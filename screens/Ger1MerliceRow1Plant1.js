...
export default class Ger1MerliceRow1Plant1 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantGer1MerliceRow1Plant1 = this.onSubmitleavesPerPlantGer1MerliceRow1Plant1.bind(
      this,
    );
    ...
    this.leavesPerPlantGer1MerliceRow1Plant1Ref = this.updateRef.bind(
      this,
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantGer1MerliceRow1Plant1')
        .then(text1Value => {
          this.setState({
            leavesPerPlantGer1MerliceRow1Plant1: JSON.parse(text1Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('fullySetTrussGer1MerliceRow1Plant1')
        .then(text2Value => {
          this.setState({
            fullySetTrussGer1MerliceRow1Plant1: JSON.parse(text2Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('setTrussLengthGer1MerliceRow1Plant1')
        .then(text3Value => {
          this.setState({
            setTrussLengthGer1MerliceRow1Plant1: JSON.parse(text3Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('weeklyGrowthGer1MerliceRow1Plant1')
        .then(text4Value => {
          this.setState({
            weeklyGrowthGer1MerliceRow1Plant1: JSON.parse(text4Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('floweringTrussHeightGer1MerliceRow1Plant1')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightGer1MerliceRow1Plant1: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthGer1MerliceRow1Plant1')
        .then(text6Value => {
          this.setState({
            leafLengthGer1MerliceRow1Plant1: JSON.parse(text6Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafWidthGer1MerliceRow1Plant1')
        .then(text7Value => {
          this.setState({
            leafWidthGer1MerliceRow1Plant1: JSON.parse(text7Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('stmDiameterGer1MerliceRow1Plant1')
        .then(text8Value => {
          this.setState({
            stmDiameterGer1MerliceRow1Plant1: JSON.parse(text8Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('lastWeekStmDiameterGer1MerliceRow1Plant1')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterGer1MerliceRow1Plant1: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('Ger1MerliceRow1Plant1Selected')
        .then(text99Value => {
          this.setState({
            Ger1MerliceRow1Plant1Selected: JSON.parse(text99Value),
          });
    ...
    try {
      AsyncStorage.getItem('trussNumberGer1MerliceRow1Plant1')
        .then(text10Value => {
          if (text10Value !== null) {
            this.setState({
              trussNumberGer1MerliceRow1Plant1: JSON.parse(text10Value),
            });

            this.setState({
              trussNumber1Ger1MerliceRow1Plant1:
                Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) +
                1,
            });
            this.setState({
              trussNumber2Ger1MerliceRow1Plant1:
    ...
    try {
      AsyncStorage.getItem('setFruitsGer1MerliceRow1Plant1')
        .then(text11Value => {
          if (text11Value !== null) {
            this.setState({
              setFruitsGer1MerliceRow1Plant1: JSON.parse(text11Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowersGer1MerliceRow1Plant1')
        .then(text12Value => {
          if (text12Value !== null) {
            this.setState({
              setFlowersGer1MerliceRow1Plant1: JSON.parse(text12Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumberGer1MerliceRow1Plant1')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberGer1MerliceRow1Plant1: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterGer1MerliceRow1Plant1')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterGer1MerliceRow1Plant1: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1Ger1MerliceRow1Plant1')
        .then(text16Value => {
          if (text16Value !== null) {
            this.setState({
              setFruits1Ger1MerliceRow1Plant1: JSON.parse(text16Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers1Ger1MerliceRow1Plant1')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFlowers1Ger1MerliceRow1Plant1: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber1Ger1MerliceRow1Plant1')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1Ger1MerliceRow1Plant1: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1Ger1MerliceRow1Plant1')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1Ger1MerliceRow1Plant1: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2Ger1MerliceRow1Plant1')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFruits2Ger1MerliceRow1Plant1: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers2Ger1MerliceRow1Plant1')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              setFlowers2Ger1MerliceRow1Plant1: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber2Ger1MerliceRow1Plant1')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2Ger1MerliceRow1Plant1: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2Ger1MerliceRow1Plant1')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2Ger1MerliceRow1Plant1: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3Ger1MerliceRow1Plant1')
        .then(text21Value => {
          if (text21Value !== null) {
            this.setState({
              setFruits3Ger1MerliceRow1Plant1: JSON.parse(text21Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers3Ger1MerliceRow1Plant1')
        .then(text22Value => {
          if (text22Value !== null) {
            this.setState({
              setFlowers3Ger1MerliceRow1Plant1: JSON.parse(text22Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber3Ger1MerliceRow1Plant1')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3Ger1MerliceRow1Plant1: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3Ger1MerliceRow1Plant1')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3Ger1MerliceRow1Plant1: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4Ger1MerliceRow1Plant1')
        .then(text25Value => {
          if (text25Value !== null) {
            this.setState({
              setFruits4Ger1MerliceRow1Plant1: JSON.parse(text25Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers4Ger1MerliceRow1Plant1')
        .then(text26Value => {
          if (text26Value !== null) {
            this.setState({
              setFlowers4Ger1MerliceRow1Plant1: JSON.parse(text26Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber4Ger1MerliceRow1Plant1')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4Ger1MerliceRow1Plant1: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4Ger1MerliceRow1Plant1')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4Ger1MerliceRow1Plant1: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5Ger1MerliceRow1Plant1')
        .then(text29Value => {
          if (text29Value !== null) {
            this.setState({
              setFruits5Ger1MerliceRow1Plant1: JSON.parse(text29Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers5Ger1MerliceRow1Plant1')
        .then(text30Value => {
          if (text30Value !== null) {
            this.setState({
              setFlowers5Ger1MerliceRow1Plant1: JSON.parse(text30Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber5Ger1MerliceRow1Plant1')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5Ger1MerliceRow1Plant1: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5Ger1MerliceRow1Plant1')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5Ger1MerliceRow1Plant1: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6Ger1MerliceRow1Plant1')
        .then(text33Value => {
          if (text33Value !== null) {
            this.setState({
              setFruits6Ger1MerliceRow1Plant1: JSON.parse(text33Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers6Ger1MerliceRow1Plant1')
        .then(text34Value => {
          if (text34Value !== null) {
            this.setState({
              setFlowers6Ger1MerliceRow1Plant1: JSON.parse(text34Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber6Ger1MerliceRow1Plant1')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6Ger1MerliceRow1Plant1: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6Ger1MerliceRow1Plant1')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6Ger1MerliceRow1Plant1: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7Ger1MerliceRow1Plant1')
        .then(text37Value => {
          if (text37Value !== null) {
            this.setState({
              setFruits7Ger1MerliceRow1Plant1: JSON.parse(text37Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers7Ger1MerliceRow1Plant1')
        .then(text38Value => {
          if (text38Value !== null) {
            this.setState({
              setFlowers7Ger1MerliceRow1Plant1: JSON.parse(text38Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber7Ger1MerliceRow1Plant1')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7Ger1MerliceRow1Plant1: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7Ger1MerliceRow1Plant1')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7Ger1MerliceRow1Plant1: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8Ger1MerliceRow1Plant1')
        .then(text41Value => {
          if (text41Value !== null) {
            this.setState({
              setFruits8Ger1MerliceRow1Plant1: JSON.parse(text41Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers8Ger1MerliceRow1Plant1')
        .then(text42Value => {
          if (text42Value !== null) {
            this.setState({
              setFlowers8Ger1MerliceRow1Plant1: JSON.parse(text42Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber8Ger1MerliceRow1Plant1')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8Ger1MerliceRow1Plant1: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8Ger1MerliceRow1Plant1')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8Ger1MerliceRow1Plant1: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9Ger1MerliceRow1Plant1')
        .then(text45Value => {
          if (text45Value !== null) {
            this.setState({
              setFruits9Ger1MerliceRow1Plant1: JSON.parse(text45Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers9Ger1MerliceRow1Plant1')
        .then(text46Value => {
          if (text46Value !== null) {
            this.setState({
              setFlowers9Ger1MerliceRow1Plant1: JSON.parse(text46Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber9Ger1MerliceRow1Plant1')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9Ger1MerliceRow1Plant1: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9Ger1MerliceRow1Plant1')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9Ger1MerliceRow1Plant1: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadGer1MerliceRow1Plant1')
        .then(text49Value => {
          if (text49Value !== null) {
            this.setState({
              fruitLoadGer1MerliceRow1Plant1: JSON.parse(text49Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('floweringTrussssGer1MerliceRow1Plant1')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssGer1MerliceRow1Plant1: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberGer1MerliceRow1Plant1')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberGer1MerliceRow1Plant1: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussGer1MerliceRow1Plant1')
        .then(text52Value => {
          if (text52Value !== null) {
            this.setState({
              harvestTrussGer1MerliceRow1Plant1: JSON.parse(text52Value),
            });
          }
        })
        .done();
  ...
  updateTextInput22 = (text, field) => {
    ...
    this.setState({
      trussNumber1Ger1MerliceRow1Plant1:
        Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 1,
    });
    this.setState({
      trussNumber2Ger1MerliceRow1Plant1:
        Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 2,
    });
    this.setState({
      trussNumber3Ger1MerliceRow1Plant1:
        Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 3,
    });
    this.setState({
      trussNumber4Ger1MerliceRow1Plant1:
        Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 4,
    });
    this.setState({
      trussNumber5Ger1MerliceRow1Plant1:
        Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 5,
    });
    this.setState({
      trussNumber6Ger1MerliceRow1Plant1:
        Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 6,
    });
    this.setState({
      trussNumber7Ger1MerliceRow1Plant1:
        Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 7,
    });
    this.setState({
      trussNumber8Ger1MerliceRow1Plant1:
        Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 8,
    });
    this.setState({
      trussNumber9Ger1MerliceRow1Plant1:
        Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 9,
    });
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      (Number.parseInt(this.state.setFruitsGer1MerliceRow1Plant1)
        ? Number.parseInt(this.state.setFruitsGer1MerliceRow1Plant1)
        : 0) +
      (Number.parseInt(this.state.setFruits1Ger1MerliceRow1Plant1)
        ? Number.parseInt(this.state.setFruits1Ger1MerliceRow1Plant1)
        : 0) +
      (Number.parseInt(this.state.setFruits2Ger1MerliceRow1Plant1)
        ? Number.parseInt(this.state.setFruits2Ger1MerliceRow1Plant1)
        : 0) +
      (Number.parseInt(this.state.setFruits3Ger1MerliceRow1Plant1)
        ? Number.parseInt(this.state.setFruits3Ger1MerliceRow1Plant1)
        : 0) +
      (Number.parseInt(this.state.setFruits4Ger1MerliceRow1Plant1)
        ? Number.parseInt(this.state.setFruits4Ger1MerliceRow1Plant1)
        : 0) +
      (Number.parseInt(this.state.setFruits5Ger1MerliceRow1Plant1)
        ? Number.parseInt(this.state.setFruits5Ger1MerliceRow1Plant1)
        : 0) +
      (Number.parseInt(this.state.setFruits6Ger1MerliceRow1Plant1)
        ? Number.parseInt(this.state.setFruits6Ger1MerliceRow1Plant1)
        : 0) +
      (Number.parseInt(this.state.setFruits7Ger1MerliceRow1Plant1)
        ? Number.parseInt(this.state.setFruits7Ger1MerliceRow1Plant1)
        : 0) +
      (Number.parseInt(this.state.setFruits8Ger1MerliceRow1Plant1)
        ? Number.parseInt(this.state.setFruits8Ger1MerliceRow1Plant1)
        : 0) +
      (Number.parseInt(this.state.setFruits9Ger1MerliceRow1Plant1)
        ? Number.parseInt(this.state.setFruits9Ger1MerliceRow1Plant1)
        : 0);
    this.setState({
    ...
    this.setItem(
      'fruitLoadGer1MerliceRow1Plant1',
      this.state.fruitLoadGer1MerliceRow1Plant1,
    );
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersGer1MerliceRow1Plant1 === '') {
      prunNum = Number.parseInt(this.state.pruningNumberGer1MerliceRow1Plant1);

      div =
        Number.parseInt(
          this.state.setFruitsGer1MerliceRow1Plant1
            ? this.state.setFruitsGer1MerliceRow1Plant1
            : 0,
        ) /
        parseFloat(
          this.state.pruningNumberGer1MerliceRow1Plant1
            ? this.state.pruningNumberGer1MerliceRow1Plant1
            : 0,
        );
      sub = 1 - div;
      ...
      this.setItem('pruningHarGer1MerliceRow1Plant1', prunNum);
    } else {
      prunNum = Number.parseInt(this.state.pruningNumberGer1MerliceRow1Plant1);
    ...
    this.setItem(
      'harvestTrussGer1MerliceRow1Plant1',
      this.state.harvestTrussGer1MerliceRow1Plant1,
    );
  };
  ...
  calculateSettingTruss2 = () => {
    ...
    console.log(
      'Setting truss called : ' + this.state.setFruits2Ger1MerliceRow1Plant1,
    );
    ...
    if (this.state.setFruits9Ger1MerliceRow1Plant1 === '') {
      if (this.state.setFruits8Ger1MerliceRow1Plant1 === '') {
        if (this.state.setFruits7Ger1MerliceRow1Plant1 === '') {
          if (this.state.setFruits6Ger1MerliceRow1Plant1 === '') {
            if (this.state.setFruits5Ger1MerliceRow1Plant1 === '') {
              if (this.state.setFruits4Ger1MerliceRow1Plant1 === '') {
                if (this.state.setFruits3Ger1MerliceRow1Plant1 === '') {
                  if (this.state.setFruits2Ger1MerliceRow1Plant1 === '') {
                    if (this.state.setFruits1Ger1MerliceRow1Plant1 === '') {
                      if (this.state.setFruitsGer1MerliceRow1Plant1 === '') {
                        ...
                        trussNum = Number.parseInt(
                          this.state.trussNumberGer1MerliceRow1Plant1,
                        );
                      ...
                      pruningSet = Number.parseInt(
                        this.state.pruningNumber1Ger1MerliceRow1Plant1,
                      );
                      trussNum = Number.parseInt(number);
                      settingFruit = Number.parseInt(
                        this.state.setFruits1Ger1MerliceRow1Plant1,
                      );
                      settingTruss = (
                        trussNum +
                        settingFruit / pruningSet
                    ...
                    pruningSet = Number.parseInt(
                      this.state.pruningNumber2Ger1MerliceRow1Plant1,
                    );
                    trussNum = Number.parseInt(number2);
                    settingFruit = Number.parseInt(
                      this.state.setFruits2Ger1MerliceRow1Plant1,
                    );
                    settingTruss = (
                      trussNum +
                      settingFruit / pruningSet
                  ...
                  pruningSet = Number.parseInt(
                    this.state.pruningNumber3Ger1MerliceRow1Plant1,
                  );
                  trussNum = Number.parseInt(number3);
                  settingFruit = Number.parseInt(
                    this.state.setFruits3Ger1MerliceRow1Plant1,
                  );
                  ...
                  this.setItem('prunSettingGer1MerliceRow1Plant1', pruningSet);
                }
              } else {
                var number4 =
                  Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) +
                ...
                pruningSet = Number.parseInt(
                  this.state.pruningNumber4Ger1MerliceRow1Plant1,
                );
                trussNum = Number.parseInt(number4);
                settingFruit = Number.parseInt(
                  this.state.setFruits4Ger1MerliceRow1Plant1,
                );
                settingTruss = (trussNum + settingFruit / pruningSet).toFixed(
                  2,
                );
              ...
              pruningSet = Number.parseInt(
                this.state.pruningNumber5Ger1MerliceRow1Plant1,
              );
              trussNum = Number.parseInt(number5);
              settingFruit = Number.parseInt(
                this.state.setFruits5Ger1MerliceRow1Plant1,
              );
            ...
            pruningSet = Number.parseInt(
              this.state.pruningNumber6Ger1MerliceRow1Plant1,
            );
            trussNum = Number.parseInt(number6);
            settingFruit = Number.parseInt(
              this.state.setFruits6Ger1MerliceRow1Plant1,
            );
            settingTruss = (trussNum + settingFruit / pruningSet).toFixed(2);
          ...
          pruningSet = Number.parseInt(
            this.state.pruningNumber7Ger1MerliceRow1Plant1,
          );
          trussNum = Number.parseInt(number7);
          settingFruit = Number.parseInt(
            this.state.setFruits7Ger1MerliceRow1Plant1,
          );
          settingTruss = (trussNum + settingFruit / pruningSet).toFixed(2);
        ...
        pruningSet = Number.parseInt(
          this.state.pruningNumber8Ger1MerliceRow1Plant1,
        );
        trussNum = Number.parseInt(number8);
        settingFruit = Number.parseInt(
          this.state.setFruits8Ger1MerliceRow1Plant1,
        );
        settingTruss = (trussNum + settingFruit / pruningSet).toFixed(2);
      ...
      pruningSet = Number.parseInt(
        this.state.pruningNumber9Ger1MerliceRow1Plant1,
      );
      trussNum = Number.parseInt(number9);
      settingFruit = Number.parseInt(
        this.state.setFruits9Ger1MerliceRow1Plant1,
      );
      settingTruss = (trussNum + settingFruit / pruningSet).toFixed(2);
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2Ger1MerliceRow1Plant1,
    );
    ...
    if (this.state.setFlowers9Ger1MerliceRow1Plant1 === '') {
      if (this.state.setFlowers8Ger1MerliceRow1Plant1 === '') {
        if (this.state.setFlowers7Ger1MerliceRow1Plant1 === '') {
          if (this.state.setFlowers6Ger1MerliceRow1Plant1 === '') {
            if (this.state.setFlowers5Ger1MerliceRow1Plant1 === '') {
              if (this.state.setFlowers4Ger1MerliceRow1Plant1 === '') {
                if (this.state.setFlowers3Ger1MerliceRow1Plant1 === '') {
                  if (this.state.setFlowers2Ger1MerliceRow1Plant1 === '') {
                    if (this.state.setFlowers1Ger1MerliceRow1Plant1 === '') {
                      if (this.state.setFlowersGer1MerliceRow1Plant1 === '') {
                        ...
                        flowering = Number.parseInt(
                          this.state.setFlowersGer1MerliceRow1Plant1,
                        );
                      ...
                      var number11 =
                        +this.state.trussNumberGer1MerliceRow1Plant1 + 1;
                      ...
                      flowering = Number.parseInt(
                        this.state.setFlowers1Ger1MerliceRow1Plant1,
                      );
                      flowerSetFruits = Number.parseInt(
                        this.state.setFruits1Ger1MerliceRow1Plant1,
                      );
                    ...
                    var number21 =
                      +this.state.trussNumberGer1MerliceRow1Plant1 + 2;

                    flowerPruningNumner = Number.parseInt(
                      this.state.pruningNumber2Ger1MerliceRow1Plant1,
                    );
                    flowering = Number.parseInt(
                      this.state.setFlowers2Ger1MerliceRow1Plant1,
                    );
                    flowerSetFruits = Number.parseInt(
                      this.state.setFruits2Ger1MerliceRow1Plant1,
                    );
                  ...
                  var number31 =
                    +this.state.trussNumberGer1MerliceRow1Plant1 + 3;

                  flowerPruningNumner = Number.parseInt(
                    this.state.pruningNumber3Ger1MerliceRow1Plant1,
                  );
                  flowering = Number.parseInt(
                    this.state.setFlowers3Ger1MerliceRow1Plant1,
                  );
                  flowerSetFruits = Number.parseInt(
                    this.state.setFruits3Ger1MerliceRow1Plant1,
                  );
                ...
                flowering = Number.parseInt(
                  this.state.setFlowers4Ger1MerliceRow1Plant1,
                );
                flowerSetFruits = Number.parseInt(
                  this.state.setFruits4Ger1MerliceRow1Plant1,
                );
              ...
              flowering = Number.parseInt(
                this.state.setFlowers5Ger1MerliceRow1Plant1,
              );
              flowerSetFruits = Number.parseInt(
                this.state.setFruits5Ger1MerliceRow1Plant1,
              );
            ...
            flowering = Number.parseInt(
              this.state.setFlowers6Ger1MerliceRow1Plant1,
            );
            flowerSetFruits = Number.parseInt(
              this.state.setFruits6Ger1MerliceRow1Plant1,
            );
          ...
          flowering = Number.parseInt(
            this.state.setFlowers7Ger1MerliceRow1Plant1,
          );
          flowerSetFruits = Number.parseInt(
            this.state.setFruits7Ger1MerliceRow1Plant1,
          );
        ...
        flowering = Number.parseInt(
          this.state.setFlowers8Ger1MerliceRow1Plant1,
        );
        flowerSetFruits = Number.parseInt(
          this.state.setFruits8Ger1MerliceRow1Plant1,
        );
      ...
      flowering = Number.parseInt(this.state.setFlowers9Ger1MerliceRow1Plant1);
      flowerSetFruits = Number.parseInt(
        this.state.setFruits9Ger1MerliceRow1Plant1,
      );
      summ =
      ...
      this.setItem('floweringTrussssGer1MerliceRow1Plant1', floweringTruss);
      this.setItem('pruneFloweringGer1MerliceRow1Plant1', flowerPruningNumner);
    }
  };
  //
      ...
      if (this.state.trussNumberGer1MerliceRow1Plant1 != null) {
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersGer1MerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsGer1MerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberGer1MerliceRow1Plant1: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1Ger1MerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1Ger1MerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1Ger1MerliceRow1Plant1: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2Ger1MerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2Ger1MerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2Ger1MerliceRow1Plant1: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3Ger1MerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3Ger1MerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3Ger1MerliceRow1Plant1: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4Ger1MerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4Ger1MerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4Ger1MerliceRow1Plant1: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5Ger1MerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5Ger1MerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5Ger1MerliceRow1Plant1: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6Ger1MerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6Ger1MerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6Ger1MerliceRow1Plant1: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7Ger1MerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7Ger1MerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7Ger1MerliceRow1Plant1: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8Ger1MerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8Ger1MerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8Ger1MerliceRow1Plant1: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9Ger1MerliceRow1Plant1: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9Ger1MerliceRow1Plant1: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9Ger1MerliceRow1Plant1: JSON.stringify(
  ...
  changeCheckbox = () => {
    this.setState({
      Ger1MerliceRow1Plant1Selected: !this.state.Ger1MerliceRow1Plant1Selected,
    });
  ...
  checkStatus = () => {
    ...
    if (vart == null || vart == false) {
      const {leavesPerPlantGer1MerliceRow1Plant1} = this.state;
      const {fullySetTrussGer1MerliceRow1Plant1} = this.state;
      const {setTrussLengthGer1MerliceRow1Plant1} = this.state;
      const {weeklyGrowthGer1MerliceRow1Plant1} = this.state;
      const {floweringTrussHeightGer1MerliceRow1Plant1} = this.state;
      const {leafLengthGer1MerliceRow1Plant1} = this.state;
      const {leafWidthGer1MerliceRow1Plant1} = this.state;
      const {stmDiameterGer1MerliceRow1Plant1} = this.state;
      const {lastWeekStmDiameterGer1MerliceRow1Plant1} = this.state;
      ...
      if (+!isNaN(+leavesPerPlantGer1MerliceRow1Plant1)) {
        if (+!isNaN(+fullySetTrussGer1MerliceRow1Plant1)) {
          if (+!isNaN(+setTrussLengthGer1MerliceRow1Plant1)) {
            if (+!isNaN(+weeklyGrowthGer1MerliceRow1Plant1)) {
              if (+!isNaN(+floweringTrussHeightGer1MerliceRow1Plant1)) {
                if (+!isNaN(+leafLengthGer1MerliceRow1Plant1)) {
                  if (+!isNaN(+leafWidthGer1MerliceRow1Plant1)) {
                    if (+!isNaN(+stmDiameterGer1MerliceRow1Plant1)) {
                      if (+!isNaN(+lastWeekStmDiameterGer1MerliceRow1Plant1)) {
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberGer1MerliceRow1Plant1 !== null &&
      this.state.pruningNumberGer1MerliceRow1Plant1 !== null
    ) {
      let data = {
  ...
  saveTrussToDB1 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 1 !=
        null &&
      this.state.pruningNumber1Ger1MerliceRow1Plant1 !== null
    ) {
      let data1 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 1,
  ...
  saveTrussToDB2 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 2 !=
        null &&
      this.state.pruningNumber2Ger1MerliceRow1Plant1 !== null
    ) {
      let data2 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 2,
  ...
  saveTrussToDB3 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 3 !==
        null &&
      this.state.pruningNumber3Ger1MerliceRow1Plant1 !== null
    ) {
      let data3 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 3,
  ...
  saveTrussToDB4 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 4 !=
        null &&
      this.state.pruningNumber4Ger1MerliceRow1Plant1 !== null
    ) {
      let data4 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 4,
  ...
  saveTrussToDB5 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 5 !=
        null &&
      this.state.pruningNumber5Ger1MerliceRow1Plant1 !== null
    ) {
      let data5 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 5,
  ...
  saveTrussToDB6 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 6 !=
        null &&
      this.state.pruningNumber6Ger1MerliceRow1Plant1 !== null
    ) {
      let data6 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 6,
  ...
  saveTrussToDB7 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 7 !=
        null &&
      this.state.pruningNumber7Ger1MerliceRow1Plant1 !== null
    ) {
      let data7 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 7,
  ...
  saveTrussToDB8 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 8 !=
        null &&
      this.state.pruningNumber8Ger1MerliceRow1Plant1 !== null
    ) {
      let data8 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 8,
  ...
  saveTrussToDB9 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 9 !=
        null &&
      this.state.pruningNumber9Ger1MerliceRow1Plant1 !== null
    ) {
      let data9 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 9,
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 1</Text>/ Row No. 81&amp;85/
        ...
        <KeyboardAvoidingView
          ...
          <ScrollView
            ...
            <View
              pointerEvents={
                this.state.Ger1MerliceRow1Plant1Selected ? 'none' : 'auto'
              }>
              <View style={styles.formContainer}>
                  ...
                  <View style={styles.row}>
                    <View style={styles.borderEdit}>
                      <TextInput
                        ...
                        value={
                          this.state.floweringTrussHeightGer1MerliceRow1Plant1
                        }
                        ref={input => {
                  ...
                  <View style={styles.row}>
                    <View style={styles.borderEdit}>
                      <TextInput
                        ...
                        value={
                          this.state.lastWeekStmDiameterGer1MerliceRow1Plant1
                        }
                        ref={input => {
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadGer1MerliceRow1Plant1 <= 22 ||
                      this.state.fruitLoadGer1MerliceRow1Plant1 >= 40
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssGer1MerliceRow1Plant1 <= 0 ||
                      this.state.floweringTrussssGer1MerliceRow1Plant1 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}>
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssGer1MerliceRow1Plant1}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberGer1MerliceRow1Plant1 <= 1 ||
                      this.state.settingTrussNumberGer1MerliceRow1Plant1 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}>
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberGer1MerliceRow1Plant1}
                      </Text>
                    </View>
                    <View
                      style={{
