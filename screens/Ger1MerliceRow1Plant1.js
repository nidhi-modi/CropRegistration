...
export default class Ger1MerliceRow1Plant1 extends Component {
  ...
  renderEntryData = () => {
    ...
    try {
      AsyncStorage.getItem('@MySuperStore:plantKey').then((plantValues) => {
        ...
        //Change week number
        const weekRowPlant = d => d.plantName === 'GER 1 - Merlice' && d.plantNumber === 1 && d.plantRow === '81/86' && d.plantWeek === filteredPlantWeek;
    ...
    try {
      AsyncStorage.getItem('@MySuperStore:trussKey').then((trussValues) => {
        ...
        //Change week number
        const weekRowTruss = d => d.plantName === 'GER 1 - Merlice' && d.plantNumber === 1 && d.plantRow === '81/86' && d.plantWeek === filteredTrussWeek;
    ...
    try {
      AsyncStorage.getItem('trussNumberGer1MerliceRow1Plant1').then((text10Value) => {
        ...
        if (text10Value !== null) {
          ...
          this.setState({ trussNumber1Ger1MerliceRow1Plant1: Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 1 })
          this.setState({ trussNumber2Ger1MerliceRow1Plant1: Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 2 })
          this.setState({ trussNumber3Ger1MerliceRow1Plant1: Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 3 })
          this.setState({ trussNumber4Ger1MerliceRow1Plant1: Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 4 })
          this.setState({ trussNumber5Ger1MerliceRow1Plant1: Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 5 })
          this.setState({ trussNumber6Ger1MerliceRow1Plant1: Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 6 })
          this.setState({ trussNumber7Ger1MerliceRow1Plant1: Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 7 })
          this.setState({ trussNumber8Ger1MerliceRow1Plant1: Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 8 })
          this.setState({ trussNumber9Ger1MerliceRow1Plant1: Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 9 })
  ...
  calculateFruitLoad = () => {
    ...
    sum = ((Number.parseInt(this.state.setFruitsGer1MerliceRow1Plant1) ? Number.parseInt(this.state.setFruitsGer1MerliceRow1Plant1) : 0) + (Number.parseInt(this.state.setFruits1Ger1MerliceRow1Plant1) ? Number.parseInt(this.state.setFruits1Ger1MerliceRow1Plant1) : 0) + (Number.parseInt(this.state.setFruits2Ger1MerliceRow1Plant1) ? Number.parseInt(this.state.setFruits2Ger1MerliceRow1Plant1) : 0) + (Number.parseInt(this.state.setFruits3Ger1MerliceRow1Plant1) ? Number.parseInt(this.state.setFruits3Ger1MerliceRow1Plant1) : 0) + (Number.parseInt(this.state.setFruits4Ger1MerliceRow1Plant1) ? Number.parseInt(this.state.setFruits4Ger1MerliceRow1Plant1) : 0) + (Number.parseInt(this.state.setFruits5Ger1MerliceRow1Plant1) ? Number.parseInt(this.state.setFruits5Ger1MerliceRow1Plant1) : 0) + (Number.parseInt(this.state.setFruits6Ger1MerliceRow1Plant1) ? Number.parseInt(this.state.setFruits6Ger1MerliceRow1Plant1) : 0) + (Number.parseInt(this.state.setFruits7Ger1MerliceRow1Plant1) ? Number.parseInt(this.state.setFruits7Ger1MerliceRow1Plant1) : 0) + (Number.parseInt(this.state.setFruits8Ger1MerliceRow1Plant1) ? Number.parseInt(this.state.setFruits8Ger1MerliceRow1Plant1) : 0) + (Number.parseInt(this.state.setFruits9Ger1MerliceRow1Plant1) ? Number.parseInt(this.state.setFruits9Ger1MerliceRow1Plant1) : 0));
    this.setState({
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersGer1MerliceRow1Plant1 === "") {
      ...
      div = (Number.parseInt((this.state.setFruitsGer1MerliceRow1Plant1) ? (this.state.setFruitsGer1MerliceRow1Plant1) : 0) / parseFloat((this.state.pruningNumberGer1MerliceRow1Plant1) ? (this.state.pruningNumberGer1MerliceRow1Plant1) : 0))
      sub = (1 - div);
      add = (((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) ? Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) : 0) + sub).toFixed(2))
      this.setState({
  ...
  calculateSettingTruss2 = () => {
    ...
    if (this.state.setFruits9Ger1MerliceRow1Plant1 === "") {
      ...
      if (this.state.setFruits8Ger1MerliceRow1Plant1 === "") {
        ...
        if (this.state.setFruits7Ger1MerliceRow1Plant1 === "") {
          ...
          if (this.state.setFruits6Ger1MerliceRow1Plant1 === "") {
            ...
            if (this.state.setFruits5Ger1MerliceRow1Plant1 === "") {
              ...
              if (this.state.setFruits4Ger1MerliceRow1Plant1 === "") {
                ...
                if (this.state.setFruits3Ger1MerliceRow1Plant1 === "") {
                  ...
                  if (this.state.setFruits2Ger1MerliceRow1Plant1 === "") {
                    ...
                    if (this.state.setFruits1Ger1MerliceRow1Plant1 === "") {
                      ...
                      if (this.state.setFruitsGer1MerliceRow1Plant1 === "") {
                        ...
                        pruningSet = Number.parseInt(this.state.pruningNumberGer1MerliceRow1Plant1);
                        trussNum = Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1);
                        settingFruit = Number.parseInt(this.state.setFruitsGer1MerliceRow1Plant1);
                      ...
                      var number = (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 1)

                      pruningSet = Number.parseInt(this.state.pruningNumber1Ger1MerliceRow1Plant1);
                      trussNum = Number.parseInt(number);
                      settingFruit = Number.parseInt(this.state.setFruits1Ger1MerliceRow1Plant1);
                      settingTruss = ((trussNum + (settingFruit / pruningSet)).toFixed(2));
                    ...
                    var number2 = (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 2)

                    pruningSet = Number.parseInt(this.state.pruningNumber2Ger1MerliceRow1Plant1);
                    trussNum = Number.parseInt(number2);
                    settingFruit = Number.parseInt(this.state.setFruits2Ger1MerliceRow1Plant1);
                    settingTruss = ((trussNum + (settingFruit / pruningSet)).toFixed(2));
                  ...
                  var number3 = (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 3)

                  pruningSet = Number.parseInt(this.state.pruningNumber3Ger1MerliceRow1Plant1);
                  trussNum = Number.parseInt(number3);
                  settingFruit = Number.parseInt(this.state.setFruits3Ger1MerliceRow1Plant1);
                  settingTruss = ((trussNum + (settingFruit / pruningSet)).toFixed(2));
                ...
                var number4 = (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 4)

                pruningSet = Number.parseInt(this.state.pruningNumber4Ger1MerliceRow1Plant1);
                trussNum = Number.parseInt(number4);
                settingFruit = Number.parseInt(this.state.setFruits4Ger1MerliceRow1Plant1);
                settingTruss = ((trussNum + (settingFruit / pruningSet)).toFixed(2));
              ...
              var number5 = (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 5)

              pruningSet = Number.parseInt(this.state.pruningNumber5Ger1MerliceRow1Plant1);
              trussNum = Number.parseInt(number5);
              settingFruit = Number.parseInt(this.state.setFruits5Ger1MerliceRow1Plant1);
              settingTruss = ((trussNum + (settingFruit / pruningSet)).toFixed(2));
            ...
            var number6 = (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 6)

            pruningSet = Number.parseInt(this.state.pruningNumber6Ger1MerliceRow1Plant1);
            trussNum = Number.parseInt(number6);
            settingFruit = Number.parseInt(this.state.setFruits6Ger1MerliceRow1Plant1);
            settingTruss = ((trussNum + (settingFruit / pruningSet)).toFixed(2));
          ...
          var number7 = (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 7)

          pruningSet = Number.parseInt(this.state.pruningNumber7Ger1MerliceRow1Plant1);
          trussNum = Number.parseInt(number7);
          settingFruit = Number.parseInt(this.state.setFruits7Ger1MerliceRow1Plant1);
          settingTruss = ((trussNum + (settingFruit / pruningSet)).toFixed(2));
        ...
        var number8 = (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 8)

        pruningSet = Number.parseInt(this.state.pruningNumber8Ger1MerliceRow1Plant1);
        trussNum = Number.parseInt(number8);
        settingFruit = Number.parseInt(this.state.setFruits8Ger1MerliceRow1Plant1);
        settingTruss = ((trussNum + (settingFruit / pruningSet)).toFixed(2));
      ...
      var number9 = (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 9)

      pruningSet = Number.parseInt(this.state.pruningNumber9Ger1MerliceRow1Plant1);
      trussNum = Number.parseInt(number9);
      settingFruit = Number.parseInt(this.state.setFruits9Ger1MerliceRow1Plant1);
      settingTruss = ((trussNum + (settingFruit / pruningSet)).toFixed(2));
  ...
  calculateFloweringTruss2 = () => {
    ...
    if (this.state.setFlowers9Ger1MerliceRow1Plant1 === "") {
      ...
      if (this.state.setFlowers8Ger1MerliceRow1Plant1 === "") {
        ...
        if (this.state.setFlowers7Ger1MerliceRow1Plant1 === "") {
          ...
          if (this.state.setFlowers6Ger1MerliceRow1Plant1 === "") {
            ...
            if (this.state.setFlowers5Ger1MerliceRow1Plant1 === "") {
              ...
              if (this.state.setFlowers4Ger1MerliceRow1Plant1 === "") {
                ...
                if (this.state.setFlowers3Ger1MerliceRow1Plant1 === "") {
                  ...
                  if (this.state.setFlowers2Ger1MerliceRow1Plant1 === "") {
                    ...
                    if (this.state.setFlowers1Ger1MerliceRow1Plant1 === "") {
                      ...
                      if (this.state.setFlowersGer1MerliceRow1Plant1 === "") {
                        ...
                        flowerPruningNumner = Number.parseInt(this.state.pruningNumberGer1MerliceRow1Plant1);
                        flowering = Number.parseInt(this.state.setFlowersGer1MerliceRow1Plant1);
                        flowerSetFruits = Number.parseInt(this.state.setFruitsGer1MerliceRow1Plant1);
                      ...
                      flowerPruningNumner = Number.parseInt(this.state.pruningNumber1Ger1MerliceRow1Plant1);
                      flowering = Number.parseInt(this.state.setFlowers1Ger1MerliceRow1Plant1);
                      flowerSetFruits = Number.parseInt(this.state.setFruits1Ger1MerliceRow1Plant1);
                      trussNum = number11
                      summ = (flowering ? flowering : 0) + (flowerSetFruits ? flowerSetFruits : 0);
                    ...
                    flowerPruningNumner = Number.parseInt(this.state.pruningNumber2Ger1MerliceRow1Plant1);
                    flowering = Number.parseInt(this.state.setFlowers2Ger1MerliceRow1Plant1);
                    flowerSetFruits = Number.parseInt(this.state.setFruits2Ger1MerliceRow1Plant1);
                    summ = (flowering ? flowering : 0) + (flowerSetFruits ? flowerSetFruits : 0);
                  ...
                  flowerPruningNumner = Number.parseInt(this.state.pruningNumber3Ger1MerliceRow1Plant1);
                  flowering = Number.parseInt(this.state.setFlowers3Ger1MerliceRow1Plant1);
                  flowerSetFruits = Number.parseInt(this.state.setFruits3Ger1MerliceRow1Plant1);
                  summ = (flowering ? flowering : 0) + (flowerSetFruits ? flowerSetFruits : 0);
                ...
                flowerPruningNumner = Number.parseInt(this.state.pruningNumber4Ger1MerliceRow1Plant1);
                flowering = Number.parseInt(this.state.setFlowers4Ger1MerliceRow1Plant1);
                flowerSetFruits = Number.parseInt(this.state.setFruits4Ger1MerliceRow1Plant1);
                summ = (flowering ? flowering : 0) + (flowerSetFruits ? flowerSetFruits : 0);
              ...
              flowerPruningNumner = Number.parseInt(this.state.pruningNumber5Ger1MerliceRow1Plant1);
              flowering = Number.parseInt(this.state.setFlowers5Ger1MerliceRow1Plant1);
              flowerSetFruits = Number.parseInt(this.state.setFruits5Ger1MerliceRow1Plant1);
              summ = (flowering ? flowering : 0) + (flowerSetFruits ? flowerSetFruits : 0);
            ...
            flowerPruningNumner = Number.parseInt(this.state.pruningNumber6Ger1MerliceRow1Plant1);
            flowering = Number.parseInt(this.state.setFlowers6Ger1MerliceRow1Plant1);
            flowerSetFruits = Number.parseInt(this.state.setFruits6Ger1MerliceRow1Plant1);
            summ = (flowering ? flowering : 0) + (flowerSetFruits ? flowerSetFruits : 0);
          ...
          flowerPruningNumner = Number.parseInt(this.state.pruningNumber7Ger1MerliceRow1Plant1);
          flowering = Number.parseInt(this.state.setFlowers7Ger1MerliceRow1Plant1);
          flowerSetFruits = Number.parseInt(this.state.setFruits7Ger1MerliceRow1Plant1);
          summ = (flowering ? flowering : 0) + (flowerSetFruits ? flowerSetFruits : 0);
        ...
        flowerPruningNumner = Number.parseInt(this.state.pruningNumber8Ger1MerliceRow1Plant1);
        flowering = Number.parseInt(this.state.setFlowers8Ger1MerliceRow1Plant1);
        flowerSetFruits = Number.parseInt(this.state.setFruits8Ger1MerliceRow1Plant1);
        summ = (flowering ? flowering : 0) + (flowerSetFruits ? flowerSetFruits : 0);
      ...
      flowerPruningNumner = Number.parseInt(this.state.pruningNumber9Ger1MerliceRow1Plant1);
      flowering = Number.parseInt(this.state.setFlowers9Ger1MerliceRow1Plant1);
      flowerSetFruits = Number.parseInt(this.state.setFruits9Ger1MerliceRow1Plant1);
      summ = (flowering ? flowering : 0) + (flowerSetFruits ? flowerSetFruits : 0);
  ...
  getTrussData = () => {
    ...
    if (this.state.allTrussData.length != 0) {
      ...
      if (this.state.trussNumberGer1MerliceRow1Plant1 != null) {
        ...
        //Change week number
        const weekRowTruss1 = d => d.trussNumber === Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1);
      ...
      //2nd Truss
      if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 1) != null) {

        //Change week number
        const weekRowTruss2 = d => d.trussNumber === (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 1);
      ...
      //3rd Truss
      if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 2) != null) {

        //Change week number
        const weekRowTruss3 = d => d.trussNumber === (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 2);
      ...
      //4th Truss
      if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 3) != null) {

        //Change week number
        const weekRowTruss4 = d => d.trussNumber === (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 3);
      ...
      //5th Truss
      if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 4) != null) {

        //Change week number
        const weekRowTruss5 = d => d.trussNumber === (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 4);
      ...
      //6th Truss
      if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 5) != null) {

        //Change week number
        const weekRowTruss6 = d => d.trussNumber === (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 5);
      ...
      //7th Truss
      if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 6) != null) {

        //Change week number
        const weekRowTruss7 = d => d.trussNumber === (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 6);
      ...
      //8th Truss
      if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 7) != null) {

        //Change week number
        const weekRowTruss8 = d => d.trussNumber === (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 7);
      ...
      //9th Truss
      if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 8) != null) {

        //Change week number
        const weekRowTruss9 = d => d.trussNumber === (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 8);
      ...
      //10th Truss
      if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 9) != null) {

        //Change week number
        const weekRowTruss10 = d => d.trussNumber === (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 9);
  ...
  saveTrussToDB1 = () => {
    ...
    if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 1) != null && this.state.pruningNumber1Ger1MerliceRow1Plant1 !== null) {


      let data1 = {

        trussNumber: (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 1),
      ...
      db.addTrussDetails(data1).then((result) => {
        ...
        if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 2) !== null && this.state.pruningNumber2Ger1MerliceRow1Plant1 !== '') {
  ...
  saveTrussToDB2 = () => {
    ...
    if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 2) != null && this.state.pruningNumber2Ger1MerliceRow1Plant1 !== null) {


      let data2 = {

        trussNumber: (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 2),
      ...
      db.addTrussDetails(data2).then((result) => {
        ...
        if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 3) !== null && this.state.pruningNumber3Ger1MerliceRow1Plant1 !== '') {
  ...
  saveTrussToDB3 = () => {
    ...
    if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 3) !== null && this.state.pruningNumber3Ger1MerliceRow1Plant1 !== null) {


      let data3 = {
        trussNumber: (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 3),
      ...
      db.addTrussDetails(data3).then((result) => {
        ...
        if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 4) !== null && this.state.pruningNumber4Ger1MerliceRow1Plant1 !== '') {
  ...
  saveTrussToDB4 = () => {
    ...
    if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 4) != null && this.state.pruningNumber4Ger1MerliceRow1Plant1 !== null) {


      let data4 = {
        trussNumber: (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 4),
      ...
      db.addTrussDetails(data4).then((result) => {
        ...
        if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 5) !== null && this.state.pruningNumber5Ger1MerliceRow1Plant1 !== '') {
  ...
  saveTrussToDB5 = () => {
    ...
    if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 5) != null && this.state.pruningNumber5Ger1MerliceRow1Plant1 !== null) {


      let data5 = {
        trussNumber: (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 5),
      ...
      db.addTrussDetails(data5).then((result) => {
        ...
        if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 6) !== null && this.state.pruningNumber6Ger1MerliceRow1Plant1 !== '') {
  ...
  saveTrussToDB6 = () => {
    ...
    if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 6) != null && this.state.pruningNumber6Ger1MerliceRow1Plant1 !== null) {


      let data6 = {
        trussNumber: (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 6),
      ...
      db.addTrussDetails(data6).then((result) => {
        ...
        if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 7) !== null && this.state.pruningNumber7Ger1MerliceRow1Plant1 !== '') {
  ...
  saveTrussToDB7 = () => {
    ...
    if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 7) != null && this.state.pruningNumber7Ger1MerliceRow1Plant1 !== null) {


      let data7 = {
        trussNumber: (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 7),
      ...
      db.addTrussDetails(data7).then((result) => {
        ...
        if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 8) !== null && this.state.pruningNumber8Ger1MerliceRow1Plant1 !== '') {
  ...
  saveTrussToDB8 = () => {
    ...
    if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 8) != null && this.state.pruningNumber8Ger1MerliceRow1Plant1 !== null) {


      let data8 = {
        trussNumber: (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 8),
      ...
      db.addTrussDetails(data8).then((result) => {
        ...
        if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 9) !== null && this.state.pruningNumber9Ger1MerliceRow1Plant1 !== '') {
  ...
  saveTrussToDB9 = () => {
    ...
    if ((Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 9) != null && this.state.pruningNumber9Ger1MerliceRow1Plant1 !== null) {



      let data9 = {
        trussNumber: (Number.parseInt(this.state.trussNumberGer1MerliceRow1Plant1) + 9),
  ...
  render() {
    return (
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.text2}><Text style={styles.textPlants}>Plant 1</Text>/ Row No. 81&amp;85/ Week No. {this.state.weekNumber}</Text>
