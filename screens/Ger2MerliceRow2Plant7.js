...
export default class Ger2MerliceRow2Plant7 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantGer2MerliceRow2Plant7 = this.onSubmitleavesPerPlantGer2MerliceRow2Plant7.bind(
      this,
    );
    ...
    this.leavesPerPlantGer2MerliceRow2Plant7Ref = this.updateRef.bind(
      this,
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantGer2MerliceRow2Plant7')
        .then(text1Value => {
          this.setState({
            leavesPerPlantGer2MerliceRow2Plant7: JSON.parse(text1Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('fullySetTrussGer2MerliceRow2Plant7')
        .then(text2Value => {
          this.setState({
            fullySetTrussGer2MerliceRow2Plant7: JSON.parse(text2Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('setTrussLengthGer2MerliceRow2Plant7')
        .then(text3Value => {
          this.setState({
            setTrussLengthGer2MerliceRow2Plant7: JSON.parse(text3Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('weeklyGrowthGer2MerliceRow2Plant7')
        .then(text4Value => {
          this.setState({
            weeklyGrowthGer2MerliceRow2Plant7: JSON.parse(text4Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('floweringTrussHeightGer2MerliceRow2Plant7')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightGer2MerliceRow2Plant7: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthGer2MerliceRow2Plant7')
        .then(text6Value => {
          this.setState({
            leafLengthGer2MerliceRow2Plant7: JSON.parse(text6Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafWidthGer2MerliceRow2Plant7')
        .then(text7Value => {
          this.setState({
            leafWidthGer2MerliceRow2Plant7: JSON.parse(text7Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('stmDiameterGer2MerliceRow2Plant7')
        .then(text8Value => {
          this.setState({
            stmDiameterGer2MerliceRow2Plant7: JSON.parse(text8Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('lastWeekStmDiameterGer2MerliceRow2Plant7')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterGer2MerliceRow2Plant7: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('Ger2MerliceRow2Plant7Selected')
        .then(text99Value => {
          this.setState({
            Ger2MerliceRow2Plant7Selected: JSON.parse(text99Value),
          });
    ...
    try {
      AsyncStorage.getItem('trussNumberGer2MerliceRow2Plant7')
        .then(text10Value => {
          if (text10Value !== null) {
            this.setState({
              trussNumberGer2MerliceRow2Plant7: JSON.parse(text10Value),
            });

            this.setState({
              trussNumber1Ger2MerliceRow2Plant7:
                Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) +
                1,
            });
            this.setState({
              trussNumber2Ger2MerliceRow2Plant7:
    ...
    try {
      AsyncStorage.getItem('setFruitsGer2MerliceRow2Plant7')
        .then(text11Value => {
          if (text11Value !== null) {
            this.setState({
              setFruitsGer2MerliceRow2Plant7: JSON.parse(text11Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowersGer2MerliceRow2Plant7')
        .then(text12Value => {
          if (text12Value !== null) {
            this.setState({
              setFlowersGer2MerliceRow2Plant7: JSON.parse(text12Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumberGer2MerliceRow2Plant7')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberGer2MerliceRow2Plant7: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterGer2MerliceRow2Plant7')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterGer2MerliceRow2Plant7: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1Ger2MerliceRow2Plant7')
        .then(text16Value => {
          if (text16Value !== null) {
            this.setState({
              setFruits1Ger2MerliceRow2Plant7: JSON.parse(text16Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers1Ger2MerliceRow2Plant7')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFlowers1Ger2MerliceRow2Plant7: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber1Ger2MerliceRow2Plant7')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1Ger2MerliceRow2Plant7: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1Ger2MerliceRow2Plant7')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1Ger2MerliceRow2Plant7: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2Ger2MerliceRow2Plant7')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFruits2Ger2MerliceRow2Plant7: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers2Ger2MerliceRow2Plant7')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              setFlowers2Ger2MerliceRow2Plant7: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber2Ger2MerliceRow2Plant7')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2Ger2MerliceRow2Plant7: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2Ger2MerliceRow2Plant7')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2Ger2MerliceRow2Plant7: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3Ger2MerliceRow2Plant7')
        .then(text21Value => {
          if (text21Value !== null) {
            this.setState({
              setFruits3Ger2MerliceRow2Plant7: JSON.parse(text21Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers3Ger2MerliceRow2Plant7')
        .then(text22Value => {
          if (text22Value !== null) {
            this.setState({
              setFlowers3Ger2MerliceRow2Plant7: JSON.parse(text22Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber3Ger2MerliceRow2Plant7')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3Ger2MerliceRow2Plant7: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3Ger2MerliceRow2Plant7')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3Ger2MerliceRow2Plant7: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4Ger2MerliceRow2Plant7')
        .then(text25Value => {
          if (text25Value !== null) {
            this.setState({
              setFruits4Ger2MerliceRow2Plant7: JSON.parse(text25Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers4Ger2MerliceRow2Plant7')
        .then(text26Value => {
          if (text26Value !== null) {
            this.setState({
              setFlowers4Ger2MerliceRow2Plant7: JSON.parse(text26Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber4Ger2MerliceRow2Plant7')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4Ger2MerliceRow2Plant7: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4Ger2MerliceRow2Plant7')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4Ger2MerliceRow2Plant7: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5Ger2MerliceRow2Plant7')
        .then(text29Value => {
          if (text29Value !== null) {
            this.setState({
              setFruits5Ger2MerliceRow2Plant7: JSON.parse(text29Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers5Ger2MerliceRow2Plant7')
        .then(text30Value => {
          if (text30Value !== null) {
            this.setState({
              setFlowers5Ger2MerliceRow2Plant7: JSON.parse(text30Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber5Ger2MerliceRow2Plant7')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5Ger2MerliceRow2Plant7: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5Ger2MerliceRow2Plant7')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5Ger2MerliceRow2Plant7: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6Ger2MerliceRow2Plant7')
        .then(text33Value => {
          if (text33Value !== null) {
            this.setState({
              setFruits6Ger2MerliceRow2Plant7: JSON.parse(text33Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers6Ger2MerliceRow2Plant7')
        .then(text34Value => {
          if (text34Value !== null) {
            this.setState({
              setFlowers6Ger2MerliceRow2Plant7: JSON.parse(text34Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber6Ger2MerliceRow2Plant7')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6Ger2MerliceRow2Plant7: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6Ger2MerliceRow2Plant7')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6Ger2MerliceRow2Plant7: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7Ger2MerliceRow2Plant7')
        .then(text37Value => {
          if (text37Value !== null) {
            this.setState({
              setFruits7Ger2MerliceRow2Plant7: JSON.parse(text37Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers7Ger2MerliceRow2Plant7')
        .then(text38Value => {
          if (text38Value !== null) {
            this.setState({
              setFlowers7Ger2MerliceRow2Plant7: JSON.parse(text38Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber7Ger2MerliceRow2Plant7')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7Ger2MerliceRow2Plant7: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7Ger2MerliceRow2Plant7')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7Ger2MerliceRow2Plant7: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8Ger2MerliceRow2Plant7')
        .then(text41Value => {
          if (text41Value !== null) {
            this.setState({
              setFruits8Ger2MerliceRow2Plant7: JSON.parse(text41Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers8Ger2MerliceRow2Plant7')
        .then(text42Value => {
          if (text42Value !== null) {
            this.setState({
              setFlowers8Ger2MerliceRow2Plant7: JSON.parse(text42Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber8Ger2MerliceRow2Plant7')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8Ger2MerliceRow2Plant7: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8Ger2MerliceRow2Plant7')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8Ger2MerliceRow2Plant7: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9Ger2MerliceRow2Plant7')
        .then(text45Value => {
          if (text45Value !== null) {
            this.setState({
              setFruits9Ger2MerliceRow2Plant7: JSON.parse(text45Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers9Ger2MerliceRow2Plant7')
        .then(text46Value => {
          if (text46Value !== null) {
            this.setState({
              setFlowers9Ger2MerliceRow2Plant7: JSON.parse(text46Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber9Ger2MerliceRow2Plant7')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9Ger2MerliceRow2Plant7: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9Ger2MerliceRow2Plant7')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9Ger2MerliceRow2Plant7: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadGer2MerliceRow2Plant7')
        .then(text49Value => {
          if (text49Value !== null) {
            this.setState({
              fruitLoadGer2MerliceRow2Plant7: JSON.parse(text49Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('floweringTrussssGer2MerliceRow2Plant7')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssGer2MerliceRow2Plant7: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberGer2MerliceRow2Plant7')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberGer2MerliceRow2Plant7: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussGer2MerliceRow2Plant7')
        .then(text52Value => {
          if (text52Value !== null) {
            this.setState({
              harvestTrussGer2MerliceRow2Plant7: JSON.parse(text52Value),
            });
          }
        })
        .done();
  ...
  updateTextInput22 = (text, field) => {
    ...
    this.setState({
      trussNumber1Ger2MerliceRow2Plant7:
        Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 1,
    });
    this.setState({
      trussNumber2Ger2MerliceRow2Plant7:
        Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 2,
    });
    this.setState({
      trussNumber3Ger2MerliceRow2Plant7:
        Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 3,
    });
    this.setState({
      trussNumber4Ger2MerliceRow2Plant7:
        Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 4,
    });
    this.setState({
      trussNumber5Ger2MerliceRow2Plant7:
        Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 5,
    });
    this.setState({
      trussNumber6Ger2MerliceRow2Plant7:
        Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 6,
    });
    this.setState({
      trussNumber7Ger2MerliceRow2Plant7:
        Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 7,
    });
    this.setState({
      trussNumber8Ger2MerliceRow2Plant7:
        Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 8,
    });
    this.setState({
      trussNumber9Ger2MerliceRow2Plant7:
        Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 9,
    });
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      (Number.parseInt(this.state.setFruitsGer2MerliceRow2Plant7)
        ? Number.parseInt(this.state.setFruitsGer2MerliceRow2Plant7)
        : 0) +
      (Number.parseInt(this.state.setFruits1Ger2MerliceRow2Plant7)
        ? Number.parseInt(this.state.setFruits1Ger2MerliceRow2Plant7)
        : 0) +
      (Number.parseInt(this.state.setFruits2Ger2MerliceRow2Plant7)
        ? Number.parseInt(this.state.setFruits2Ger2MerliceRow2Plant7)
        : 0) +
      (Number.parseInt(this.state.setFruits3Ger2MerliceRow2Plant7)
        ? Number.parseInt(this.state.setFruits3Ger2MerliceRow2Plant7)
        : 0) +
      (Number.parseInt(this.state.setFruits4Ger2MerliceRow2Plant7)
        ? Number.parseInt(this.state.setFruits4Ger2MerliceRow2Plant7)
        : 0) +
      (Number.parseInt(this.state.setFruits5Ger2MerliceRow2Plant7)
        ? Number.parseInt(this.state.setFruits5Ger2MerliceRow2Plant7)
        : 0) +
      (Number.parseInt(this.state.setFruits6Ger2MerliceRow2Plant7)
        ? Number.parseInt(this.state.setFruits6Ger2MerliceRow2Plant7)
        : 0) +
      (Number.parseInt(this.state.setFruits7Ger2MerliceRow2Plant7)
        ? Number.parseInt(this.state.setFruits7Ger2MerliceRow2Plant7)
        : 0) +
      (Number.parseInt(this.state.setFruits8Ger2MerliceRow2Plant7)
        ? Number.parseInt(this.state.setFruits8Ger2MerliceRow2Plant7)
        : 0) +
      (Number.parseInt(this.state.setFruits9Ger2MerliceRow2Plant7)
        ? Number.parseInt(this.state.setFruits9Ger2MerliceRow2Plant7)
        : 0);
    this.setState({
    ...
    this.setItem(
      'fruitLoadGer2MerliceRow2Plant7',
      this.state.fruitLoadGer2MerliceRow2Plant7,
    );
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersGer2MerliceRow2Plant7 === '') {
      ...
      div =
        Number.parseInt(
          this.state.setFruitsGer2MerliceRow2Plant7
            ? this.state.setFruitsGer2MerliceRow2Plant7
            : 0,
        ) /
        parseFloat(
          this.state.pruningNumberGer2MerliceRow2Plant7
            ? this.state.pruningNumberGer2MerliceRow2Plant7
            : 0,
        );
      sub = 1 - div;
      ...
      this.setItem('pruningHarGer2MerliceRow2Plant7', prunNum);
    } else {
      prunNum = Number.parseInt(this.state.pruningNumberGer2MerliceRow2Plant7);
    ...
    this.setItem(
      'harvestTrussGer2MerliceRow2Plant7',
      this.state.harvestTrussGer2MerliceRow2Plant7,
    );
  };
  ...
  calculateSettingTruss2 = () => {
    ...
    console.log(
      'Setting truss called : ' + this.state.setFruits2Ger2MerliceRow2Plant7,
    );
    ...
    if (this.state.setFruits9Ger2MerliceRow2Plant7 === '') {
      if (this.state.setFruits8Ger2MerliceRow2Plant7 === '') {
        if (this.state.setFruits7Ger2MerliceRow2Plant7 === '') {
          if (this.state.setFruits6Ger2MerliceRow2Plant7 === '') {
            if (this.state.setFruits5Ger2MerliceRow2Plant7 === '') {
              if (this.state.setFruits4Ger2MerliceRow2Plant7 === '') {
                if (this.state.setFruits3Ger2MerliceRow2Plant7 === '') {
                  if (this.state.setFruits2Ger2MerliceRow2Plant7 === '') {
                    if (this.state.setFruits1Ger2MerliceRow2Plant7 === '') {
                      if (this.state.setFruitsGer2MerliceRow2Plant7 === '') {
                        ...
                        trussNum = Number.parseInt(
                          this.state.trussNumberGer2MerliceRow2Plant7,
                        );
                      ...
                      pruningSet = Number.parseInt(
                        this.state.pruningNumber1Ger2MerliceRow2Plant7,
                      );
                      trussNum = Number.parseInt(number);
                      settingFruit = Number.parseInt(
                        this.state.setFruits1Ger2MerliceRow2Plant7,
                      );
                      settingTruss = (
                        trussNum +
                        settingFruit / pruningSet
                    ...
                    pruningSet = Number.parseInt(
                      this.state.pruningNumber2Ger2MerliceRow2Plant7,
                    );
                    trussNum = Number.parseInt(number2);
                    settingFruit = Number.parseInt(
                      this.state.setFruits2Ger2MerliceRow2Plant7,
                    );
                    settingTruss = (
                      trussNum +
                      settingFruit / pruningSet
                  ...
                  pruningSet = Number.parseInt(
                    this.state.pruningNumber3Ger2MerliceRow2Plant7,
                  );
                  trussNum = Number.parseInt(number3);
                  settingFruit = Number.parseInt(
                    this.state.setFruits3Ger2MerliceRow2Plant7,
                  );
                  ...
                  this.setItem('prunSettingGer2MerliceRow2Plant7', pruningSet);
                }
              } else {
                var number4 =
                  Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) +
                ...
                pruningSet = Number.parseInt(
                  this.state.pruningNumber4Ger2MerliceRow2Plant7,
                );
                trussNum = Number.parseInt(number4);
                settingFruit = Number.parseInt(
                  this.state.setFruits4Ger2MerliceRow2Plant7,
                );
                settingTruss = (trussNum + settingFruit / pruningSet).toFixed(
                  2,
                );
              ...
              pruningSet = Number.parseInt(
                this.state.pruningNumber5Ger2MerliceRow2Plant7,
              );
              trussNum = Number.parseInt(number5);
              settingFruit = Number.parseInt(
                this.state.setFruits5Ger2MerliceRow2Plant7,
              );
            ...
            pruningSet = Number.parseInt(
              this.state.pruningNumber6Ger2MerliceRow2Plant7,
            );
            trussNum = Number.parseInt(number6);
            settingFruit = Number.parseInt(
              this.state.setFruits6Ger2MerliceRow2Plant7,
            );
            settingTruss = (trussNum + settingFruit / pruningSet).toFixed(2);
          ...
          pruningSet = Number.parseInt(
            this.state.pruningNumber7Ger2MerliceRow2Plant7,
          );
          trussNum = Number.parseInt(number7);
          settingFruit = Number.parseInt(
            this.state.setFruits7Ger2MerliceRow2Plant7,
          );
          settingTruss = (trussNum + settingFruit / pruningSet).toFixed(2);
        ...
        pruningSet = Number.parseInt(
          this.state.pruningNumber8Ger2MerliceRow2Plant7,
        );
        trussNum = Number.parseInt(number8);
        settingFruit = Number.parseInt(
          this.state.setFruits8Ger2MerliceRow2Plant7,
        );
        settingTruss = (trussNum + settingFruit / pruningSet).toFixed(2);
      ...
      pruningSet = Number.parseInt(
        this.state.pruningNumber9Ger2MerliceRow2Plant7,
      );
      trussNum = Number.parseInt(number9);
      settingFruit = Number.parseInt(
        this.state.setFruits9Ger2MerliceRow2Plant7,
      );
      settingTruss = (trussNum + settingFruit / pruningSet).toFixed(2);
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2Ger2MerliceRow2Plant7,
    );
    ...
    if (this.state.setFlowers9Ger2MerliceRow2Plant7 === '') {
      if (this.state.setFlowers8Ger2MerliceRow2Plant7 === '') {
        if (this.state.setFlowers7Ger2MerliceRow2Plant7 === '') {
          if (this.state.setFlowers6Ger2MerliceRow2Plant7 === '') {
            if (this.state.setFlowers5Ger2MerliceRow2Plant7 === '') {
              if (this.state.setFlowers4Ger2MerliceRow2Plant7 === '') {
                if (this.state.setFlowers3Ger2MerliceRow2Plant7 === '') {
                  if (this.state.setFlowers2Ger2MerliceRow2Plant7 === '') {
                    if (this.state.setFlowers1Ger2MerliceRow2Plant7 === '') {
                      if (this.state.setFlowersGer2MerliceRow2Plant7 === '') {
                        ...
                        flowering = Number.parseInt(
                          this.state.setFlowersGer2MerliceRow2Plant7,
                        );
                      ...
                      var number11 =
                        +this.state.trussNumberGer2MerliceRow2Plant7 + 1;
                      ...
                      flowering = Number.parseInt(
                        this.state.setFlowers1Ger2MerliceRow2Plant7,
                      );
                      flowerSetFruits = Number.parseInt(
                        this.state.setFruits1Ger2MerliceRow2Plant7,
                      );
                    ...
                    var number21 =
                      +this.state.trussNumberGer2MerliceRow2Plant7 + 2;

                    flowerPruningNumner = Number.parseInt(
                      this.state.pruningNumber2Ger2MerliceRow2Plant7,
                    );
                    flowering = Number.parseInt(
                      this.state.setFlowers2Ger2MerliceRow2Plant7,
                    );
                    flowerSetFruits = Number.parseInt(
                      this.state.setFruits2Ger2MerliceRow2Plant7,
                    );
                  ...
                  var number31 =
                    +this.state.trussNumberGer2MerliceRow2Plant7 + 3;

                  flowerPruningNumner = Number.parseInt(
                    this.state.pruningNumber3Ger2MerliceRow2Plant7,
                  );
                  flowering = Number.parseInt(
                    this.state.setFlowers3Ger2MerliceRow2Plant7,
                  );
                  flowerSetFruits = Number.parseInt(
                    this.state.setFruits3Ger2MerliceRow2Plant7,
                  );
                ...
                flowering = Number.parseInt(
                  this.state.setFlowers4Ger2MerliceRow2Plant7,
                );
                flowerSetFruits = Number.parseInt(
                  this.state.setFruits4Ger2MerliceRow2Plant7,
                );
              ...
              flowering = Number.parseInt(
                this.state.setFlowers5Ger2MerliceRow2Plant7,
              );
              flowerSetFruits = Number.parseInt(
                this.state.setFruits5Ger2MerliceRow2Plant7,
              );
            ...
            flowering = Number.parseInt(
              this.state.setFlowers6Ger2MerliceRow2Plant7,
            );
            flowerSetFruits = Number.parseInt(
              this.state.setFruits6Ger2MerliceRow2Plant7,
            );
          ...
          flowering = Number.parseInt(
            this.state.setFlowers7Ger2MerliceRow2Plant7,
          );
          flowerSetFruits = Number.parseInt(
            this.state.setFruits7Ger2MerliceRow2Plant7,
          );
        ...
        flowering = Number.parseInt(
          this.state.setFlowers8Ger2MerliceRow2Plant7,
        );
        flowerSetFruits = Number.parseInt(
          this.state.setFruits8Ger2MerliceRow2Plant7,
        );
      ...
      this.setItem('floweringTrussssGer2MerliceRow2Plant7', floweringTruss);
      this.setItem('pruneFloweringGer2MerliceRow2Plant7', flowerPruningNumner);
    }
  };
  //
      ...
      if (this.state.trussNumberGer2MerliceRow2Plant7 != null) {
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersGer2MerliceRow2Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsGer2MerliceRow2Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberGer2MerliceRow2Plant7: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1Ger2MerliceRow2Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1Ger2MerliceRow2Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1Ger2MerliceRow2Plant7: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2Ger2MerliceRow2Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2Ger2MerliceRow2Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2Ger2MerliceRow2Plant7: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3Ger2MerliceRow2Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3Ger2MerliceRow2Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3Ger2MerliceRow2Plant7: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4Ger2MerliceRow2Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4Ger2MerliceRow2Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4Ger2MerliceRow2Plant7: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5Ger2MerliceRow2Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5Ger2MerliceRow2Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5Ger2MerliceRow2Plant7: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6Ger2MerliceRow2Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6Ger2MerliceRow2Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6Ger2MerliceRow2Plant7: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7Ger2MerliceRow2Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7Ger2MerliceRow2Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7Ger2MerliceRow2Plant7: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8Ger2MerliceRow2Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8Ger2MerliceRow2Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8Ger2MerliceRow2Plant7: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9Ger2MerliceRow2Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9Ger2MerliceRow2Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9Ger2MerliceRow2Plant7: JSON.stringify(
  ...
  changeCheckbox = () => {
    this.setState({
      Ger2MerliceRow2Plant7Selected: !this.state.Ger2MerliceRow2Plant7Selected,
    });
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberGer2MerliceRow2Plant7 !== null &&
      this.state.pruningNumberGer2MerliceRow2Plant7 !== null
    ) {
      let data = {
  ...
  saveTrussToDB1 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 1 !=
        null &&
      this.state.pruningNumber1Ger2MerliceRow2Plant7 !== null
    ) {
      let data1 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 1,
  ...
  saveTrussToDB2 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 2 !=
        null &&
      this.state.pruningNumber2Ger2MerliceRow2Plant7 !== null
    ) {
      let data2 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 2,
  ...
  saveTrussToDB3 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 3 !==
        null &&
      this.state.pruningNumber3Ger2MerliceRow2Plant7 !== null
    ) {
      let data3 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 3,
  ...
  saveTrussToDB4 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 4 !=
        null &&
      this.state.pruningNumber4Ger2MerliceRow2Plant7 !== null
    ) {
      let data4 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 4,
  ...
  saveTrussToDB5 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 5 !=
        null &&
      this.state.pruningNumber5Ger2MerliceRow2Plant7 !== null
    ) {
      let data5 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 5,
  ...
  saveTrussToDB6 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 6 !=
        null &&
      this.state.pruningNumber6Ger2MerliceRow2Plant7 !== null
    ) {
      let data6 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 6,
  ...
  saveTrussToDB7 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 7 !=
        null &&
      this.state.pruningNumber7Ger2MerliceRow2Plant7 !== null
    ) {
      let data7 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 7,
  ...
  saveTrussToDB8 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 8 !=
        null &&
      this.state.pruningNumber8Ger2MerliceRow2Plant7 !== null
    ) {
      let data8 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 8,
  ...
  saveTrussToDB9 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 9 !=
        null &&
      this.state.pruningNumber9Ger2MerliceRow2Plant7 !== null
    ) {
      let data9 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer2MerliceRow2Plant7) + 9,
      ...
      <View style={styles.container}>
        ...
        <KeyboardAvoidingView
          ...
          <ScrollView
            ...
            <View
              pointerEvents={
                this.state.Ger2MerliceRow2Plant7Selected ? 'none' : 'auto'
              }>
              <View style={styles.formContainer}>
                  ...
                  <View style={styles.row}>
                    <View style={styles.borderEdit}>
                      <TextInput
                        ...
                        value={
                          this.state.floweringTrussHeightGer2MerliceRow2Plant7
                        }
                        ref={input => {
                  ...
                  <View style={styles.row}>
                    <View style={styles.borderEdit}>
                      <TextInput
                        ...
                        value={
                          this.state.lastWeekStmDiameterGer2MerliceRow2Plant7
                        }
                        ref={input => {
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadGer2MerliceRow2Plant7 <= 22 ||
                      this.state.fruitLoadGer2MerliceRow2Plant7 >= 40
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssGer2MerliceRow2Plant7 <= 0 ||
                      this.state.floweringTrussssGer2MerliceRow2Plant7 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}>
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssGer2MerliceRow2Plant7}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberGer2MerliceRow2Plant7 <= 1 ||
                      this.state.settingTrussNumberGer2MerliceRow2Plant7 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}>
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberGer2MerliceRow2Plant7}
                      </Text>
                    </View>
                    <View
                      style={{
