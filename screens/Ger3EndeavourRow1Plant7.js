...
export default class Ger3EndeavourRow1Plant7 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantGer3EndeavourRow1Plant7 = this.onSubmitleavesPerPlantGer3EndeavourRow1Plant7.bind(
      this,
    );
    ...
    this.leavesPerPlantGer3EndeavourRow1Plant7Ref = this.updateRef.bind(
      this,
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantGer3EndeavourRow1Plant7')
        .then(text1Value => {
          this.setState({
            leavesPerPlantGer3EndeavourRow1Plant7: JSON.parse(text1Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('fullySetTrussGer3EndeavourRow1Plant7')
        .then(text2Value => {
          this.setState({
            fullySetTrussGer3EndeavourRow1Plant7: JSON.parse(text2Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('setTrussLengthGer3EndeavourRow1Plant7')
        .then(text3Value => {
          this.setState({
            setTrussLengthGer3EndeavourRow1Plant7: JSON.parse(text3Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('weeklyGrowthGer3EndeavourRow1Plant7')
        .then(text4Value => {
          this.setState({
            weeklyGrowthGer3EndeavourRow1Plant7: JSON.parse(text4Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('floweringTrussHeightGer3EndeavourRow1Plant7')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightGer3EndeavourRow1Plant7: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthGer3EndeavourRow1Plant7')
        .then(text6Value => {
          this.setState({
            leafLengthGer3EndeavourRow1Plant7: JSON.parse(text6Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafWidthGer3EndeavourRow1Plant7')
        .then(text7Value => {
          this.setState({
            leafWidthGer3EndeavourRow1Plant7: JSON.parse(text7Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('stmDiameterGer3EndeavourRow1Plant7')
        .then(text8Value => {
          this.setState({
            stmDiameterGer3EndeavourRow1Plant7: JSON.parse(text8Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('lastWeekStmDiameterGer3EndeavourRow1Plant7')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterGer3EndeavourRow1Plant7: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('Ger3EndeavourRow1Plant7Selected')
        .then(text99Value => {
          this.setState({
            Ger3EndeavourRow1Plant7Selected: JSON.parse(text99Value),
          });
    ...
    try {
      AsyncStorage.getItem('trussNumberGer3EndeavourRow1Plant7')
        .then(text10Value => {
          if (text10Value !== null) {
            this.setState({
              trussNumberGer3EndeavourRow1Plant7: JSON.parse(text10Value),
            });

            this.setState({
              trussNumber1Ger3EndeavourRow1Plant7:
                Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) +
                1,
            });
            this.setState({
              trussNumber2Ger3EndeavourRow1Plant7:
    ...
    try {
      AsyncStorage.getItem('setFruitsGer3EndeavourRow1Plant7')
        .then(text11Value => {
          if (text11Value !== null) {
            this.setState({
              setFruitsGer3EndeavourRow1Plant7: JSON.parse(text11Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowersGer3EndeavourRow1Plant7')
        .then(text12Value => {
          if (text12Value !== null) {
            this.setState({
              setFlowersGer3EndeavourRow1Plant7: JSON.parse(text12Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumberGer3EndeavourRow1Plant7')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberGer3EndeavourRow1Plant7: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterGer3EndeavourRow1Plant7')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterGer3EndeavourRow1Plant7: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1Ger3EndeavourRow1Plant7')
        .then(text16Value => {
          if (text16Value !== null) {
            this.setState({
              setFruits1Ger3EndeavourRow1Plant7: JSON.parse(text16Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers1Ger3EndeavourRow1Plant7')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFlowers1Ger3EndeavourRow1Plant7: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber1Ger3EndeavourRow1Plant7')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1Ger3EndeavourRow1Plant7: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1Ger3EndeavourRow1Plant7')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1Ger3EndeavourRow1Plant7: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2Ger3EndeavourRow1Plant7')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFruits2Ger3EndeavourRow1Plant7: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers2Ger3EndeavourRow1Plant7')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              setFlowers2Ger3EndeavourRow1Plant7: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber2Ger3EndeavourRow1Plant7')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2Ger3EndeavourRow1Plant7: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2Ger3EndeavourRow1Plant7')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2Ger3EndeavourRow1Plant7: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3Ger3EndeavourRow1Plant7')
        .then(text21Value => {
          if (text21Value !== null) {
            this.setState({
              setFruits3Ger3EndeavourRow1Plant7: JSON.parse(text21Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers3Ger3EndeavourRow1Plant7')
        .then(text22Value => {
          if (text22Value !== null) {
            this.setState({
              setFlowers3Ger3EndeavourRow1Plant7: JSON.parse(text22Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber3Ger3EndeavourRow1Plant7')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3Ger3EndeavourRow1Plant7: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3Ger3EndeavourRow1Plant7')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3Ger3EndeavourRow1Plant7: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4Ger3EndeavourRow1Plant7')
        .then(text25Value => {
          if (text25Value !== null) {
            this.setState({
              setFruits4Ger3EndeavourRow1Plant7: JSON.parse(text25Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers4Ger3EndeavourRow1Plant7')
        .then(text26Value => {
          if (text26Value !== null) {
            this.setState({
              setFlowers4Ger3EndeavourRow1Plant7: JSON.parse(text26Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber4Ger3EndeavourRow1Plant7')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4Ger3EndeavourRow1Plant7: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4Ger3EndeavourRow1Plant7')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4Ger3EndeavourRow1Plant7: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5Ger3EndeavourRow1Plant7')
        .then(text29Value => {
          if (text29Value !== null) {
            this.setState({
              setFruits5Ger3EndeavourRow1Plant7: JSON.parse(text29Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers5Ger3EndeavourRow1Plant7')
        .then(text30Value => {
          if (text30Value !== null) {
            this.setState({
              setFlowers5Ger3EndeavourRow1Plant7: JSON.parse(text30Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber5Ger3EndeavourRow1Plant7')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5Ger3EndeavourRow1Plant7: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5Ger3EndeavourRow1Plant7')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5Ger3EndeavourRow1Plant7: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6Ger3EndeavourRow1Plant7')
        .then(text33Value => {
          if (text33Value !== null) {
            this.setState({
              setFruits6Ger3EndeavourRow1Plant7: JSON.parse(text33Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers6Ger3EndeavourRow1Plant7')
        .then(text34Value => {
          if (text34Value !== null) {
            this.setState({
              setFlowers6Ger3EndeavourRow1Plant7: JSON.parse(text34Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber6Ger3EndeavourRow1Plant7')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6Ger3EndeavourRow1Plant7: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6Ger3EndeavourRow1Plant7')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6Ger3EndeavourRow1Plant7: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7Ger3EndeavourRow1Plant7')
        .then(text37Value => {
          if (text37Value !== null) {
            this.setState({
              setFruits7Ger3EndeavourRow1Plant7: JSON.parse(text37Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers7Ger3EndeavourRow1Plant7')
        .then(text38Value => {
          if (text38Value !== null) {
            this.setState({
              setFlowers7Ger3EndeavourRow1Plant7: JSON.parse(text38Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber7Ger3EndeavourRow1Plant7')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7Ger3EndeavourRow1Plant7: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7Ger3EndeavourRow1Plant7')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7Ger3EndeavourRow1Plant7: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8Ger3EndeavourRow1Plant7')
        .then(text41Value => {
          if (text41Value !== null) {
            this.setState({
              setFruits8Ger3EndeavourRow1Plant7: JSON.parse(text41Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers8Ger3EndeavourRow1Plant7')
        .then(text42Value => {
          if (text42Value !== null) {
            this.setState({
              setFlowers8Ger3EndeavourRow1Plant7: JSON.parse(text42Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber8Ger3EndeavourRow1Plant7')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8Ger3EndeavourRow1Plant7: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8Ger3EndeavourRow1Plant7')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8Ger3EndeavourRow1Plant7: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9Ger3EndeavourRow1Plant7')
        .then(text45Value => {
          if (text45Value !== null) {
            this.setState({
              setFruits9Ger3EndeavourRow1Plant7: JSON.parse(text45Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers9Ger3EndeavourRow1Plant7')
        .then(text46Value => {
          if (text46Value !== null) {
            this.setState({
              setFlowers9Ger3EndeavourRow1Plant7: JSON.parse(text46Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber9Ger3EndeavourRow1Plant7')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9Ger3EndeavourRow1Plant7: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9Ger3EndeavourRow1Plant7')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9Ger3EndeavourRow1Plant7: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadGer3EndeavourRow1Plant7')
        .then(text49Value => {
          if (text49Value !== null) {
            this.setState({
              fruitLoadGer3EndeavourRow1Plant7: JSON.parse(text49Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('floweringTrussssGer3EndeavourRow1Plant7')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssGer3EndeavourRow1Plant7: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberGer3EndeavourRow1Plant7')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberGer3EndeavourRow1Plant7: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussGer3EndeavourRow1Plant7')
        .then(text52Value => {
          if (text52Value !== null) {
            this.setState({
              harvestTrussGer3EndeavourRow1Plant7: JSON.parse(text52Value),
            });
          }
        })
        .done();
  ...
  updateTextInput22 = (text, field) => {
    ...
    this.setState({
      trussNumber1Ger3EndeavourRow1Plant7:
        Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 1,
    });
    this.setState({
      trussNumber2Ger3EndeavourRow1Plant7:
        Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 2,
    });
    this.setState({
      trussNumber3Ger3EndeavourRow1Plant7:
        Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 3,
    });
    this.setState({
      trussNumber4Ger3EndeavourRow1Plant7:
        Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 4,
    });
    this.setState({
      trussNumber5Ger3EndeavourRow1Plant7:
        Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 5,
    });
    this.setState({
      trussNumber6Ger3EndeavourRow1Plant7:
        Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 6,
    });
    this.setState({
      trussNumber7Ger3EndeavourRow1Plant7:
        Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 7,
    });
    this.setState({
      trussNumber8Ger3EndeavourRow1Plant7:
        Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 8,
    });
    this.setState({
      trussNumber9Ger3EndeavourRow1Plant7:
        Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 9,
    });
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      (Number.parseInt(this.state.setFruitsGer3EndeavourRow1Plant7)
        ? Number.parseInt(this.state.setFruitsGer3EndeavourRow1Plant7)
        : 0) +
      (Number.parseInt(this.state.setFruits1Ger3EndeavourRow1Plant7)
        ? Number.parseInt(this.state.setFruits1Ger3EndeavourRow1Plant7)
        : 0) +
      (Number.parseInt(this.state.setFruits2Ger3EndeavourRow1Plant7)
        ? Number.parseInt(this.state.setFruits2Ger3EndeavourRow1Plant7)
        : 0) +
      (Number.parseInt(this.state.setFruits3Ger3EndeavourRow1Plant7)
        ? Number.parseInt(this.state.setFruits3Ger3EndeavourRow1Plant7)
        : 0) +
      (Number.parseInt(this.state.setFruits4Ger3EndeavourRow1Plant7)
        ? Number.parseInt(this.state.setFruits4Ger3EndeavourRow1Plant7)
        : 0) +
      (Number.parseInt(this.state.setFruits5Ger3EndeavourRow1Plant7)
        ? Number.parseInt(this.state.setFruits5Ger3EndeavourRow1Plant7)
        : 0) +
      (Number.parseInt(this.state.setFruits6Ger3EndeavourRow1Plant7)
        ? Number.parseInt(this.state.setFruits6Ger3EndeavourRow1Plant7)
        : 0) +
      (Number.parseInt(this.state.setFruits7Ger3EndeavourRow1Plant7)
        ? Number.parseInt(this.state.setFruits7Ger3EndeavourRow1Plant7)
        : 0) +
      (Number.parseInt(this.state.setFruits8Ger3EndeavourRow1Plant7)
        ? Number.parseInt(this.state.setFruits8Ger3EndeavourRow1Plant7)
        : 0) +
      (Number.parseInt(this.state.setFruits9Ger3EndeavourRow1Plant7)
        ? Number.parseInt(this.state.setFruits9Ger3EndeavourRow1Plant7)
        : 0);
    this.setState({
    ...
    this.setItem(
      'fruitLoadGer3EndeavourRow1Plant7',
      this.state.fruitLoadGer3EndeavourRow1Plant7,
    );
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersGer3EndeavourRow1Plant7 === '') {
      prunNum = Number.parseInt(this.state.pruningNumberGer3EndeavourRow1Plant7);

      div =
        Number.parseInt(
          this.state.setFruitsGer3EndeavourRow1Plant7
            ? this.state.setFruitsGer3EndeavourRow1Plant7
            : 0,
        ) /
        parseFloat(
          this.state.pruningNumberGer3EndeavourRow1Plant7
            ? this.state.pruningNumberGer3EndeavourRow1Plant7
            : 0,
        );
      sub = 1 - div;
    ...
    this.setItem(
      'harvestTrussGer3EndeavourRow1Plant7',
      this.state.harvestTrussGer3EndeavourRow1Plant7,
    );
  };
  ...
  calculateSettingTruss2 = () => {
    ...
    console.log(
      'Setting truss called : ' + this.state.setFruits2Ger3EndeavourRow1Plant7,
    );
    ...
    if (this.state.setFruits9Ger3EndeavourRow1Plant7 === '') {
      if (this.state.setFruits8Ger3EndeavourRow1Plant7 === '') {
        if (this.state.setFruits7Ger3EndeavourRow1Plant7 === '') {
          if (this.state.setFruits6Ger3EndeavourRow1Plant7 === '') {
            if (this.state.setFruits5Ger3EndeavourRow1Plant7 === '') {
              if (this.state.setFruits4Ger3EndeavourRow1Plant7 === '') {
                if (this.state.setFruits3Ger3EndeavourRow1Plant7 === '') {
                  if (this.state.setFruits2Ger3EndeavourRow1Plant7 === '') {
                    if (this.state.setFruits1Ger3EndeavourRow1Plant7 === '') {
                      if (this.state.setFruitsGer3EndeavourRow1Plant7 === '') {
                        ...
                        trussNum = Number.parseInt(
                          this.state.trussNumberGer3EndeavourRow1Plant7,
                        );
                      ...
                      pruningSet = Number.parseInt(
                        this.state.pruningNumber1Ger3EndeavourRow1Plant7,
                      );
                      trussNum = Number.parseInt(number);
                      settingFruit = Number.parseInt(
                        this.state.setFruits1Ger3EndeavourRow1Plant7,
                      );
                      settingTruss = (
                        trussNum +
                        settingFruit / pruningSet
                    ...
                    pruningSet = Number.parseInt(
                      this.state.pruningNumber2Ger3EndeavourRow1Plant7,
                    );
                    trussNum = Number.parseInt(number2);
                    settingFruit = Number.parseInt(
                      this.state.setFruits2Ger3EndeavourRow1Plant7,
                    );
                    settingTruss = (
                      trussNum +
                      settingFruit / pruningSet
                  ...
                  pruningSet = Number.parseInt(
                    this.state.pruningNumber3Ger3EndeavourRow1Plant7,
                  );
                  trussNum = Number.parseInt(number3);
                  settingFruit = Number.parseInt(
                    this.state.setFruits3Ger3EndeavourRow1Plant7,
                  );
                ...
                pruningSet = Number.parseInt(
                  this.state.pruningNumber4Ger3EndeavourRow1Plant7,
                );
                trussNum = Number.parseInt(number4);
                settingFruit = Number.parseInt(
                  this.state.setFruits4Ger3EndeavourRow1Plant7,
                );
                settingTruss = (trussNum + settingFruit / pruningSet).toFixed(
                  2,
                );
              ...
              pruningSet = Number.parseInt(
                this.state.pruningNumber5Ger3EndeavourRow1Plant7,
              );
              trussNum = Number.parseInt(number5);
              settingFruit = Number.parseInt(
                this.state.setFruits5Ger3EndeavourRow1Plant7,
              );
            ...
            pruningSet = Number.parseInt(
              this.state.pruningNumber6Ger3EndeavourRow1Plant7,
            );
            trussNum = Number.parseInt(number6);
            settingFruit = Number.parseInt(
              this.state.setFruits6Ger3EndeavourRow1Plant7,
            );
            settingTruss = (trussNum + settingFruit / pruningSet).toFixed(2);
          ...
          pruningSet = Number.parseInt(
            this.state.pruningNumber7Ger3EndeavourRow1Plant7,
          );
          trussNum = Number.parseInt(number7);
          settingFruit = Number.parseInt(
            this.state.setFruits7Ger3EndeavourRow1Plant7,
          );
          settingTruss = (trussNum + settingFruit / pruningSet).toFixed(2);
        ...
        pruningSet = Number.parseInt(
          this.state.pruningNumber8Ger3EndeavourRow1Plant7,
        );
        trussNum = Number.parseInt(number8);
        settingFruit = Number.parseInt(
          this.state.setFruits8Ger3EndeavourRow1Plant7,
        );
        settingTruss = (trussNum + settingFruit / pruningSet).toFixed(2);
      ...
      pruningSet = Number.parseInt(
        this.state.pruningNumber9Ger3EndeavourRow1Plant7,
      );
      trussNum = Number.parseInt(number9);
      settingFruit = Number.parseInt(
        this.state.setFruits9Ger3EndeavourRow1Plant7,
      );
      settingTruss = (trussNum + settingFruit / pruningSet).toFixed(2);
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2Ger3EndeavourRow1Plant7,
    );
    ...
    if (this.state.setFlowers9Ger3EndeavourRow1Plant7 === '') {
      if (this.state.setFlowers8Ger3EndeavourRow1Plant7 === '') {
        if (this.state.setFlowers7Ger3EndeavourRow1Plant7 === '') {
          if (this.state.setFlowers6Ger3EndeavourRow1Plant7 === '') {
            if (this.state.setFlowers5Ger3EndeavourRow1Plant7 === '') {
              if (this.state.setFlowers4Ger3EndeavourRow1Plant7 === '') {
                if (this.state.setFlowers3Ger3EndeavourRow1Plant7 === '') {
                  if (this.state.setFlowers2Ger3EndeavourRow1Plant7 === '') {
                    if (this.state.setFlowers1Ger3EndeavourRow1Plant7 === '') {
                      if (this.state.setFlowersGer3EndeavourRow1Plant7 === '') {
                        ...
                        flowering = Number.parseInt(
                          this.state.setFlowersGer3EndeavourRow1Plant7,
                        );
                      ...
                      var number11 =
                        +this.state.trussNumberGer3EndeavourRow1Plant7 + 1;
                      ...
                      flowering = Number.parseInt(
                        this.state.setFlowers1Ger3EndeavourRow1Plant7,
                      );
                      flowerSetFruits = Number.parseInt(
                        this.state.setFruits1Ger3EndeavourRow1Plant7,
                      );
                    ...
                    var number21 =
                      +this.state.trussNumberGer3EndeavourRow1Plant7 + 2;

                    flowerPruningNumner = Number.parseInt(
                      this.state.pruningNumber2Ger3EndeavourRow1Plant7,
                    );
                    flowering = Number.parseInt(
                      this.state.setFlowers2Ger3EndeavourRow1Plant7,
                    );
                    flowerSetFruits = Number.parseInt(
                      this.state.setFruits2Ger3EndeavourRow1Plant7,
                    );
                  ...
                  var number31 =
                    +this.state.trussNumberGer3EndeavourRow1Plant7 + 3;

                  flowerPruningNumner = Number.parseInt(
                    this.state.pruningNumber3Ger3EndeavourRow1Plant7,
                  );
                  flowering = Number.parseInt(
                    this.state.setFlowers3Ger3EndeavourRow1Plant7,
                  );
                  flowerSetFruits = Number.parseInt(
                    this.state.setFruits3Ger3EndeavourRow1Plant7,
                  );
                ...
                flowering = Number.parseInt(
                  this.state.setFlowers4Ger3EndeavourRow1Plant7,
                );
                flowerSetFruits = Number.parseInt(
                  this.state.setFruits4Ger3EndeavourRow1Plant7,
                );
              ...
              flowering = Number.parseInt(
                this.state.setFlowers5Ger3EndeavourRow1Plant7,
              );
              flowerSetFruits = Number.parseInt(
                this.state.setFruits5Ger3EndeavourRow1Plant7,
              );
            ...
            flowering = Number.parseInt(
              this.state.setFlowers6Ger3EndeavourRow1Plant7,
            );
            flowerSetFruits = Number.parseInt(
              this.state.setFruits6Ger3EndeavourRow1Plant7,
            );
          ...
          flowering = Number.parseInt(
            this.state.setFlowers7Ger3EndeavourRow1Plant7,
          );
          flowerSetFruits = Number.parseInt(
            this.state.setFruits7Ger3EndeavourRow1Plant7,
          );
        ...
        flowering = Number.parseInt(
          this.state.setFlowers8Ger3EndeavourRow1Plant7,
        );
        flowerSetFruits = Number.parseInt(
          this.state.setFruits8Ger3EndeavourRow1Plant7,
        );
      ...
      flowering = Number.parseInt(this.state.setFlowers9Ger3EndeavourRow1Plant7);
      flowerSetFruits = Number.parseInt(
        this.state.setFruits9Ger3EndeavourRow1Plant7,
      );
      summ =
      ...
      if (this.state.trussNumberGer3EndeavourRow1Plant7 != null) {
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersGer3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsGer3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberGer3EndeavourRow1Plant7: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1Ger3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1Ger3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1Ger3EndeavourRow1Plant7: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2Ger3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2Ger3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2Ger3EndeavourRow1Plant7: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3Ger3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3Ger3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3Ger3EndeavourRow1Plant7: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4Ger3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4Ger3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4Ger3EndeavourRow1Plant7: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5Ger3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5Ger3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5Ger3EndeavourRow1Plant7: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6Ger3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6Ger3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6Ger3EndeavourRow1Plant7: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7Ger3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7Ger3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7Ger3EndeavourRow1Plant7: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8Ger3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8Ger3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8Ger3EndeavourRow1Plant7: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9Ger3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9Ger3EndeavourRow1Plant7: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9Ger3EndeavourRow1Plant7: JSON.stringify(
  ...
  changeCheckbox = () => {
    this.setState({
      Ger3EndeavourRow1Plant7Selected: !this.state.Ger3EndeavourRow1Plant7Selected,
    });
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberGer3EndeavourRow1Plant7 !== null &&
      this.state.pruningNumberGer3EndeavourRow1Plant7 !== null
    ) {
      let data = {
  ...
  saveTrussToDB1 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 1 !=
        null &&
      this.state.pruningNumber1Ger3EndeavourRow1Plant7 !== null
    ) {
      let data1 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 1,
  ...
  saveTrussToDB2 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 2 !=
        null &&
      this.state.pruningNumber2Ger3EndeavourRow1Plant7 !== null
    ) {
      let data2 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 2,
  ...
  saveTrussToDB3 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 3 !==
        null &&
      this.state.pruningNumber3Ger3EndeavourRow1Plant7 !== null
    ) {
      let data3 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 3,
  ...
  saveTrussToDB4 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 4 !=
        null &&
      this.state.pruningNumber4Ger3EndeavourRow1Plant7 !== null
    ) {
      let data4 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 4,
  ...
  saveTrussToDB5 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 5 !=
        null &&
      this.state.pruningNumber5Ger3EndeavourRow1Plant7 !== null
    ) {
      let data5 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 5,
  ...
  saveTrussToDB6 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 6 !=
        null &&
      this.state.pruningNumber6Ger3EndeavourRow1Plant7 !== null
    ) {
      let data6 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 6,
  ...
  saveTrussToDB7 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 7 !=
        null &&
      this.state.pruningNumber7Ger3EndeavourRow1Plant7 !== null
    ) {
      let data7 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 7,
  ...
  saveTrussToDB8 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 8 !=
        null &&
      this.state.pruningNumber8Ger3EndeavourRow1Plant7 !== null
    ) {
      let data8 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 8,
  ...
  saveTrussToDB9 = () => {
    if (
      Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 9 !=
        null &&
      this.state.pruningNumber9Ger3EndeavourRow1Plant7 !== null
    ) {
      let data9 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberGer3EndeavourRow1Plant7) + 9,
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 7</Text>/ Row No. 125&amp;126/
        ...
        <KeyboardAvoidingView
          ...
          <ScrollView
            ...
            <View
              pointerEvents={
                this.state.Ger3EndeavourRow1Plant7Selected ? 'none' : 'auto'
              }>
              <View style={styles.formContainer}>
                  ...
                  <View style={styles.row}>
                    <View style={styles.borderEdit}>
                      <TextInput
                        ...
                        value={
                          this.state.floweringTrussHeightGer3EndeavourRow1Plant7
                        }
                        ref={input => {
                  ...
                  <View style={styles.row}>
                    <View style={styles.borderEdit}>
                      <TextInput
                        ...
                        value={
                          this.state.lastWeekStmDiameterGer3EndeavourRow1Plant7
                        }
                        ref={input => {
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadGer3EndeavourRow1Plant7 <= 22 ||
                      this.state.fruitLoadGer3EndeavourRow1Plant7 >= 40
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssGer3EndeavourRow1Plant7 <= 0 ||
                      this.state.floweringTrussssGer3EndeavourRow1Plant7 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}>
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssGer3EndeavourRow1Plant7}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberGer3EndeavourRow1Plant7 <= 1 ||
                      this.state.settingTrussNumberGer3EndeavourRow1Plant7 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}>
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberGer3EndeavourRow1Plant7}
                      </Text>
                    </View>
                    <View
                      style={{
                ...
                <TouchableOpacity
                  onPress={() =>
                    this.props.navigation.navigate('Ger3DataChecker', {name : 'Ger3EndeavourRow1Plant7', row : '125/126', plant: 7})
                  }>
