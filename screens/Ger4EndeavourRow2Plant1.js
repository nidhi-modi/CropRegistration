...
export default class Ger4EndeavourRow2Plant1 extends Component {
  ...
  renderEntryData = () => {
    ...
    try {
      AsyncStorage.getItem('@MySuperStore:plantKey').then((plantValues) => {
        ...
        //Change week number
        const weekRowPlant = d => d.plantName === 'GER 4 - Endeavour' && d.plantNumber === 1 && d.plantRow === 70/71 && d.plantWeek === this.state.weekNumber;
    ...
    try {
      AsyncStorage.getItem('@MySuperStore:trussKey').then((trussValues) => {
        ...
        //Change week number
        const weekRowTruss = d => d.plantName === 'GER 4 - Endeavour' && d.plantNumber === '1' && d.plantRow === 70/71 && d.plantWeek === this.state.weekNumber;
    ...
    try {
      AsyncStorage.getItem('trussNumberGer4EndeavourRow2Plant1').then((text10Value) => {
        ...
        if (text10Value !== null) {
          ...
          this.setState({ trussNumber1Ger4EndeavourRow2Plant1: parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 1 })
          this.setState({ trussNumber2Ger4EndeavourRow2Plant1: parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 2 })
          this.setState({ trussNumber3Ger4EndeavourRow2Plant1: parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 3 })
          this.setState({ trussNumber4Ger4EndeavourRow2Plant1: parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 4 })
          this.setState({ trussNumber5Ger4EndeavourRow2Plant1: parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 5 })
          this.setState({ trussNumber6Ger4EndeavourRow2Plant1: parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 6 })
          this.setState({ trussNumber7Ger4EndeavourRow2Plant1: parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 7 })
          this.setState({ trussNumber8Ger4EndeavourRow2Plant1: parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 8 })
          this.setState({ trussNumber9Ger4EndeavourRow2Plant1: parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 9 })
  ...
  calculateFruitLoad = () => {
    ...
    sum = ((parseInt(this.state.setFruitsGer4EndeavourRow2Plant1) ? parseInt(this.state.setFruitsGer4EndeavourRow2Plant1) : 0) + (parseInt(this.state.setFruits1Ger4EndeavourRow2Plant1) ? parseInt(this.state.setFruits1Ger4EndeavourRow2Plant1) : 0) + (parseInt(this.state.setFruits2Ger4EndeavourRow2Plant1) ? parseInt(this.state.setFruits2Ger4EndeavourRow2Plant1) : 0) + (parseInt(this.state.setFruits3Ger4EndeavourRow2Plant1) ? parseInt(this.state.setFruits3Ger4EndeavourRow2Plant1) : 0) + (parseInt(this.state.setFruits4Ger4EndeavourRow2Plant1) ? parseInt(this.state.setFruits4Ger4EndeavourRow2Plant1) : 0) + (parseInt(this.state.setFruits5Ger4EndeavourRow2Plant1) ? parseInt(this.state.setFruits5Ger4EndeavourRow2Plant1) : 0) + (parseInt(this.state.setFruits6Ger4EndeavourRow2Plant1) ? parseInt(this.state.setFruits6Ger4EndeavourRow2Plant1) : 0) + (parseInt(this.state.setFruits7Ger4EndeavourRow2Plant1) ? parseInt(this.state.setFruits7Ger4EndeavourRow2Plant1) : 0) + (parseInt(this.state.setFruits8Ger4EndeavourRow2Plant1) ? parseInt(this.state.setFruits8Ger4EndeavourRow2Plant1) : 0) + (parseInt(this.state.setFruits9Ger4EndeavourRow2Plant1) ? parseInt(this.state.setFruits9Ger4EndeavourRow2Plant1) : 0));
    this.setState({
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersGer4EndeavourRow2Plant1 === "") {
      ...
      prunNum = parseInt(this.state.pruningNumberGer4EndeavourRow2Plant1)

      div = (parseInt((this.state.setFruitsGer4EndeavourRow2Plant1) ? (this.state.setFruitsGer4EndeavourRow2Plant1) : 0) / parseFloat((this.state.pruningNumberGer4EndeavourRow2Plant1) ? (this.state.pruningNumberGer4EndeavourRow2Plant1) : 0))
      sub = (1 - div);
      add = (((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) ? parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) : 0) + sub).toFixed(2))
      this.setState({
  ...
  calculateSettingTruss2 = () => {
    ...
    if (this.state.setFruits9Ger4EndeavourRow2Plant1 === "") {
      ...
      if (this.state.setFruits8Ger4EndeavourRow2Plant1 === "") {
        ...
        if (this.state.setFruits7Ger4EndeavourRow2Plant1 === "") {
          ...
          if (this.state.setFruits6Ger4EndeavourRow2Plant1 === "") {
            ...
            if (this.state.setFruits5Ger4EndeavourRow2Plant1 === "") {
              ...
              if (this.state.setFruits4Ger4EndeavourRow2Plant1 === "") {
                ...
                if (this.state.setFruits3Ger4EndeavourRow2Plant1 === "") {
                  ...
                  if (this.state.setFruits2Ger4EndeavourRow2Plant1 === "") {
                    ...
                    if (this.state.setFruits1Ger4EndeavourRow2Plant1 === "") {
                      ...
                      if (this.state.setFruitsGer4EndeavourRow2Plant1 === "") {
                        ...
                        pruningSet = parseInt(this.state.pruningNumberGer4EndeavourRow2Plant1);
                        trussNum = parseInt(this.state.trussNumberGer4EndeavourRow2Plant1);
                        settingFruit = parseInt(this.state.setFruitsGer4EndeavourRow2Plant1);
                      ...
                      var number = (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 1)

                      pruningSet = parseInt(this.state.pruningNumber1Ger4EndeavourRow2Plant1);
                      trussNum = parseInt(number);
                      settingFruit = parseInt(this.state.setFruits1Ger4EndeavourRow2Plant1);
                      settingTruss = ((trussNum + (settingFruit / pruningSet)).toFixed(2));
                    ...
                    var number2 = (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 2)

                    pruningSet = parseInt(this.state.pruningNumber2Ger4EndeavourRow2Plant1);
                    trussNum = parseInt(number2);
                    settingFruit = parseInt(this.state.setFruits2Ger4EndeavourRow2Plant1);
                    settingTruss = ((trussNum + (settingFruit / pruningSet)).toFixed(2));
                  ...
                  var number3 = (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 3)

                  pruningSet = parseInt(this.state.pruningNumber3Ger4EndeavourRow2Plant1);
                  trussNum = parseInt(number3);
                  settingFruit = parseInt(this.state.setFruits3Ger4EndeavourRow2Plant1);
                  settingTruss = ((trussNum + (settingFruit / pruningSet)).toFixed(2));
                ...
                var number4 = (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 4)

                pruningSet = parseInt(this.state.pruningNumber4Ger4EndeavourRow2Plant1);
                trussNum = parseInt(number4);
                settingFruit = parseInt(this.state.setFruits4Ger4EndeavourRow2Plant1);
                settingTruss = ((trussNum + (settingFruit / pruningSet)).toFixed(2));
              ...
              var number5 = (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 5)

              pruningSet = parseInt(this.state.pruningNumber5Ger4EndeavourRow2Plant1);
              trussNum = parseInt(number5);
              settingFruit = parseInt(this.state.setFruits5Ger4EndeavourRow2Plant1);
              settingTruss = ((trussNum + (settingFruit / pruningSet)).toFixed(2));
            ...
            var number6 = (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 6)

            pruningSet = parseInt(this.state.pruningNumber6Ger4EndeavourRow2Plant1);
            trussNum = parseInt(number6);
            settingFruit = parseInt(this.state.setFruits6Ger4EndeavourRow2Plant1);
            settingTruss = ((trussNum + (settingFruit / pruningSet)).toFixed(2));
          ...
          var number7 = (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 7)

          pruningSet = parseInt(this.state.pruningNumber7Ger4EndeavourRow2Plant1);
          trussNum = parseInt(number7);
          settingFruit = parseInt(this.state.setFruits7Ger4EndeavourRow2Plant1);
          settingTruss = ((trussNum + (settingFruit / pruningSet)).toFixed(2));
        ...
        var number8 = (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 8)

        pruningSet = parseInt(this.state.pruningNumber8Ger4EndeavourRow2Plant1);
        trussNum = parseInt(number8);
        settingFruit = parseInt(this.state.setFruits8Ger4EndeavourRow2Plant1);
        settingTruss = ((trussNum + (settingFruit / pruningSet)).toFixed(2));
      ...
      var number9 = (ParseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 9)

      pruningSet = parseInt(this.state.pruningNumber9Ger4EndeavourRow2Plant1);
      trussNum = parseInt(number9);
      settingFruit = parseInt(this.state.setFruits9Ger4EndeavourRow2Plant1);
      settingTruss = ((trussNum + (settingFruit / pruningSet)).toFixed(2));
  ...
  calculateFloweringTruss2 = () => {
    ...
    if (this.state.setFlowers9Ger4EndeavourRow2Plant1 === "") {
      ...
      if (this.state.setFlowers8Ger4EndeavourRow2Plant1 === "") {
        ...
        if (this.state.setFlowers7Ger4EndeavourRow2Plant1 === "") {
          ...
          if (this.state.setFlowers6Ger4EndeavourRow2Plant1 === "") {
            ...
            if (this.state.setFlowers5Ger4EndeavourRow2Plant1 === "") {
              ...
              if (this.state.setFlowers4Ger4EndeavourRow2Plant1 === "") {
                ...
                if (this.state.setFlowers3Ger4EndeavourRow2Plant1 === "") {
                  ...
                  if (this.state.setFlowers2Ger4EndeavourRow2Plant1 === "") {
                    ...
                    if (this.state.setFlowers1Ger4EndeavourRow2Plant1 === "") {
                      ...
                      if (this.state.setFlowersGer4EndeavourRow2Plant1 === "") {
                        ...
                        flowerPruningNumner = parseInt(this.state.pruningNumberGer4EndeavourRow2Plant1);
                        flowering = parseInt(this.state.setFlowersGer4EndeavourRow2Plant1);
                        flowerSetFruits = parseInt(this.state.setFruitsGer4EndeavourRow2Plant1);
                      ...
                      flowerPruningNumner = parseInt(this.state.pruningNumber1Ger4EndeavourRow2Plant1);
                      flowering = parseInt(this.state.setFlowers1Ger4EndeavourRow2Plant1);
                      flowerSetFruits = parseInt(this.state.setFruits1Ger4EndeavourRow2Plant1);
                      trussNum = number11
                      summ = (flowering ? flowering : 0) + (flowerSetFruits ? flowerSetFruits : 0);
                    ...
                    flowerPruningNumner = parseInt(this.state.pruningNumber2Ger4EndeavourRow2Plant1);
                    flowering = parseInt(this.state.setFlowers2Ger4EndeavourRow2Plant1);
                    flowerSetFruits = parseInt(this.state.setFruits2Ger4EndeavourRow2Plant1);
                    summ = (flowering ? flowering : 0) + (flowerSetFruits ? flowerSetFruits : 0);
                  ...
                  flowerPruningNumner = parseInt(this.state.pruningNumber3Ger4EndeavourRow2Plant1);
                  flowering = parseInt(this.state.setFlowers3Ger4EndeavourRow2Plant1);
                  flowerSetFruits = parseInt(this.state.setFruits3Ger4EndeavourRow2Plant1);
                  summ = (flowering ? flowering : 0) + (flowerSetFruits ? flowerSetFruits : 0);
                ...
                flowerPruningNumner = parseInt(this.state.pruningNumber4Ger4EndeavourRow2Plant1);
                flowering = parseInt(this.state.setFlowers4Ger4EndeavourRow2Plant1);
                flowerSetFruits = parseInt(this.state.setFruits4Ger4EndeavourRow2Plant1);
                summ = (flowering ? flowering : 0) + (flowerSetFruits ? flowerSetFruits : 0);
              ...
              flowerPruningNumner = parseInt(this.state.pruningNumber5Ger4EndeavourRow2Plant1);
              flowering = parseInt(this.state.setFlowers5Ger4EndeavourRow2Plant1);
              flowerSetFruits = parseInt(this.state.setFruits5Ger4EndeavourRow2Plant1);
              summ = (flowering ? flowering : 0) + (flowerSetFruits ? flowerSetFruits : 0);
            ...
            flowerPruningNumner = parseInt(this.state.pruningNumber6Ger4EndeavourRow2Plant1);
            flowering = parseInt(this.state.setFlowers6Ger4EndeavourRow2Plant1);
            flowerSetFruits = parseInt(this.state.setFruits6Ger4EndeavourRow2Plant1);
            summ = (flowering ? flowering : 0) + (flowerSetFruits ? flowerSetFruits : 0);
          ...
          flowerPruningNumner = parseInt(this.state.pruningNumber7Ger4EndeavourRow2Plant1);
          flowering = parseInt(this.state.setFlowers7Ger4EndeavourRow2Plant1);
          flowerSetFruits = parseInt(this.state.setFruits7Ger4EndeavourRow2Plant1);
          summ = (flowering ? flowering : 0) + (flowerSetFruits ? flowerSetFruits : 0);
        ...
        flowerPruningNumner = parseInt(this.state.pruningNumber8Ger4EndeavourRow2Plant1);
        flowering = parseInt(this.state.setFlowers8Ger4EndeavourRow2Plant1);
        flowerSetFruits = parseInt(this.state.setFruits8Ger4EndeavourRow2Plant1);
        summ = (flowering ? flowering : 0) + (flowerSetFruits ? flowerSetFruits : 0);
      ...
      flowerPruningNumner = parseInt(this.state.pruningNumber9Ger4EndeavourRow2Plant1);
      flowering = parseInt(this.state.setFlowers9Ger4EndeavourRow2Plant1);
      flowerSetFruits = parseInt(this.state.setFruits9Ger4EndeavourRow2Plant1);
      summ = (flowering ? flowering : 0) + (flowerSetFruits ? flowerSetFruits : 0);
  ...
  getTrussData = () => {
    ...
    if (this.state.allTrussData.length != 0) {
      ...
      if (this.state.trussNumberGer4EndeavourRow2Plant1 != null) {
        ...
        //Change week number
        const weekRowTruss1 = d => d.trussNumber === parseInt(this.state.trussNumberGer4EndeavourRow2Plant1);
      ...
      //2nd Truss
      if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 1) != null) {

        //Change week number
        const weekRowTruss2 = d => d.trussNumber === (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 1);
      ...
      //3rd Truss
      if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 2) != null) {

        //Change week number
        const weekRowTruss3 = d => d.trussNumber === (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 2);
      ...
      //4th Truss
      if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 3) != null) {

        //Change week number
        const weekRowTruss4 = d => d.trussNumber === (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 3);
      ...
      //5th Truss
      if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 4) != null) {

        //Change week number
        const weekRowTruss5 = d => d.trussNumber === (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 4);
      ...
      //6th Truss
      if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 5) != null) {

        //Change week number
        const weekRowTruss6 = d => d.trussNumber === (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 5);
      ...
      //7th Truss
      if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 6) != null) {

        //Change week number
        const weekRowTruss7 = d => d.trussNumber === (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 6);
      ...
      //8th Truss
      if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 7) != null) {

        //Change week number
        const weekRowTruss8 = d => d.trussNumber === (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 7);
      ...
      //9th Truss
      if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 8) != null) {

        //Change week number
        const weekRowTruss9 = d => d.trussNumber === (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 8);
      ...
      //10th Truss
      if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 9) != null) {

        //Change week number
        const weekRowTruss10 = d => d.trussNumber === (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 9);
  ...
  saveTrussToDb = () => {
    ...
    if (this.state.trussNumberGer4EndeavourRow2Plant1 !== null && this.state.pruningNumberGer4EndeavourRow2Plant1 !== null) {
      ...
      db.addTrussDetails(data).then((result) => {
        ...
        if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 1) !== null && this.state.pruningNumber1Ger4EndeavourRow2Plant1 !== '') {
  ...
  saveTrussToDB1 = () => {
    ...
    if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 1) != null && this.state.pruningNumber1Ger4EndeavourRow2Plant1 !== null) {


      let data1 = {

        trussNumber: (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 1),
      ...
      db.addTrussDetails(data1).then((result) => {
        ...
        if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 2) !== null && this.state.pruningNumber2Ger4EndeavourRow2Plant1 !== '') {
  ...
  saveTrussToDB2 = () => {
    ...
    if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 2) != null && this.state.pruningNumber2Ger4EndeavourRow2Plant1 !== null) {


      let data2 = {

        trussNumber: (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 2),
      ...
      db.addTrussDetails(data2).then((result) => {
        ...
        if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 3) !== null && this.state.pruningNumber3Ger4EndeavourRow2Plant1 !== '') {
  ...
  saveTrussToDB3 = () => {
    ...
    if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 3) !== null && this.state.pruningNumber3Ger4EndeavourRow2Plant1 !== null) {


      let data3 = {
        trussNumber: (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 3),
      ...
      db.addTrussDetails(data3).then((result) => {
        ...
        if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 4) !== null && this.state.pruningNumber4Ger4EndeavourRow2Plant1 !== '') {
  ...
  saveTrussToDB4 = () => {
    ...
    if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 4) != null && this.state.pruningNumber4Ger4EndeavourRow2Plant1 !== null) {


      let data4 = {
        trussNumber: (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 4),
      ...
      db.addTrussDetails(data4).then((result) => {
        ...
        if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 5) !== null && this.state.pruningNumber5Ger4EndeavourRow2Plant1 !== '') {
  ...
  saveTrussToDB5 = () => {
    ...
    if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 5) != null && this.state.pruningNumber5Ger4EndeavourRow2Plant1 !== null) {


      let data5 = {
        trussNumber: (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 5),
      ...
      db.addTrussDetails(data5).then((result) => {
        ...
        if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 6) !== null && this.state.pruningNumber6Ger4EndeavourRow2Plant1 !== '') {
  ...
  saveTrussToDB6 = () => {
    ...
    if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 6) != null && this.state.pruningNumber6Ger4EndeavourRow2Plant1 !== null) {


      let data6 = {
        trussNumber: (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 6),
      ...
      db.addTrussDetails(data6).then((result) => {
        ...
        if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 7) !== null && this.state.pruningNumber7Ger4EndeavourRow2Plant1 !== '') {
  ...
  saveTrussToDB7 = () => {
    ...
    if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 7) != null && this.state.pruningNumber7Ger4EndeavourRow2Plant1 !== null) {


      let data7 = {
        trussNumber: (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 7),
      ...
      db.addTrussDetails(data7).then((result) => {
        ...
        if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 8) !== null && this.state.pruningNumber8Ger4EndeavourRow2Plant1 !== '') {
  ...
  saveTrussToDB8 = () => {
    ...
    if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 8) != null && this.state.pruningNumber8Ger4EndeavourRow2Plant1 !== null) {


      let data8 = {
        trussNumber: (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 8),
      ...
      db.addTrussDetails(data8).then((result) => {
        ...
        if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 9) !== null && this.state.pruningNumber9Ger4EndeavourRow2Plant1 !== '') {
  ...
  saveTrussToDB9 = () => {
    ...
    if ((parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 9) != null && this.state.pruningNumber9Ger4EndeavourRow2Plant1 !== null) {



      let data9 = {
        trussNumber: (parseInt(this.state.trussNumberGer4EndeavourRow2Plant1) + 9),
