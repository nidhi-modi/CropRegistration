...
export default class Ger4EndeavourRow2Plant1 extends Component {
  ...
  checkStatus = () => {
    ...
    if (vart == null || vart == false) {
      ...
      const { leavesPerPlantGer4EndeavourRow2Plant1 } = this.state;
      const { fullySetTrussGer4EndeavourRow2Plant1 } = this.state;
      const { setTrussLengthGer4EndeavourRow2Plant1 } = this.state;
      const { weeklyGrowthGer4EndeavourRow2Plant1 } = this.state;
      const { floweringTrussHeightGer4EndeavourRow2Plant1 } = this.state;
      const { leafLengthGer4EndeavourRow2Plant1 } = this.state;
      const { leafWidthGer4EndeavourRow2Plant1 } = this.state;
      const { stmDiameterGer4EndeavourRow2Plant1 } = this.state;
      const { lastWeekStmDiameterGer4EndeavourRow2Plant1 } = this.state;
      ...
      if (+!isNaN(+leavesPerPlantGer4EndeavourRow2Plant1)) {
        if (+!isNaN(+fullySetTrussGer4EndeavourRow2Plant1)) {
          if (+!isNaN(+setTrussLengthGer4EndeavourRow2Plant1)) {
            if (+!isNaN(+weeklyGrowthGer4EndeavourRow2Plant1)) {
              if (+!isNaN(+floweringTrussHeightGer4EndeavourRow2Plant1)) {
                if (+!isNaN(+leafLengthGer4EndeavourRow2Plant1)) {
                  if (+!isNaN(+leafWidthGer4EndeavourRow2Plant1)) {
                    if (+!isNaN(+stmDiameterGer4EndeavourRow2Plant1)) {
                      if (+!isNaN(+lastWeekStmDiameterGer4EndeavourRow2Plant1)) {
