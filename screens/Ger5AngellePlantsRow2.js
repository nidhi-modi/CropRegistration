...
export default class Ger5AngellePlantsRow2 extends Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    //PLANT 1
    this.ger5AngelleRow2EventPlant1 = EventRegister.addEventListener('ger5AngelleRow2EventPlant1', (data1) => {
    ...
    //PLANT 2
    this.ger5AngelleRow2EventPlant2 = EventRegister.addEventListener('ger5AngelleRow2EventPlant2', (data2) => {
    ...
    //PLANT 3
    this.ger5AngelleRow2EventPlant3 = EventRegister.addEventListener('ger5AngelleRow2EventPlant3', (data3) => {
    ...
    //PLANT 4
    this.ger5AngelleRow2EventPlant4 = EventRegister.addEventListener('ger5AngelleRow2EventPlant4', (data4) => {
    ...
    //PLANT 5
    this.ger5AngelleRow2EventPlant5 = EventRegister.addEventListener('ger5AngelleRow2EventPlant5', (data5) => {
  ...
  renderElement1() {
    ...
    if (plant1Selected == null || plant1Selected == true) {
      ...
      return <TouchableOpacity
        ...
        onPress={() => this.props.navigation.navigate('Ger5AngelleRow2Plant1')}>
  ...
  renderElement2() {
    ...
    if (plant2Selected == null || plant2Selected == true) {
      ...
      return <TouchableOpacity
        style={styles.buttonContainer}
        onPress={() => this.props.navigation.navigate('Ger5AngelleRow2Plant2')}>
  ...
  renderElement3() {
    ...
    if (plant3Selected == null || plant3Selected == true) {
      ...
      return <TouchableOpacity
        style={styles.buttonContainer}
        onPress={() => this.props.navigation.navigate('Ger5AngelleRow2Plant3')}>
  ...
  renderElement4() {
    ...
    if (plant4Selected == null || plant4Selected == true) {
      ...
      return <TouchableOpacity
        style={styles.buttonContainer}
        onPress={() => this.props.navigation.navigate('Ger5AngelleRow2Plant4')}>
  ...
  renderElement5() {
    ...
    if (plant5Selected == null || plant5Selected == true) {
      ...
      return <TouchableOpacity
        style={styles.buttonContainer}
        onPress={() => this.props.navigation.navigate('Ger5AngelleRow2Plant5')}>
