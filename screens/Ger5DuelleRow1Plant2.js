  ...
  calculateFloweringTruss2 = () => {
    ...
    if (this.state.setFlowers9Ger5DuelleRow1Plant2 === '') {
      if (this.state.setFlowers8Ger5DuelleRow1Plant2 === '') {
        ...
        flowering = Number.parseInt(
          this.state.setFlowers8Ger5DuelleRow1Plant2,
        );
        flowerSetFruits = Number.parseInt(
          this.state.setFruits8Ger5DuelleRow1Plant2,
        );
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 2</Text>/ Row No. 48/
          ...
          <ScrollView
            ...
            <View
              ...
              <View style={styles.formContainer}>
                ...
                <TouchableOpacity
                  onPress={() =>
                    this.props.navigation.navigate('Ger5DataChecker', {name : 'Ger5DuelleRow1Plant2', row : '48', plant: 2, type: 'GER 5 - Duelle'})
                  }>
