...
export default class Har1AnnasunPlant2 extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      Har1AnnasunPlant2Selected: false,
      checkboxStatus: '',
  ...
  getAsysncValues = async () => {
    ...
    try {
      AsyncStorage.getItem('Har1AnnasunPlant2Selected').then((text99Value) => {
        this.setState({ Har1AnnasunPlant2Selected: JSON.parse(text99Value) });

        console.log(this.state.Har1AnnasunPlant2Selected)

      }).done();
    } catch (error) {
    }
    try {
      AsyncStorage.getItem('trussNumberHar1AnnasunPlant2').then((text10Value) => {

        if (text10Value !== null) {
          this.setState({ trussNumberHar1AnnasunPlant2: JSON.parse(text10Value) });

          this.setState({ trussNumber1Har1AnnasunPlant2: parseInt(this.state.trussNumberHar1AnnasunPlant2) + 1 })
          this.setState({ trussNumber2Har1AnnasunPlant2: parseInt(this.state.trussNumberHar1AnnasunPlant2) + 2 })
          this.setState({ trussNumber3Har1AnnasunPlant2: parseInt(this.state.trussNumberHar1AnnasunPlant2) + 3 })
          this.setState({ trussNumber4Har1AnnasunPlant2: parseInt(this.state.trussNumberHar1AnnasunPlant2) + 4 })
          this.setState({ trussNumber5Har1AnnasunPlant2: parseInt(this.state.trussNumberHar1AnnasunPlant2) + 5 })
          this.setState({ trussNumber6Har1AnnasunPlant2: parseInt(this.state.trussNumberHar1AnnasunPlant2) + 6 })
          this.setState({ trussNumber7Har1AnnasunPlant2: parseInt(this.state.trussNumberHar1AnnasunPlant2) + 7 })
          this.setState({ trussNumber8Har1AnnasunPlant2: parseInt(this.state.trussNumberHar1AnnasunPlant2) + 8 })
          this.setState({ trussNumber9Har1AnnasunPlant2: parseInt(this.state.trussNumberHar1AnnasunPlant2) + 9 })
    ...
    try {
      AsyncStorage.getItem('setFruitsHar1AnnasunPlant2').then((text11Value) => {
        if (text11Value !== null) {

          this.setState({ setFruitsHar1AnnasunPlant2: JSON.parse(text11Value) });
    ...
    try {
      AsyncStorage.getItem('setFlowersHar1AnnasunPlant2').then((text12Value) => {

        if (text12Value !== null) {

          this.setState({ setFlowersHar1AnnasunPlant2: JSON.parse(text12Value) });
    ...
    try {
      AsyncStorage.getItem('pruningNumberHar1AnnasunPlant2').then((text13Value) => {
        if (text13Value !== null) {
          this.setState({ pruningNumberHar1AnnasunPlant2: JSON.parse(text13Value) });
        }
    ...
    try {
      AsyncStorage.getItem('fruitDiameterHar1AnnasunPlant2').then((text14Value) => {

        if (text14Value !== null) {
          this.setState({ fruitDiameterHar1AnnasunPlant2: JSON.parse(text14Value) });
        }
    ...
    try {
      AsyncStorage.getItem('setFruits1Har1AnnasunPlant2').then((text16Value) => {

        if (text16Value !== null) {
          this.setState({ setFruits1Har1AnnasunPlant2: JSON.parse(text16Value) });
        }
    ...
    try {
      AsyncStorage.getItem('setFlowers1Har1AnnasunPlant2').then((text17Value) => {

        if (text17Value !== null) {
          this.setState({ setFlowers1Har1AnnasunPlant2: JSON.parse(text17Value) });
        }
    ...
    try {
      AsyncStorage.getItem('pruningNumber1Har1AnnasunPlant2').then((text18Value) => {

        if (text18Value !== null) {
          this.setState({ pruningNumber1Har1AnnasunPlant2: JSON.parse(text18Value) });
        }
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1Har1AnnasunPlant2').then((text19Value) => {

        if (text19Value !== null) {
          this.setState({ fruitDiameter1Har1AnnasunPlant2: JSON.parse(text19Value) });
        }
    ...
    try {
      AsyncStorage.getItem('setFruits2Har1AnnasunPlant2').then((text17Value) => {

        if (text17Value !== null) {
          this.setState({ setFruits2Har1AnnasunPlant2: JSON.parse(text17Value) });
        }
    ...
    try {
      AsyncStorage.getItem('setFlowers2Har1AnnasunPlant2').then((text18Value) => {

        if (text18Value !== null) {
          this.setState({ setFlowers2Har1AnnasunPlant2: JSON.parse(text18Value) });
        }
    ...
    try {
      AsyncStorage.getItem('pruningNumber2Har1AnnasunPlant2').then((text19Value) => {

        if (text19Value !== null) {
          this.setState({ pruningNumber2Har1AnnasunPlant2: JSON.parse(text19Value) });
        }
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2Har1AnnasunPlant2').then((text20Value) => {

        if (text20Value !== null) {
          this.setState({ fruitDiameter2Har1AnnasunPlant2: JSON.parse(text20Value) });
        }
    ...
    try {
      AsyncStorage.getItem('setFruits3Har1AnnasunPlant2').then((text21Value) => {

        if (text21Value !== null) {
          this.setState({ setFruits3Har1AnnasunPlant2: JSON.parse(text21Value) });
        }
    ...
    try {
      AsyncStorage.getItem('setFlowers3Har1AnnasunPlant2').then((text22Value) => {

        if (text22Value !== null) {
          this.setState({ setFlowers3Har1AnnasunPlant2: JSON.parse(text22Value) });
        }
    ...
    try {
      AsyncStorage.getItem('pruningNumber3Har1AnnasunPlant2').then((text23Value) => {

        if (text23Value !== null) {
          this.setState({ pruningNumber3Har1AnnasunPlant2: JSON.parse(text23Value) });
        }
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3Har1AnnasunPlant2').then((text24Value) => {

        if (text24Value !== null) {
          this.setState({ fruitDiameter3Har1AnnasunPlant2: JSON.parse(text24Value) });
        }
    ...
    try {
      AsyncStorage.getItem('setFruits4Har1AnnasunPlant2').then((text25Value) => {

        if (text25Value !== null) {
          this.setState({ setFruits4Har1AnnasunPlant2: JSON.parse(text25Value) });
        }
    ...
    try {
      AsyncStorage.getItem('setFlowers4Har1AnnasunPlant2').then((text26Value) => {

        if (text26Value !== null) {
          this.setState({ setFlowers4Har1AnnasunPlant2: JSON.parse(text26Value) });
        }
    ...
    try {
      AsyncStorage.getItem('pruningNumber4Har1AnnasunPlant2').then((text27Value) => {

        if (text27Value !== null) {
          this.setState({ pruningNumber4Har1AnnasunPlant2: JSON.parse(text27Value) });
        }
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4Har1AnnasunPlant2').then((text28Value) => {

        if (text28Value !== null) {
          this.setState({ fruitDiameter4Har1AnnasunPlant2: JSON.parse(text28Value) });
        }
    ...
    try {
      AsyncStorage.getItem('setFruits5Har1AnnasunPlant2').then((text29Value) => {

        if (text29Value !== null) {
          this.setState({ setFruits5Har1AnnasunPlant2: JSON.parse(text29Value) });
        }
    ...
    try {
      AsyncStorage.getItem('setFlowers5Har1AnnasunPlant2').then((text30Value) => {

        if (text30Value !== null) {
          this.setState({ setFlowers5Har1AnnasunPlant2: JSON.parse(text30Value) });
        }
    ...
    try {
      AsyncStorage.getItem('pruningNumber5Har1AnnasunPlant2').then((text31Value) => {

        if (text31Value !== null) {
          this.setState({ pruningNumber5Har1AnnasunPlant2: JSON.parse(text31Value) });
        }
    ...
    try {
      ...
      AsyncStorage.getItem('fruitDiameter5Har1AnnasunPlant2').then((text32Value) => {
        if (text32Value !== null) {
          this.setState({ fruitDiameter5Har1AnnasunPlant2: JSON.parse(text32Value) });
        }
    ...
    try {
      AsyncStorage.getItem('setFruits6Har1AnnasunPlant2').then((text33Value) => {

        if (text33Value !== null) {
          this.setState({ setFruits6Har1AnnasunPlant2: JSON.parse(text33Value) });
        }
    ...
    try {
      AsyncStorage.getItem('setFlowers6Har1AnnasunPlant2').then((text34Value) => {

        if (text34Value !== null) {
          this.setState({ setFlowers6Har1AnnasunPlant2: JSON.parse(text34Value) });
        }
    ...
    try {
      AsyncStorage.getItem('pruningNumber6Har1AnnasunPlant2').then((text35Value) => {

        if (text35Value !== null) {
          this.setState({ pruningNumber6Har1AnnasunPlant2: JSON.parse(text35Value) });
        }
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6Har1AnnasunPlant2').then((text36Value) => {

        if (text36Value !== null) {
          this.setState({ fruitDiameter6Har1AnnasunPlant2: JSON.parse(text36Value) });
        }
    ...
    try {
      AsyncStorage.getItem('setFruits7Har1AnnasunPlant2').then((text37Value) => {

        if (text37Value !== null) {
          this.setState({ setFruits7Har1AnnasunPlant2: JSON.parse(text37Value) });
        }
    ...
    try {
      AsyncStorage.getItem('setFlowers7Har1AnnasunPlant2').then((text38Value) => {

        if (text38Value !== null) {

          this.setState({ setFlowers7Har1AnnasunPlant2: JSON.parse(text38Value) });
        }
    ...
    try {
      AsyncStorage.getItem('pruningNumber7Har1AnnasunPlant2').then((text39Value) => {

        if (text39Value !== null) {
          this.setState({ pruningNumber7Har1AnnasunPlant2: JSON.parse(text39Value) });
        }
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7Har1AnnasunPlant2').then((text40Value) => {

        if (text40Value !== null) {
          this.setState({ fruitDiameter7Har1AnnasunPlant2: JSON.parse(text40Value) });
        }
    ...
    try {
      AsyncStorage.getItem('setFruits8Har1AnnasunPlant2').then((text41Value) => {

        if (text41Value !== null) {
          this.setState({ setFruits8Har1AnnasunPlant2: JSON.parse(text41Value) });
        }
    ...
    try {
      AsyncStorage.getItem('setFlowers8Har1AnnasunPlant2').then((text42Value) => {

        if (text42Value !== null) {
          this.setState({ setFlowers8Har1AnnasunPlant2: JSON.parse(text42Value) });
        }
    ...
    try {
      AsyncStorage.getItem('pruningNumber8Har1AnnasunPlant2').then((text43Value) => {

        if (text43Value !== null) {
          this.setState({ pruningNumber8Har1AnnasunPlant2: JSON.parse(text43Value) });
        }
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8Har1AnnasunPlant2').then((text44Value) => {

        if (text44Value !== null) {
          this.setState({ fruitDiameter8Har1AnnasunPlant2: JSON.parse(text44Value) });
        }
    ...
    try {
      AsyncStorage.getItem('setFruits9Har1AnnasunPlant2').then((text45Value) => {

        if (text45Value !== null) {
          this.setState({ setFruits9Har1AnnasunPlant2: JSON.parse(text45Value) });
        }
    ...
    try {
      AsyncStorage.getItem('setFlowers9Har1AnnasunPlant2').then((text46Value) => {

        if (text46Value !== null) {
          this.setState({ setFlowers9Har1AnnasunPlant2: JSON.parse(text46Value) });
        }
    ...
    try {
      AsyncStorage.getItem('pruningNumber9Har1AnnasunPlant2').then((text47Value) => {

        if (text47Value !== null) {
          this.setState({ pruningNumber9Har1AnnasunPlant2: JSON.parse(text47Value) });
        }
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9Har1AnnasunPlant2').then((text48Value) => {

        if (text48Value !== null) {
          this.setState({ fruitDiameter9Har1AnnasunPlant2: JSON.parse(text48Value) });
        }
    ...
    try {
      AsyncStorage.getItem('fruitLoadHar1AnnasunPlant2').then((text49Value) => {
        if (text49Value !== null) {
          this.setState({ fruitLoadHar1AnnasunPlant2: JSON.parse(text49Value) });
        }
    ...
    try {
      AsyncStorage.getItem('floweringTrussssHar1AnnasunPlant2').then((text50Value) => {

        if (text50Value !== null) {
          this.setState({ floweringTrussssHar1AnnasunPlant2: JSON.parse(text50Value) });
        }
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberHar1AnnasunPlant2').then((text51Value) => {

        if (text51Value !== null) {
          this.setState({ settingTrussNumberHar1AnnasunPlant2: JSON.parse(text51Value) });
        }
    ...
    try {
      AsyncStorage.getItem('harvestTrussHar1AnnasunPlant2').then((text52Value) => {

        if (text52Value !== null) {
          this.setState({ harvestTrussHar1AnnasunPlant2: JSON.parse(text52Value) });
        }
    ...
    /*try {
      AsyncStorage.getItem('trussNumberHar1AnnasunPlant2').then((text10Value) => {
        this.setState({ trussNumberHar1AnnasunPlant2: JSON.parse(text10Value) });
        console.log(this.state.trussNumberHar1AnnasunPlant2)
    ...
    try {
      AsyncStorage.getItem('setFruitsHar1AnnasunPlant2').then((text11Value) => {
        this.setState({ setFruitsHar1AnnasunPlant2: JSON.parse(text11Value) });
        console.log(this.state.setFruitsHar1AnnasunPlant2)
    ...
    try {
      AsyncStorage.getItem('setFlowersHar1AnnasunPlant2').then((text12Value) => {
        this.setState({ setFlowersHar1AnnasunPlant2: JSON.parse(text12Value) });
        console.log(this.state.setFlowersHar1AnnasunPlant2)
    ...
    try {
      AsyncStorage.getItem('pruningNumberHar1AnnasunPlant2').then((text13Value) => {
        this.setState({ pruningNumberHar1AnnasunPlant2: JSON.parse(text13Value) });
        console.log(this.state.pruningNumberHar1AnnasunPlant2)
    ...
    try {
      AsyncStorage.getItem('fruitDiameterHar1AnnasunPlant2').then((text14Value) => {
        this.setState({ fruitDiameterHar1AnnasunPlant2: JSON.parse(text14Value) });
        console.log(this.state.fruitDiameterHar1AnnasunPlant2)
    ...
    try {
      AsyncStorage.getItem('setFruits1Har1AnnasunPlant2').then((text15Value) => {
        this.setState({ setFruits1Har1AnnasunPlant2: JSON.parse(text15Value) });
        console.log(this.state.setFruits1Har1AnnasunPlant2)
    ...
    try {
      AsyncStorage.getItem('setFlowers1Har1AnnasunPlant2').then((text16Value) => {
        this.setState({ setFlowers1Har1AnnasunPlant2: JSON.parse(text16Value) });
        console.log(this.state.setFlowers1Har1AnnasunPlant2)
    ...
    try {
      AsyncStorage.getItem('pruningNumber1Har1AnnasunPlant2').then((text17Value) => {
        this.setState({ pruningNumber1Har1AnnasunPlant2: JSON.parse(text17Value) });
        console.log(this.state.pruningNumber1Har1AnnasunPlant2)
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1Har1AnnasunPlant2').then((text18Value) => {
        this.setState({ fruitDiameter1Har1AnnasunPlant2: JSON.parse(text18Value) });
        console.log(this.state.fruitDiameter1Har1AnnasunPlant2)
    ...
    try {
      AsyncStorage.getItem('setFruits2Har1AnnasunPlant2').then((text19Value) => {
        this.setState({ setFruits2Har1AnnasunPlant2: JSON.parse(text19Value) });
        console.log(this.state.setFruits2Har1AnnasunPlant2)
    ...
    try {
      AsyncStorage.getItem('setFlowers2Har1AnnasunPlant2').then((text20Value) => {
        this.setState({ setFlowers2Har1AnnasunPlant2: JSON.parse(text20Value) });
        console.log(this.state.setFlowers2Har1AnnasunPlant2)
    ...
    try {
      AsyncStorage.getItem('pruningNumber2Har1AnnasunPlant2').then((text21Value) => {
        this.setState({ pruningNumber2Har1AnnasunPlant2: JSON.parse(text21Value) });
        console.log(this.state.pruningNumber2Har1AnnasunPlant2)
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2Har1AnnasunPlant2').then((text22Value) => {
        this.setState({ fruitDiameter2Har1AnnasunPlant2: JSON.parse(text22Value) });
        console.log(this.state.fruitDiameter2Har1AnnasunPlant2)
    ...
    try {
      AsyncStorage.getItem('setFruits3Har1AnnasunPlant2').then((text23Value) => {
        this.setState({ setFruits3Har1AnnasunPlant2: JSON.parse(text23Value) });
        console.log(this.state.setFruits3Har1AnnasunPlant2)
    ...
    try {
      AsyncStorage.getItem('setFlowers3Har1AnnasunPlant2').then((text24Value) => {
        this.setState({ setFlowers3Har1AnnasunPlant2: JSON.parse(text24Value) });
        console.log(this.state.setFlowers3Har1AnnasunPlant2)
    ...
    try {
      AsyncStorage.getItem('pruningNumber3Har1AnnasunPlant2').then((text25Value) => {
        this.setState({ pruningNumber3Har1AnnasunPlant2: JSON.parse(text25Value) });
        console.log(this.state.pruningNumber3Har1AnnasunPlant2)
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3Har1AnnasunPlant2').then((text26Value) => {
        this.setState({ fruitDiameter3Har1AnnasunPlant2: JSON.parse(text26Value) });
        console.log(this.state.fruitDiameter3Har1AnnasunPlant2)
  ...
  calculateFruitLoad = () => {
    ...
    this.setState({
      fruitLoadHar1AnnasunPlant2: sum,
    });

    this.setItem("fruitLoadHar1AnnasunPlant2", this.state.fruitLoadHar1AnnasunPlant2)
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersHar1AnnasunPlant2 === "") {
      ...
      this.setState({
        harvestTrussHar1AnnasunPlant2: add,
        pruningHarHar1AnnasunPlant2: prunNum,
      });
      ...
      this.setState({
        harvestTrussHar1AnnasunPlant2: num,
        pruningHarHar1AnnasunPlant2: prunNum,
      });
    }
    ...
    this.setItem("harvestTrussHar1AnnasunPlant2", this.state.harvestTrussHar1AnnasunPlant2)
                  ...
                  if (this.state.setFruits2Har1AnnasunPlant2 === "") {
                    ...
                    if (this.state.setFruits1Har1AnnasunPlant2 === "") {
                      ...
                      if (this.state.setFruitsHar1AnnasunPlant2 === "") {
                        ...
                        this.setState({
                          settingTrussNumberHar1AnnasunPlant2: settingTruss,
                          settingTruss: trussNum,
                          prunSettingHar1AnnasunPlant2: pruningSet,

                        });

                        this.setItem("settingTrussNumberHar1AnnasunPlant2", settingTruss)
                  ...
                  if (this.state.setFlowers2Har1AnnasunPlant2 === "") {
                    ...
                    if (this.state.setFlowers1Har1AnnasunPlant2 === "") {
                      ...
                      if (this.state.setFlowersHar1AnnasunPlant2 === "") {
                        ...
                        this.setState({
                          floweringTrussssHar1AnnasunPlant2: floweringTruss,
                          pruneFloweringHar1AnnasunPlant2: flowerPruningNumner,
                        });
                        this.setItem("floweringTrussssHar1AnnasunPlant2", floweringTruss)
  ...
  getTrussData = () => {
    ...
    /*if (this.state.trussNumber != null) {
       ...
       db.trussById(this.state.trussNumber, numberWeek - 1, 'GER 1 - Merlice', number, '81/86').then((data) => {
           ...
           this.calculateFruitLoad();
           this.calculateharvestTrussHar1AnnasunPlant2();
           this.calculateSettingTruss2();
           this.calculateFloweringTruss2();
  ...
  changeCheckbox = () => {
    ...
    this.setState({ Har1AnnasunPlant2Selected: !this.state.Har1AnnasunPlant2Selected })

    const vart = this.state.Har1AnnasunPlant2Selected

    const vart2 = false;

    if (vart == null) {

      this.setItem('Har1AnnasunPlant2Selected', vart2)

      EventRegister.emit('Har1AnnasunEventPlant2', vart2)

    } else {

      this.setItem('Har1AnnasunPlant2Selected', vart)

      EventRegister.emit('Har1AnnasunEventPlant2', vart)
  ...
  checkStatus = () => {
    ...
    if (vart == null || vart == false) {
      ...
      let data = {
        ...
        plantNumber: 2,
        leavesPerPlant: this.state.leavesPerPlantHar1AnnasunPlant2,
        fullySetTruss: this.state.fullySetTrussHar1AnnasunPlant2,
        setTrussLength: this.state.setTrussLengthHar1AnnasunPlant2,
        weeklyGrowth: this.state.weeklyGrowthHar1AnnasunPlant2,
        floweringTrussHeight: this.state.floweringTrussHeightHar1AnnasunPlant2,
        leafLength: this.state.leafLengthHar1AnnasunPlant2,
        leafWidth: this.state.leafWidthHar1AnnasunPlant2,
        stmDiameter: this.state.stmDiameterHar1AnnasunPlant2,
        lastWeekStmDiameter: this.state.lastWeekStmDiameterHar1AnnasunPlant2
  ...
  saveTrussToDb = () => {
    ...
    if (this.state.trussNumberHar1AnnasunPlant2 !== null && this.state.pruningNumberHar1AnnasunPlant2 !== null) {

      let data = {
        trussNumber: this.state.trussNumberHar1AnnasunPlant2,
        fruitDiameter: this.state.fruitDiameterHar1AnnasunPlant2,
        setFruits: this.state.setFruitsHar1AnnasunPlant2,
        setFlowers: this.state.setFlowersHar1AnnasunPlant2,
        pruningNumber: this.state.pruningNumberHar1AnnasunPlant2,
        plantRow: '105',
        plantName: 'HAR 1 - Annasun',
        plantWeek: this.state.weekNumber,
        plantNumber: 2,
        fruitLoad: this.state.fruitLoadHar1AnnasunPlant2,
        pruningFlower: this.state.pruneFloweringHar1AnnasunPlant2,
        floweringTruss: this.state.floweringTrussssHar1AnnasunPlant2,
        pruningSet: this.state.prunSettingHar1AnnasunPlant2,
        settingTruss: this.state.settingTrussNumberHar1AnnasunPlant2,
        pruningHarvest: this.state.pruningHarHar1AnnasunPlant2,
        harvestTruss: this.state.harvestTrussHar1AnnasunPlant2
      ...
      db.addTrussDetails(data).then((result) => {
        ...
        if ((parseInt(this.state.trussNumberHar1AnnasunPlant2) + 1) !== null && this.state.pruningNumber1Har1AnnasunPlant2 !== '') {
  ...
  saveTrussToDB1 = () => {
    ...
    if ((parseInt(this.state.trussNumberHar1AnnasunPlant2) + 1) != null && this.state.pruningNumber1Har1AnnasunPlant2 !== null) {


      let data1 = {

        trussNumber: (parseInt(this.state.trussNumberHar1AnnasunPlant2) + 1),
        fruitDiameter: this.state.fruitDiameter1Har1AnnasunPlant2,
        setFruits: this.state.setFruits1Har1AnnasunPlant2,
        setFlowers: this.state.setFlowers1Har1AnnasunPlant2,
        pruningNumber: this.state.pruningNumber1Har1AnnasunPlant2,
        plantRow: '105',
        plantName: 'HAR 1 - Annasun',
        plantWeek: this.state.weekNumber,
        plantNumber: 2,
      ...
      db.addTrussDetails(data1).then((result) => {
        ...
        if ((parseInt(this.state.trussNumberHar1AnnasunPlant2) + 2) !== null && this.state.pruningNumber2Har1AnnasunPlant2 !== '') {
  ...
  saveTrussToDB2 = () => {
    ...
    if ((parseInt(this.state.trussNumberHar1AnnasunPlant2) + 2) != null && this.state.pruningNumber2Har1AnnasunPlant2 !== null) {


      let data2 = {

        trussNumber: (parseInt(this.state.trussNumberHar1AnnasunPlant2) + 2),
        fruitDiameter: this.state.fruitDiameter2Har1AnnasunPlant2,
        setFruits: this.state.setFruits2Har1AnnasunPlant2,
        setFlowers: this.state.setFlowers2Har1AnnasunPlant2,
        pruningNumber: this.state.pruningNumber2Har1AnnasunPlant2,
        plantRow: '105',
        plantName: 'HAR 1 - Annasun',
        plantWeek: this.state.weekNumber,
        plantNumber: 2,
      ...
      db.addTrussDetails(data2).then((result) => {
        ...
        if ((parseInt(this.state.trussNumberHar1AnnasunPlant2) + 3) !== null && this.state.pruningNumber3Har1AnnasunPlant2 !== '') {
  ...
  saveTrussToDB3 = () => {
    ...
    if ((parseInt(this.state.trussNumberHar1AnnasunPlant2) + 3) !== null && this.state.pruningNumber3Har1AnnasunPlant2 !== null) {


      let data3 = {
        trussNumber: (parseInt(this.state.trussNumberHar1AnnasunPlant3) + 3),
        fruitDiameter: this.state.fruitDiameter3Har1AnnasunPlant2,
        setFruits: this.state.setFruits3Har1AnnasunPlant2,
        setFlowers: this.state.setFlowers3Har1AnnasunPlant2,
        pruningNumber: this.state.pruningNumber3Har1AnnasunPlant2,
        plantRow: '105',
        plantName: 'HAR 1 - Annasun',
        plantWeek: this.state.weekNumber,
        plantNumber: 2,
      ...
      db.addTrussDetails(data3).then((result) => {
        ...
        if ((parseInt(this.state.trussNumberHar1AnnasunPlant2) + 4) !== null && this.state.pruningNumber4Har1AnnasunPlant2 !== '') {
  ...
  saveTrussToDB4 = () => {
    ...
    if ((parseInt(this.state.trussNumberHar1AnnasunPlant2) + 4) != null && this.state.pruningNumber4Har1AnnasunPlant2 !== null) {


      let data4 = {
        trussNumber: (parseInt(this.state.trussNumberHar1AnnasunPlant2) + 4),
        fruitDiameter: this.state.fruitDiameter4Har1AnnasunPlant2,
        setFruits: this.state.setFruits4Har1AnnasunPlant2,
        setFlowers: this.state.setFlowers4Har1AnnasunPlant2,
        pruningNumber: this.state.pruningNumber4Har1AnnasunPlant2,
        plantRow: '105',
        plantName: 'HAR 1 - Annasun',
        plantWeek: this.state.weekNumber,
        plantNumber: 2,
      ...
      db.addTrussDetails(data4).then((result) => {
        ...
        if ((parseInt(this.state.trussNumberHar1AnnasunPlant2) + 5) !== null && this.state.pruningNumber5Har1AnnasunPlant2 !== '') {
  ...
  saveTrussToDB5 = () => {
    ...
    if ((parseInt(this.state.trussNumberHar1AnnasunPlant2) + 5) != null && this.state.pruningNumber5Har1AnnasunPlant2 !== null) {


      let data5 = {
        trussNumber: (parseInt(this.state.trussNumberHar1AnnasunPlant2) + 5),
        fruitDiameter: this.state.fruitDiameter5Har1AnnasunPlant2,
        setFruits: this.state.setFruits5Har1AnnasunPlant2,
        setFlowers: this.state.setFlowers5Har1AnnasunPlant2,
        pruningNumber: this.state.pruningNumber5Har1AnnasunPlant2,
        plantRow: '105',
        plantName: 'HAR 1 - Annasun',
        plantWeek: this.state.weekNumber,
        plantNumber: 2,
      ...
      db.addTrussDetails(data5).then((result) => {
        ...
        if ((parseInt(this.state.trussNumberHar1AnnasunPlant2) + 6) !== null && this.state.pruningNumber6Har1AnnasunPlant2 !== '') {
  ...
  saveTrussToDB6 = () => {
    ...
    if ((parseInt(this.state.trussNumberHar1AnnasunPlant2) + 6) != null && this.state.pruningNumber6Har1AnnasunPlant2 !== null) {


      let data6 = {
        trussNumber: (parseInt(this.state.trussNumberHar1AnnasunPlant2) + 6),
        fruitDiameter: this.state.fruitDiameter6Har1AnnasunPlant2,
        setFruits: this.state.setFruits6Har1AnnasunPlant2,
        setFlowers: this.state.setFlowers6Har1AnnasunPlant2,
        pruningNumber: this.state.pruningNumber6Har1AnnasunPlant2,
        plantRow: '105',
        plantName: 'HAR 1 - Annasun',
        plantWeek: this.state.weekNumber,
        plantNumber: 2,
      ...
      db.addTrussDetails(data6).then((result) => {
        ...
        if ((parseInt(this.state.trussNumberHar1AnnasunPlant2) + 7) !== null && this.state.pruningNumber7Har1AnnasunPlant2 !== '') {
  ...
  saveTrussToDB7 = () => {
    ...
    if ((parseInt(this.state.trussNumberHar1AnnasunPlant2) + 7) != null && this.state.pruningNumber7Har1AnnasunPlant2 !== null) {


      let data7 = {
        trussNumber: (parseInt(this.state.trussNumberHar1AnnasunPlant2) + 7),
        fruitDiameter: this.state.fruitDiameter7Har1AnnasunPlant2,
        setFruits: this.state.setFruits7Har1AnnasunPlant2,
        setFlowers: this.state.setFlowers7Har1AnnasunPlant2,
        pruningNumber: this.state.pruningNumber7Har1AnnasunPlant2,
        plantRow: '105',
        plantName: 'HAR 1 - Annasun',
        plantWeek: this.state.weekNumber,
        plantNumber: 2,
      ...
      db.addTrussDetails(data7).then((result) => {
        ...
        if ((parseInt(this.state.trussNumberHar1AnnasunPlant2) + 8) !== null && this.state.pruningNumber8Har1AnnasunPlant2 !== '') {
  ...
  saveTrussToDB8 = () => {
    ...
    if ((parseInt(this.state.trussNumberHar1AnnasunPlant2) + 8) != null && this.state.pruningNumber8Har1AnnasunPlant2 !== null) {


      let data8 = {
        trussNumber: (parseInt(this.state.trussNumberHar1AnnasunPlant2) + 8),
        fruitDiameter: this.state.fruitDiameter8Har1AnnasunPlant2,
        setFruits: this.state.setFruits8Har1AnnasunPlant2,
        setFlowers: this.state.setFlowers8Har1AnnasunPlant2,
        pruningNumber: this.state.pruningNumber8Har1AnnasunPlant2,
        plantRow: '105',
        plantName: 'HAR 1 - Annasun',
        plantWeek: this.state.weekNumber,
        plantNumber: 2,
      ...
      db.addTrussDetails(data8).then((result) => {
        ...
        if ((parseInt(this.state.trussNumberHar1AnnasunPlant2) + 9) !== null && this.state.pruningNumber9Har1AnnasunPlant2 !== '') {
  ...
  saveTrussToDB9 = () => {
    ...
    if ((parseInt(this.state.trussNumberHar1AnnasunPlant2) + 9) != null && this.state.pruningNumber9Har1AnnasunPlant2 !== null) {



      let data9 = {
        trussNumber: (parseInt(this.state.trussNumberHar1AnnasunPlant2) + 9),
        fruitDiameter: this.state.fruitDiameter9Har1AnnasunPlant2,
        setFruits: this.state.setFruits9Har1AnnasunPlant2,
        setFlowers: this.state.setFlowers9Har1AnnasunPlant2,
        pruningNumber: this.state.pruningNumber9Har1AnnasunPlant2,
        plantRow: '105',
        plantName: 'HAR 1 - Annasun',
        plantWeek: this.state.weekNumber,
        plantNumber: 2,
    ...
    return (
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View pointerEvents={this.state.Har1AnnasunPlant2Selected ? 'none' : 'auto'}>
            ...
            <View style={styles.formContainer}>
              ...
              <View style={styles.rowContainer222}>
                ...
                <TextInput
                  ...
                  blurOnSubmit={false}
                  value={this.state.trussNumberHar1AnnasunPlant2}
                />
              ...
              <CheckBox style={styles.styleCheckbox}
                ...
                checked={this.state.Har1AnnasunPlant2Selected}
