...
export default class Har1AnnasunPlant2 extends Component {
  ...
  updateTextInput22 = (text, field) => {
    ...
    this.setState({ trussNumber1: parseInt(this.state.trussNumberHar1AnnasunPlant2) + 1 })
    this.setState({ trussNumber2: parseInt(this.state.trussNumberHar1AnnasunPlant2) + 2 })
    this.setState({ trussNumber3: parseInt(this.state.trussNumberHar1AnnasunPlant2) + 3 })
    this.setState({ trussNumber4: parseInt(this.state.trussNumberHar1AnnasunPlant2) + 4 })
    this.setState({ trussNumber5: parseInt(this.state.trussNumberHar1AnnasunPlant2) + 5 })
    this.setState({ trussNumber6: parseInt(this.state.trussNumberHar1AnnasunPlant2) + 6 })
    this.setState({ trussNumber7: parseInt(this.state.trussNumberHar1AnnasunPlant2) + 7 })
    this.setState({ trussNumber8: parseInt(this.state.trussNumberHar1AnnasunPlant2) + 8 })
    this.setState({ trussNumber9: parseInt(this.state.trussNumberHar1AnnasunPlant2) + 9 })
