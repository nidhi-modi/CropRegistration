...
export default class Har1AvalantinoPlantsRow1 extends Component {
  ...
  componentWillUnmount() {
    ...
    EventRegister.removeEventListener(this.har1AvalantinoRow1EventPlant1)
    EventRegister.removeEventListener(this.har1AvalantinoRow1EventPlant2)
    EventRegister.removeEventListener(this.har1AvalantinoRow1EventPlant3)
    EventRegister.removeEventListener(this.har1AvalantinoRow1EventPlant4)
    EventRegister.removeEventListener(this.har1AvalantinoRow1EventPlant5)
  ...
  UNSAFE_componentWillMount() {
    ...
    //PLANT 1
    this.har1AvalantinoRow1EventPlant1 = EventRegister.addEventListener('har1AvalantinoRow1EventPlant1', (data1) => {
    ...
    //PLANT 2
    this.har1AvalantinoRow1EventPlant2 = EventRegister.addEventListener('har1AvalantinoRow1EventPlant2', (data2) => {
    ...
    //PLANT 3
    this.har1AvalantinoRow1EventPlant3 = EventRegister.addEventListener('har1AvalantinoRow1EventPlant3', (data3) => {
    ...
    //PLANT 4
    this.har1AvalantinoRow1EventPlant4 = EventRegister.addEventListener('har1AvalantinoRow1EventPlant4', (data4) => {
    ...
    //PLANT 5
    this.har1AvalantinoRow1EventPlant5 = EventRegister.addEventListener('har1AvalantinoRow1EventPlant5', (data5) => {
