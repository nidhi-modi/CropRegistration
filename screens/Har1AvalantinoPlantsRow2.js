...
export default class Har1AvalantinoPlantsRow2 extends Component {
  ...
  componentWillUnmount() {
    ...
    EventRegister.removeEventListener(this.har1AvalantinoRow2EventPlant1)
    EventRegister.removeEventListener(this.har1AvalantinoRow2EventPlant2)
    EventRegister.removeEventListener(this.har1AvalantinoRow2EventPlant3)
    EventRegister.removeEventListener(this.har1AvalantinoRow2EventPlant4)
    EventRegister.removeEventListener(this.har1AvalantinoRow2EventPlant5)
  ...
  UNSAFE_componentWillMount() {
    ...
    //PLANT 1
    this.har1AvalantinoRow2EventPlant1 = EventRegister.addEventListener('har1AvalantinoRow2EventPlant1', (data1) => {
    ...
    //PLANT 2
    this.har1AvalantinoRow2EventPlant2 = EventRegister.addEventListener('har1AvalantinoRow2EventPlant2', (data2) => {
    ...
    //PLANT 3
    this.har1AvalantinoRow2EventPlant3 = EventRegister.addEventListener('har1AvalantinoRow2EventPlant3', (data3) => {
    ...
    //PLANT 4
    this.har1AvalantinoRow2EventPlant4 = EventRegister.addEventListener('har1AvalantinoRow2EventPlant4', (data4) => {
    ...
    //PLANT 5
    this.har1AvalantinoRow2EventPlant5 = EventRegister.addEventListener('har1AvalantinoRow2EventPlant5', (data5) => {
