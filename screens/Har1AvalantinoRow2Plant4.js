...
export default class Har1AvalantinoRow2Plant4 extends Component {
  constructor(props) {
    ...
    this.onSubmitleavesPerPlantHar1AvalantinoRow2Plant4 = this.onSubmitleavesPerPlantHar1AvalantinoRow2Plant4.bind(
      this,
    );
    ...
    this.leavesPerPlantHar1AvalantinoRow2Plant4Ref = this.updateRef.bind(
      this,
  ...
  getAsysncValues = async () => {
    try {
      AsyncStorage.getItem('leavesPerPlantHar1AvalantinoRow2Plant4')
        .then(text1Value => {
          this.setState({
            leavesPerPlantHar1AvalantinoRow2Plant4: JSON.parse(text1Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('fullySetTrussHar1AvalantinoRow2Plant4')
        .then(text2Value => {
          this.setState({
            fullySetTrussHar1AvalantinoRow2Plant4: JSON.parse(text2Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('setTrussLengthHar1AvalantinoRow2Plant4')
        .then(text3Value => {
          this.setState({
            setTrussLengthHar1AvalantinoRow2Plant4: JSON.parse(text3Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('weeklyGrowthHar1AvalantinoRow2Plant4')
        .then(text4Value => {
          this.setState({
            weeklyGrowthHar1AvalantinoRow2Plant4: JSON.parse(text4Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('floweringTrussHeightHar1AvalantinoRow2Plant4')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightHar1AvalantinoRow2Plant4: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafLengthHar1AvalantinoRow2Plant4')
        .then(text6Value => {
          this.setState({
            leafLengthHar1AvalantinoRow2Plant4: JSON.parse(text6Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('leafWidthHar1AvalantinoRow2Plant4')
        .then(text7Value => {
          this.setState({
            leafWidthHar1AvalantinoRow2Plant4: JSON.parse(text7Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('stmDiameterHar1AvalantinoRow2Plant4')
        .then(text8Value => {
          this.setState({
            stmDiameterHar1AvalantinoRow2Plant4: JSON.parse(text8Value),
          });
        })
        .done();
    } catch (error) {}
    try {
      AsyncStorage.getItem('lastWeekStmDiameterHar1AvalantinoRow2Plant4')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterHar1AvalantinoRow2Plant4: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('Har1AvalantinoRow2Plant4Selected')
        .then(text99Value => {
          this.setState({
            Har1AvalantinoRow2Plant4Selected: JSON.parse(text99Value),
          });
    ...
    try {
      AsyncStorage.getItem('trussNumberHar1AvalantinoRow2Plant4')
        .then(text10Value => {
          if (text10Value !== null) {
            this.setState({
              trussNumberHar1AvalantinoRow2Plant4: JSON.parse(text10Value),
            });

            this.setState({
              trussNumber1Har1AvalantinoRow2Plant4:
                Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) +
                1,
            });
            this.setState({
              trussNumber2Har1AvalantinoRow2Plant4:
    ...
    try {
      AsyncStorage.getItem('setFruitsHar1AvalantinoRow2Plant4')
        .then(text11Value => {
          if (text11Value !== null) {
            this.setState({
              setFruitsHar1AvalantinoRow2Plant4: JSON.parse(text11Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowersHar1AvalantinoRow2Plant4')
        .then(text12Value => {
          if (text12Value !== null) {
            this.setState({
              setFlowersHar1AvalantinoRow2Plant4: JSON.parse(text12Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumberHar1AvalantinoRow2Plant4')
        .then(text13Value => {
          if (text13Value !== null) {
            this.setState({
              pruningNumberHar1AvalantinoRow2Plant4: JSON.parse(text13Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameterHar1AvalantinoRow2Plant4')
        .then(text14Value => {
          if (text14Value !== null) {
            this.setState({
              fruitDiameterHar1AvalantinoRow2Plant4: JSON.parse(text14Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits1Har1AvalantinoRow2Plant4')
        .then(text16Value => {
          if (text16Value !== null) {
            this.setState({
              setFruits1Har1AvalantinoRow2Plant4: JSON.parse(text16Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers1Har1AvalantinoRow2Plant4')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFlowers1Har1AvalantinoRow2Plant4: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber1Har1AvalantinoRow2Plant4')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1Har1AvalantinoRow2Plant4: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1Har1AvalantinoRow2Plant4')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1Har1AvalantinoRow2Plant4: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits2Har1AvalantinoRow2Plant4')
        .then(text17Value => {
          if (text17Value !== null) {
            this.setState({
              setFruits2Har1AvalantinoRow2Plant4: JSON.parse(text17Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers2Har1AvalantinoRow2Plant4')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              setFlowers2Har1AvalantinoRow2Plant4: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber2Har1AvalantinoRow2Plant4')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2Har1AvalantinoRow2Plant4: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2Har1AvalantinoRow2Plant4')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2Har1AvalantinoRow2Plant4: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits3Har1AvalantinoRow2Plant4')
        .then(text21Value => {
          if (text21Value !== null) {
            this.setState({
              setFruits3Har1AvalantinoRow2Plant4: JSON.parse(text21Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers3Har1AvalantinoRow2Plant4')
        .then(text22Value => {
          if (text22Value !== null) {
            this.setState({
              setFlowers3Har1AvalantinoRow2Plant4: JSON.parse(text22Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber3Har1AvalantinoRow2Plant4')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3Har1AvalantinoRow2Plant4: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3Har1AvalantinoRow2Plant4')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3Har1AvalantinoRow2Plant4: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits4Har1AvalantinoRow2Plant4')
        .then(text25Value => {
          if (text25Value !== null) {
            this.setState({
              setFruits4Har1AvalantinoRow2Plant4: JSON.parse(text25Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers4Har1AvalantinoRow2Plant4')
        .then(text26Value => {
          if (text26Value !== null) {
            this.setState({
              setFlowers4Har1AvalantinoRow2Plant4: JSON.parse(text26Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber4Har1AvalantinoRow2Plant4')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4Har1AvalantinoRow2Plant4: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4Har1AvalantinoRow2Plant4')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4Har1AvalantinoRow2Plant4: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits5Har1AvalantinoRow2Plant4')
        .then(text29Value => {
          if (text29Value !== null) {
            this.setState({
              setFruits5Har1AvalantinoRow2Plant4: JSON.parse(text29Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers5Har1AvalantinoRow2Plant4')
        .then(text30Value => {
          if (text30Value !== null) {
            this.setState({
              setFlowers5Har1AvalantinoRow2Plant4: JSON.parse(text30Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber5Har1AvalantinoRow2Plant4')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5Har1AvalantinoRow2Plant4: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5Har1AvalantinoRow2Plant4')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5Har1AvalantinoRow2Plant4: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits6Har1AvalantinoRow2Plant4')
        .then(text33Value => {
          if (text33Value !== null) {
            this.setState({
              setFruits6Har1AvalantinoRow2Plant4: JSON.parse(text33Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers6Har1AvalantinoRow2Plant4')
        .then(text34Value => {
          if (text34Value !== null) {
            this.setState({
              setFlowers6Har1AvalantinoRow2Plant4: JSON.parse(text34Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber6Har1AvalantinoRow2Plant4')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6Har1AvalantinoRow2Plant4: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6Har1AvalantinoRow2Plant4')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6Har1AvalantinoRow2Plant4: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits7Har1AvalantinoRow2Plant4')
        .then(text37Value => {
          if (text37Value !== null) {
            this.setState({
              setFruits7Har1AvalantinoRow2Plant4: JSON.parse(text37Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers7Har1AvalantinoRow2Plant4')
        .then(text38Value => {
          if (text38Value !== null) {
            this.setState({
              setFlowers7Har1AvalantinoRow2Plant4: JSON.parse(text38Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber7Har1AvalantinoRow2Plant4')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7Har1AvalantinoRow2Plant4: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7Har1AvalantinoRow2Plant4')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7Har1AvalantinoRow2Plant4: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits8Har1AvalantinoRow2Plant4')
        .then(text41Value => {
          if (text41Value !== null) {
            this.setState({
              setFruits8Har1AvalantinoRow2Plant4: JSON.parse(text41Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers8Har1AvalantinoRow2Plant4')
        .then(text42Value => {
          if (text42Value !== null) {
            this.setState({
              setFlowers8Har1AvalantinoRow2Plant4: JSON.parse(text42Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber8Har1AvalantinoRow2Plant4')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8Har1AvalantinoRow2Plant4: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8Har1AvalantinoRow2Plant4')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8Har1AvalantinoRow2Plant4: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFruits9Har1AvalantinoRow2Plant4')
        .then(text45Value => {
          if (text45Value !== null) {
            this.setState({
              setFruits9Har1AvalantinoRow2Plant4: JSON.parse(text45Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('setFlowers9Har1AvalantinoRow2Plant4')
        .then(text46Value => {
          if (text46Value !== null) {
            this.setState({
              setFlowers9Har1AvalantinoRow2Plant4: JSON.parse(text46Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber9Har1AvalantinoRow2Plant4')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9Har1AvalantinoRow2Plant4: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9Har1AvalantinoRow2Plant4')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9Har1AvalantinoRow2Plant4: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitLoadHar1AvalantinoRow2Plant4')
        .then(text49Value => {
          if (text49Value !== null) {
            this.setState({
              fruitLoadHar1AvalantinoRow2Plant4: JSON.parse(text49Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('floweringTrussssHar1AvalantinoRow2Plant4')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssHar1AvalantinoRow2Plant4: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberHar1AvalantinoRow2Plant4')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberHar1AvalantinoRow2Plant4: JSON.parse(text51Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('harvestTrussHar1AvalantinoRow2Plant4')
        .then(text52Value => {
          if (text52Value !== null) {
            this.setState({
              harvestTrussHar1AvalantinoRow2Plant4: JSON.parse(text52Value),
            });
          }
        })
        .done();
  ...
  updateTextInput22 = (text, field) => {
    ...
    this.setState({
      trussNumber1Har1AvalantinoRow2Plant4:
        Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 1,
    });
    this.setState({
      trussNumber2Har1AvalantinoRow2Plant4:
        Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 2,
    });
    this.setState({
      trussNumber3Har1AvalantinoRow2Plant4:
        Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 3,
    });
    this.setState({
      trussNumber4Har1AvalantinoRow2Plant4:
        Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 4,
    });
    this.setState({
      trussNumber5Har1AvalantinoRow2Plant4:
        Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 5,
    });
    this.setState({
      trussNumber6Har1AvalantinoRow2Plant4:
        Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 6,
    });
    this.setState({
      trussNumber7Har1AvalantinoRow2Plant4:
        Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 7,
    });
    this.setState({
      trussNumber8Har1AvalantinoRow2Plant4:
        Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 8,
    });
    this.setState({
      trussNumber9Har1AvalantinoRow2Plant4:
        Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 9,
    });
  ...
  calculateFruitLoad = () => {
    ...
    sum =
      (Number.parseInt(this.state.setFruitsHar1AvalantinoRow2Plant4)
        ? Number.parseInt(this.state.setFruitsHar1AvalantinoRow2Plant4)
        : 0) +
      (Number.parseInt(this.state.setFruits1Har1AvalantinoRow2Plant4)
        ? Number.parseInt(this.state.setFruits1Har1AvalantinoRow2Plant4)
        : 0) +
      (Number.parseInt(this.state.setFruits2Har1AvalantinoRow2Plant4)
        ? Number.parseInt(this.state.setFruits2Har1AvalantinoRow2Plant4)
        : 0) +
      (Number.parseInt(this.state.setFruits3Har1AvalantinoRow2Plant4)
        ? Number.parseInt(this.state.setFruits3Har1AvalantinoRow2Plant4)
        : 0) +
      (Number.parseInt(this.state.setFruits4Har1AvalantinoRow2Plant4)
        ? Number.parseInt(this.state.setFruits4Har1AvalantinoRow2Plant4)
        : 0) +
      (Number.parseInt(this.state.setFruits5Har1AvalantinoRow2Plant4)
        ? Number.parseInt(this.state.setFruits5Har1AvalantinoRow2Plant4)
        : 0) +
      (Number.parseInt(this.state.setFruits6Har1AvalantinoRow2Plant4)
        ? Number.parseInt(this.state.setFruits6Har1AvalantinoRow2Plant4)
        : 0) +
      (Number.parseInt(this.state.setFruits7Har1AvalantinoRow2Plant4)
        ? Number.parseInt(this.state.setFruits7Har1AvalantinoRow2Plant4)
        : 0) +
      (Number.parseInt(this.state.setFruits8Har1AvalantinoRow2Plant4)
        ? Number.parseInt(this.state.setFruits8Har1AvalantinoRow2Plant4)
        : 0) +
      (Number.parseInt(this.state.setFruits9Har1AvalantinoRow2Plant4)
        ? Number.parseInt(this.state.setFruits9Har1AvalantinoRow2Plant4)
        : 0);
    this.setState({
    ...
    this.setItem(
      'fruitLoadHar1AvalantinoRow2Plant4',
      this.state.fruitLoadHar1AvalantinoRow2Plant4,
    );
  ...
  calculateHarvestTruss = () => {
    ...
    if (this.state.setFlowersHar1AvalantinoRow2Plant4 === '') {
      ...
      div =
        Number.parseInt(
          this.state.setFruitsHar1AvalantinoRow2Plant4
            ? this.state.setFruitsHar1AvalantinoRow2Plant4
            : 0,
        ) /
        parseFloat(
          this.state.pruningNumberHar1AvalantinoRow2Plant4
            ? this.state.pruningNumberHar1AvalantinoRow2Plant4
            : 0,
        );
      sub = 1 - div;
    ...
    this.setItem(
      'harvestTrussHar1AvalantinoRow2Plant4',
      this.state.harvestTrussHar1AvalantinoRow2Plant4,
    );
  };
  ...
  calculateSettingTruss2 = () => {
    ...
    console.log(
      'Setting truss called : ' + this.state.setFruits2Har1AvalantinoRow2Plant4,
    );
    ...
    if (this.state.setFruits9Har1AvalantinoRow2Plant4 === '') {
      if (this.state.setFruits8Har1AvalantinoRow2Plant4 === '') {
        if (this.state.setFruits7Har1AvalantinoRow2Plant4 === '') {
          if (this.state.setFruits6Har1AvalantinoRow2Plant4 === '') {
            if (this.state.setFruits5Har1AvalantinoRow2Plant4 === '') {
              if (this.state.setFruits4Har1AvalantinoRow2Plant4 === '') {
                if (this.state.setFruits3Har1AvalantinoRow2Plant4 === '') {
                  if (this.state.setFruits2Har1AvalantinoRow2Plant4 === '') {
                    if (this.state.setFruits1Har1AvalantinoRow2Plant4 === '') {
                      if (this.state.setFruitsHar1AvalantinoRow2Plant4 === '') {
                        ...
                        trussNum = Number.parseInt(
                          this.state.trussNumberHar1AvalantinoRow2Plant4,
                        );
                      ...
                      pruningSet = Number.parseInt(
                        this.state.pruningNumber1Har1AvalantinoRow2Plant4,
                      );
                      trussNum = Number.parseInt(number);
                      settingFruit = Number.parseInt(
                        this.state.setFruits1Har1AvalantinoRow2Plant4,
                      );
                      settingTruss = (
                        trussNum +
                        settingFruit / pruningSet
                    ...
                    pruningSet = Number.parseInt(
                      this.state.pruningNumber2Har1AvalantinoRow2Plant4,
                    );
                    trussNum = Number.parseInt(number2);
                    settingFruit = Number.parseInt(
                      this.state.setFruits2Har1AvalantinoRow2Plant4,
                    );
                    settingTruss = (
                      trussNum +
                      settingFruit / pruningSet
                  ...
                  pruningSet = Number.parseInt(
                    this.state.pruningNumber3Har1AvalantinoRow2Plant4,
                  );
                  trussNum = Number.parseInt(number3);
                  settingFruit = Number.parseInt(
                    this.state.setFruits3Har1AvalantinoRow2Plant4,
                  );
                ...
                pruningSet = Number.parseInt(
                  this.state.pruningNumber4Har1AvalantinoRow2Plant4,
                );
                trussNum = Number.parseInt(number4);
                settingFruit = Number.parseInt(
                  this.state.setFruits4Har1AvalantinoRow2Plant4,
                );
                settingTruss = (trussNum + settingFruit / pruningSet).toFixed(
                  2,
                );
              ...
              pruningSet = Number.parseInt(
                this.state.pruningNumber5Har1AvalantinoRow2Plant4,
              );
              trussNum = Number.parseInt(number5);
              settingFruit = Number.parseInt(
                this.state.setFruits5Har1AvalantinoRow2Plant4,
              );
            ...
            pruningSet = Number.parseInt(
              this.state.pruningNumber6Har1AvalantinoRow2Plant4,
            );
            trussNum = Number.parseInt(number6);
            settingFruit = Number.parseInt(
              this.state.setFruits6Har1AvalantinoRow2Plant4,
            );
            settingTruss = (trussNum + settingFruit / pruningSet).toFixed(2);
          ...
          pruningSet = Number.parseInt(
            this.state.pruningNumber7Har1AvalantinoRow2Plant4,
          );
          trussNum = Number.parseInt(number7);
          settingFruit = Number.parseInt(
            this.state.setFruits7Har1AvalantinoRow2Plant4,
          );
          settingTruss = (trussNum + settingFruit / pruningSet).toFixed(2);
        ...
        pruningSet = Number.parseInt(
          this.state.pruningNumber8Har1AvalantinoRow2Plant4,
        );
        trussNum = Number.parseInt(number8);
        settingFruit = Number.parseInt(
          this.state.setFruits8Har1AvalantinoRow2Plant4,
        );
        settingTruss = (trussNum + settingFruit / pruningSet).toFixed(2);
      ...
      pruningSet = Number.parseInt(
        this.state.pruningNumber9Har1AvalantinoRow2Plant4,
      );
      trussNum = Number.parseInt(number9);
      settingFruit = Number.parseInt(
        this.state.setFruits9Har1AvalantinoRow2Plant4,
      );
      settingTruss = (trussNum + settingFruit / pruningSet).toFixed(2);
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2Har1AvalantinoRow2Plant4,
    );
    ...
    if (this.state.setFlowers9Har1AvalantinoRow2Plant4 === '') {
      if (this.state.setFlowers8Har1AvalantinoRow2Plant4 === '') {
        if (this.state.setFlowers7Har1AvalantinoRow2Plant4 === '') {
          if (this.state.setFlowers6Har1AvalantinoRow2Plant4 === '') {
            if (this.state.setFlowers5Har1AvalantinoRow2Plant4 === '') {
              if (this.state.setFlowers4Har1AvalantinoRow2Plant4 === '') {
                if (this.state.setFlowers3Har1AvalantinoRow2Plant4 === '') {
                  if (this.state.setFlowers2Har1AvalantinoRow2Plant4 === '') {
                    if (this.state.setFlowers1Har1AvalantinoRow2Plant4 === '') {
                      if (this.state.setFlowersHar1AvalantinoRow2Plant4 === '') {
                        ...
                        flowering = Number.parseInt(
                          this.state.setFlowersHar1AvalantinoRow2Plant4,
                        );
                      ...
                      var number11 =
                        +this.state.trussNumberHar1AvalantinoRow2Plant4 + 1;
                      ...
                      flowering = Number.parseInt(
                        this.state.setFlowers1Har1AvalantinoRow2Plant4,
                      );
                      flowerSetFruits = Number.parseInt(
                        this.state.setFruits1Har1AvalantinoRow2Plant4,
                      );
                    ...
                    var number21 =
                      +this.state.trussNumberHar1AvalantinoRow2Plant4 + 2;

                    flowerPruningNumner = Number.parseInt(
                      this.state.pruningNumber2Har1AvalantinoRow2Plant4,
                    );
                    flowering = Number.parseInt(
                      this.state.setFlowers2Har1AvalantinoRow2Plant4,
                    );
                    flowerSetFruits = Number.parseInt(
                      this.state.setFruits2Har1AvalantinoRow2Plant4,
                    );
                  ...
                  var number31 =
                    +this.state.trussNumberHar1AvalantinoRow2Plant4 + 3;

                  flowerPruningNumner = Number.parseInt(
                    this.state.pruningNumber3Har1AvalantinoRow2Plant4,
                  );
                  flowering = Number.parseInt(
                    this.state.setFlowers3Har1AvalantinoRow2Plant4,
                  );
                  flowerSetFruits = Number.parseInt(
                    this.state.setFruits3Har1AvalantinoRow2Plant4,
                  );
                ...
                flowering = Number.parseInt(
                  this.state.setFlowers4Har1AvalantinoRow2Plant4,
                );
                flowerSetFruits = Number.parseInt(
                  this.state.setFruits4Har1AvalantinoRow2Plant4,
                );
              ...
              flowering = Number.parseInt(
                this.state.setFlowers5Har1AvalantinoRow2Plant4,
              );
              flowerSetFruits = Number.parseInt(
                this.state.setFruits5Har1AvalantinoRow2Plant4,
              );
            ...
            flowering = Number.parseInt(
              this.state.setFlowers6Har1AvalantinoRow2Plant4,
            );
            flowerSetFruits = Number.parseInt(
              this.state.setFruits6Har1AvalantinoRow2Plant4,
            );
          ...
          flowering = Number.parseInt(
            this.state.setFlowers7Har1AvalantinoRow2Plant4,
          );
          flowerSetFruits = Number.parseInt(
            this.state.setFruits7Har1AvalantinoRow2Plant4,
          );
        ...
        flowering = Number.parseInt(
          this.state.setFlowers8Har1AvalantinoRow2Plant4,
        );
        flowerSetFruits = Number.parseInt(
          this.state.setFruits8Har1AvalantinoRow2Plant4,
        );
      ...
      if (this.state.trussNumberHar1AvalantinoRow2Plant4 != null) {
        ...
        if (filteredweekRowTruss1.length != 0) {
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowersHar1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruitsHar1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumberHar1AvalantinoRow2Plant4: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss2.length != 0) {
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers1Har1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits1Har1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber1Har1AvalantinoRow2Plant4: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss3.length != 0) {
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers2Har1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits2Har1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber2Har1AvalantinoRow2Plant4: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss4.length != 0) {
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers3Har1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits3Har1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber3Har1AvalantinoRow2Plant4: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss5.length != 0) {
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers4Har1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits4Har1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber4Har1AvalantinoRow2Plant4: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss6.length != 0) {
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers5Har1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits5Har1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber5Har1AvalantinoRow2Plant4: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss7.length != 0) {
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers6Har1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits6Har1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber6Har1AvalantinoRow2Plant4: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss8.length != 0) {
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers7Har1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits7Har1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber7Har1AvalantinoRow2Plant4: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss9.length != 0) {
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers8Har1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits8Har1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber8Har1AvalantinoRow2Plant4: JSON.stringify(
      ...
      if (
        ...
        if (filteredweekRowTruss10.length != 0) {
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              setFlowers9Har1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              setFruits9Har1AvalantinoRow2Plant4: JSON.stringify(
          ...
          if (
            ...
            this.setState({
              pruningNumber9Har1AvalantinoRow2Plant4: JSON.stringify(
  ...
  changeCheckbox = () => {
    this.setState({
      Har1AvalantinoRow2Plant4Selected: !this.state.Har1AvalantinoRow2Plant4Selected,
    });
  ...
  saveTrussToDb = () => {
    if (
      this.state.trussNumberHar1AvalantinoRow2Plant4 !== null &&
      this.state.pruningNumberHar1AvalantinoRow2Plant4 !== null
    ) {
      let data = {
  ...
  saveTrussToDB1 = () => {
    if (
      Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 1 !=
        null &&
      this.state.pruningNumber1Har1AvalantinoRow2Plant4 !== null
    ) {
      let data1 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 1,
  ...
  saveTrussToDB2 = () => {
    if (
      Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 2 !=
        null &&
      this.state.pruningNumber2Har1AvalantinoRow2Plant4 !== null
    ) {
      let data2 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 2,
  ...
  saveTrussToDB3 = () => {
    if (
      Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 3 !==
        null &&
      this.state.pruningNumber3Har1AvalantinoRow2Plant4 !== null
    ) {
      let data3 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 3,
  ...
  saveTrussToDB4 = () => {
    if (
      Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 4 !=
        null &&
      this.state.pruningNumber4Har1AvalantinoRow2Plant4 !== null
    ) {
      let data4 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 4,
  ...
  saveTrussToDB5 = () => {
    if (
      Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 5 !=
        null &&
      this.state.pruningNumber5Har1AvalantinoRow2Plant4 !== null
    ) {
      let data5 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 5,
  ...
  saveTrussToDB6 = () => {
    if (
      Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 6 !=
        null &&
      this.state.pruningNumber6Har1AvalantinoRow2Plant4 !== null
    ) {
      let data6 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 6,
  ...
  saveTrussToDB7 = () => {
    if (
      Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 7 !=
        null &&
      this.state.pruningNumber7Har1AvalantinoRow2Plant4 !== null
    ) {
      let data7 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 7,
  ...
  saveTrussToDB8 = () => {
    if (
      Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 8 !=
        null &&
      this.state.pruningNumber8Har1AvalantinoRow2Plant4 !== null
    ) {
      let data8 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 8,
  ...
  saveTrussToDB9 = () => {
    if (
      Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 9 !=
        null &&
      this.state.pruningNumber9Har1AvalantinoRow2Plant4 !== null
    ) {
      let data9 = {
        trussNumber:
          Number.parseInt(this.state.trussNumberHar1AvalantinoRow2Plant4) + 9,
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 4</Text>/ Row No. 123/
        ...
        <KeyboardAvoidingView
          ...
          <ScrollView
            ...
            <View
              pointerEvents={
                this.state.Har1AvalantinoRow2Plant4Selected ? 'none' : 'auto'
              }>
              <View style={styles.formContainer}>
                  ...
                  <View style={styles.row}>
                    <View style={styles.borderEdit}>
                      <TextInput
                        ...
                        value={
                          this.state.floweringTrussHeightHar1AvalantinoRow2Plant4
                        }
                        ref={input => {
                  ...
                  <View style={styles.row}>
                    <View style={styles.borderEdit}>
                      <TextInput
                        ...
                        value={
                          this.state.lastWeekStmDiameterHar1AvalantinoRow2Plant4
                        }
                        ref={input => {
                ...
                <View style={styles.borderEditTruss}>
                  <View
                    style={[
                      this.state.fruitLoadHar1AvalantinoRow2Plant4 <= 22 ||
                      this.state.fruitLoadHar1AvalantinoRow2Plant4 >= 40
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssHar1AvalantinoRow2Plant4 <= 0 ||
                      this.state.floweringTrussssHar1AvalantinoRow2Plant4 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}>
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.floweringTrussssHar1AvalantinoRow2Plant4}
                      </Text>
                    </View>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberHar1AvalantinoRow2Plant4 <= 1 ||
                      this.state.settingTrussNumberHar1AvalantinoRow2Plant4 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}>
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberHar1AvalantinoRow2Plant4}
                      </Text>
                    </View>
                    <View
                      style={{
                ...
                <TouchableOpacity
                  onPress={() =>
                    this.props.navigation.navigate('Har1DataChecker', {name : 'Har1AvalantinoRow2Plant4', row : '123', plant: 4, type: 'HAR 1 - Avalantino'})
                  }>
