...
export default class Har1SunsetDelightRow1Plant4 extends Component {
  ...
  getAsysncValues = async () => {
    ...
    try {
      AsyncStorage.getItem('floweringTrussHeightHar1SunsetDelightRow1Plant4')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightHar1SunsetDelightRow1Plant4: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('lastWeekStmDiameterHar1SunsetDelightRow1Plant4')
        .then(text9Value => {
          this.setState({
            lastWeekStmDiameterHar1SunsetDelightRow1Plant4: JSON.parse(text9Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('pruningNumber1Har1SunsetDelightRow1Plant4')
        .then(text18Value => {
          if (text18Value !== null) {
            this.setState({
              pruningNumber1Har1SunsetDelightRow1Plant4: JSON.parse(text18Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter1Har1SunsetDelightRow1Plant4')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              fruitDiameter1Har1SunsetDelightRow1Plant4: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber2Har1SunsetDelightRow1Plant4')
        .then(text19Value => {
          if (text19Value !== null) {
            this.setState({
              pruningNumber2Har1SunsetDelightRow1Plant4: JSON.parse(text19Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter2Har1SunsetDelightRow1Plant4')
        .then(text20Value => {
          if (text20Value !== null) {
            this.setState({
              fruitDiameter2Har1SunsetDelightRow1Plant4: JSON.parse(text20Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber3Har1SunsetDelightRow1Plant4')
        .then(text23Value => {
          if (text23Value !== null) {
            this.setState({
              pruningNumber3Har1SunsetDelightRow1Plant4: JSON.parse(text23Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter3Har1SunsetDelightRow1Plant4')
        .then(text24Value => {
          if (text24Value !== null) {
            this.setState({
              fruitDiameter3Har1SunsetDelightRow1Plant4: JSON.parse(text24Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber4Har1SunsetDelightRow1Plant4')
        .then(text27Value => {
          if (text27Value !== null) {
            this.setState({
              pruningNumber4Har1SunsetDelightRow1Plant4: JSON.parse(text27Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter4Har1SunsetDelightRow1Plant4')
        .then(text28Value => {
          if (text28Value !== null) {
            this.setState({
              fruitDiameter4Har1SunsetDelightRow1Plant4: JSON.parse(text28Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber5Har1SunsetDelightRow1Plant4')
        .then(text31Value => {
          if (text31Value !== null) {
            this.setState({
              pruningNumber5Har1SunsetDelightRow1Plant4: JSON.parse(text31Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter5Har1SunsetDelightRow1Plant4')
        .then(text32Value => {
          if (text32Value !== null) {
            this.setState({
              fruitDiameter5Har1SunsetDelightRow1Plant4: JSON.parse(text32Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber6Har1SunsetDelightRow1Plant4')
        .then(text35Value => {
          if (text35Value !== null) {
            this.setState({
              pruningNumber6Har1SunsetDelightRow1Plant4: JSON.parse(text35Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter6Har1SunsetDelightRow1Plant4')
        .then(text36Value => {
          if (text36Value !== null) {
            this.setState({
              fruitDiameter6Har1SunsetDelightRow1Plant4: JSON.parse(text36Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber7Har1SunsetDelightRow1Plant4')
        .then(text39Value => {
          if (text39Value !== null) {
            this.setState({
              pruningNumber7Har1SunsetDelightRow1Plant4: JSON.parse(text39Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter7Har1SunsetDelightRow1Plant4')
        .then(text40Value => {
          if (text40Value !== null) {
            this.setState({
              fruitDiameter7Har1SunsetDelightRow1Plant4: JSON.parse(text40Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber8Har1SunsetDelightRow1Plant4')
        .then(text43Value => {
          if (text43Value !== null) {
            this.setState({
              pruningNumber8Har1SunsetDelightRow1Plant4: JSON.parse(text43Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter8Har1SunsetDelightRow1Plant4')
        .then(text44Value => {
          if (text44Value !== null) {
            this.setState({
              fruitDiameter8Har1SunsetDelightRow1Plant4: JSON.parse(text44Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('pruningNumber9Har1SunsetDelightRow1Plant4')
        .then(text47Value => {
          if (text47Value !== null) {
            this.setState({
              pruningNumber9Har1SunsetDelightRow1Plant4: JSON.parse(text47Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('fruitDiameter9Har1SunsetDelightRow1Plant4')
        .then(text48Value => {
          if (text48Value !== null) {
            this.setState({
              fruitDiameter9Har1SunsetDelightRow1Plant4: JSON.parse(text48Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('floweringTrussssHar1SunsetDelightRow1Plant4')
        .then(text50Value => {
          if (text50Value !== null) {
            this.setState({
              floweringTrussssHar1SunsetDelightRow1Plant4: JSON.parse(text50Value),
            });
          }
        })
        .done();
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberHar1SunsetDelightRow1Plant4')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberHar1SunsetDelightRow1Plant4: JSON.parse(text51Value),
            });
          }
        })
        .done();
  ...
  calculateSettingTruss2 = () => {
    ...
    console.log(
      'Setting truss called : ' + this.state.setFruits2Har1SunsetDelightRow1Plant4,
    );
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2Har1SunsetDelightRow1Plant4,
    );
  ...
  changeCheckbox = () => {
    this.setState({
      Har1SunsetDelightRow1Plant4Selected: !this.state.Har1SunsetDelightRow1Plant4Selected,
    });
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 4</Text>/ Row No. 157/
            ...
            <View
              ...
              <View style={styles.formContainer}>
                ...
                <View style={styles.borderEditTruss}>
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssHar1SunsetDelightRow1Plant4 <= 0 ||
                      this.state.floweringTrussssHar1SunsetDelightRow1Plant4 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}>
                    <View style={styles.row}>
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberHar1SunsetDelightRow1Plant4 <= 1 ||
                      this.state.settingTrussNumberHar1SunsetDelightRow1Plant4 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}>
                    <View style={styles.row}>
                      ...
                      <Text style={styles.text5}>
                        {this.state.settingTrussNumberHar1SunsetDelightRow1Plant4}
                      </Text>
                    </View>
                    <View
                      style={{
                ...
                <TouchableOpacity
                  onPress={() =>
                    this.props.navigation.navigate('Har1DataChecker', {name : 'Har1SunsetDelightRow1Plant4', row : '157', plant: 4, type: 'HAR 1 - Sunset Delight'})
                  }>
