    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 4</Text>/ Row No. 236/
          ...
          <ScrollView
            ...
            <View
              ...
              <View style={styles.formContainer}>
                ...
                <TouchableOpacity
                  onPress={() =>
                    this.props.navigation.navigate('Har2DataChecker', {name : 'Har2AngelleRow2Plant4', row : '236', plant: 4, type: 'HAR 2 - Angelle'})
                  }>
