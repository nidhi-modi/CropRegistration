...
export default class Har3AngellePlantsRow1 extends Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    //PLANT 4
    this.har3AngelleRow1EventPlant4 = EventRegister.addEventListener(
      'har3AngelleRow1EventPlant4',
      data4 => {
    ...
    //PLANT 5
    this.har3AngelleRow1EventPlant5 = EventRegister.addEventListener(
      'har3AngelleRow1EventPlant5',
      data5 => {
    ...
    if (plant4Selected == null || plant4Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() =>
            this.props.navigation.navigate('Har3AngelleRow1Plant4')
          }>
          <Text style={styles.buttonText}>
    ...
    if (plant5Selected == null || plant5Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() =>
            this.props.navigation.navigate('Har3AngelleRow1Plant5')
          }>
          <Text style={styles.buttonText}>
      ...
      <View style={styles.container}>
        ...
        <View
          ...
          <View style={styles.headerImage2}>
            <Text style={styles.text}>HAR 3 - Angelle / Row 315</Text>
          </View>
