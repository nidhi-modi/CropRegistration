...
export default class Har4AvalantinoRow1Plant1 extends Component {
  ...
  getAsysncValues = async () => {
    ...
    try {
      AsyncStorage.getItem('floweringTrussHeightHar4AvalantinoRow1Plant1')
        .then(text5Value => {
          this.setState({
            floweringTrussHeightHar4AvalantinoRow1Plant1: JSON.parse(text5Value),
          });
        })
        .done();
    } catch (error) {}
    ...
    try {
      AsyncStorage.getItem('settingTrussNumberHar4AvalantinoRow1Plant1')
        .then(text51Value => {
          if (text51Value !== null) {
            this.setState({
              settingTrussNumberHar4AvalantinoRow1Plant1: JSON.parse(text51Value),
            });
          }
        })
        .done();
  ...
  calculateFloweringTruss2 = () => {
    ...
    console.log(
      'Flowering truss called : ' + this.state.setFlowers2Har4AvalantinoRow1Plant1,
    );
  ...
  changeCheckbox = () => {
    this.setState({
      Har4AvalantinoRow1Plant1Selected: !this.state.Har4AvalantinoRow1Plant1Selected,
    });
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          <Text style={styles.textPlants}>Plant 1</Text>/ Row No. 424/
            ...
            <View
              ...
              <View style={styles.formContainer}>
                ...
                <View style={styles.borderEditTruss}>
                  ...
                  <View
                    style={[
                      this.state.floweringTrussssHar4AvalantinoRow1Plant1 <= 0 ||
                  ...
                  <View
                    style={[
                      this.state.settingTrussNumberHar4AvalantinoRow1Plant1 <= 1 ||
                      this.state.settingTrussNumberHar4AvalantinoRow1Plant1 >= 45
                        ? styles.borderErrorColor
                        : null,
                    ]}>
                    <View style={styles.row}>
                ...
                <TouchableOpacity
                  onPress={() =>
                    this.props.navigation.navigate('Har4DataChecker', {name : 'Har4AvalantinoRow1Plant1', row : '424', plant: 1, type: 'HAR 4 - Avalantino'})
                  }>
