...
export default class Har5AngellePlantsRow1 extends Component {
  ...
  UNSAFE_componentWillMount() {
    //PLANT 1
    this.har5AngelleRow1EventPlant1 = EventRegister.addEventListener(
      'har5AngelleRow1EventPlant1',
      data1 => {
    ...
    //PLANT 2
    this.har5AngelleRow1EventPlant2 = EventRegister.addEventListener(
      'har5AngelleRow1EventPlant2',
      data2 => {
    ...
    //PLANT 3
    this.har5AngelleRow1EventPlant3 = EventRegister.addEventListener(
      'har5AngelleRow1EventPlant3',
      data3 => {
    ...
    //PLANT 4
    this.har5AngelleRow1EventPlant4 = EventRegister.addEventListener(
      'har5AngelleRow1EventPlant4',
      data4 => {
    ...
    //PLANT 5
    this.har5AngelleRow1EventPlant5 = EventRegister.addEventListener(
      'har5AngelleRow1EventPlant5',
      data5 => {
    ...
    if (plant1Selected == null || plant1Selected == true) {
      return (
        <TouchableOpacity
          ...
          onPress={() =>
            this.props.navigation.navigate('Har5AngelleRow1Plant1')
          }>
    ...
    if (plant2Selected == null || plant2Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() =>
            this.props.navigation.navigate('Har5AngelleRow1Plant2')
          }>
          <Text style={styles.buttonText}>
    ...
    if (plant3Selected == null || plant3Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() =>
            this.props.navigation.navigate('Har5AngelleRow1Plant3')
          }>
          <Text style={styles.buttonText}>
    ...
    if (plant4Selected == null || plant4Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() =>
            this.props.navigation.navigate('Har5AngelleRow1Plant4')
          }>
          <Text style={styles.buttonText}>
    ...
    if (plant5Selected == null || plant5Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() =>
            this.props.navigation.navigate('Har5AngelleRow1Plant5')
          }>
          <Text style={styles.buttonText}>
