...
export default class Oha2NMerlicePlantsRow1 extends Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    //PLANT 1
    this.oha2NMerliceRow1EventPlant1 = EventRegister.addEventListener('oha2NMerliceRow1EventPlant1', (data1) => {
    ...
    //PLANT 2
    this.oha2NMerliceRow1EventPlant2 = EventRegister.addEventListener('oha2NMerliceRow1EventPlant2', (data2) => {
    ...
    //PLANT 3
    this.oha2NMerliceRow1EventPlant3 = EventRegister.addEventListener('oha2NMerliceRow1EventPlant3', (data3) => {
    ...
    //PLANT 4
    this.oha2NMerliceRow1EventPlant4 = EventRegister.addEventListener('oha2NMerliceRow1EventPlant4', (data4) => {
    ...
    //PLANT 5
    this.oha2NMerliceRow1EventPlant5 = EventRegister.addEventListener('oha2NMerliceRow1EventPlant5', (data5) => {
  ...
  renderElement1() {
    ...
    if (plant1Selected == null || plant1Selected == true) {
      ...
      return <TouchableOpacity
        ...
        onPress={() => this.props.navigation.navigate('Oha2NMerliceRow1Plant1')}>
  ...
  renderElement2() {
    ...
    if (plant2Selected == null || plant2Selected == true) {
      ...
      return <TouchableOpacity
        style={styles.buttonContainer}
        onPress={() => this.props.navigation.navigate('Oha2NMerliceRow1Plant2')}>
  ...
  renderElement3() {
    ...
    if (plant3Selected == null || plant3Selected == true) {
      ...
      return <TouchableOpacity
        style={styles.buttonContainer}
        onPress={() => this.props.navigation.navigate('Oha2NMerliceRow1Plant3')}>
  ...
  renderElement4() {
    ...
    if (plant4Selected == null || plant4Selected == true) {
      ...
      return <TouchableOpacity
        style={styles.buttonContainer}
        onPress={() => this.props.navigation.navigate('Oha2NMerliceRow1Plant4')}>
  ...
  renderElement5() {
    ...
    if (plant5Selected == null || plant5Selected == true) {
      ...
      return <TouchableOpacity
        style={styles.buttonContainer}
        onPress={() => this.props.navigation.navigate('Oha2NMerliceRow1Plant5')}>
