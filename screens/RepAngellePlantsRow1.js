...
export default class RepAngellePlantsRow1 extends Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    //PLANT 1
    this.angelleRow1EventPlant1 = EventRegister.addEventListener('angelleRow1EventPlant1', (data1) => {
    ...
    //PLANT 2
    this.angelleRow1EventPlant2 = EventRegister.addEventListener('angelleRow1EventPlant2', (data2) => {
    ...
    //PLANT 3
    this.angelleRow1EventPlant3 = EventRegister.addEventListener('angelleRow1EventPlant3', (data3) => {
    ...
    //PLANT 4
    this.angelleRow1EventPlant4 = EventRegister.addEventListener('angelleRow1EventPlant4', (data4) => {
    ...
    //PLANT 5
    this.angelleRow1EventPlant5 = EventRegister.addEventListener('angelleRow1EventPlant5', (data5) => {
    ...
    //PLANT 6
    this.angelleRow1EventPlant6 = EventRegister.addEventListener('angelleRow1EventPlant6', (data6) => {
    ...
    //PLANT 7
    this.angelleRow1EventPlant7 = EventRegister.addEventListener('angelleRow1EventPlant7', (data7) => {
    ...
    //PLANT 9
    this.angelleRow1EventPlant9 = EventRegister.addEventListener('angelleRow1EventPlant9', (data9) => {
    ...
    //PLANT 10
    this.angelleRow1EventPlant10 = EventRegister.addEventListener('angelleRow1EventPlant10', (data10) => {
