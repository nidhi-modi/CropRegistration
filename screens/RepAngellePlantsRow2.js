    ...
    if (plant1Selected == null || plant1Selected == true) {
      return (
        <TouchableOpacity
          ...
          onPress={() =>
            this.props.navigation.navigate('RepAngelleRow2Plant1')
          }>
    ...
    if (plant2Selected == null || plant2Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() =>
            this.props.navigation.navigate('RepAngelleRow2Plant2')
          }>
          <Text style={styles.buttonText}>
    ...
    if (plant3Selected == null || plant3Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() =>
            this.props.navigation.navigate('RepAngelleRow2Plant3')
          }>
          <Text style={styles.buttonText}>
    ...
    if (plant4Selected == null || plant4Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() =>
            this.props.navigation.navigate('RepAngelleRow2Plant4')
          }>
          <Text style={styles.buttonText}>
    ...
    if (plant5Selected == null || plant5Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() =>
            this.props.navigation.navigate('RepAngelleRow2Plant5')
          }>
          <Text style={styles.buttonText}>
    ...
    if (plant6Selected == null || plant6Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() =>
            this.props.navigation.navigate('RepAngelleRow2Plant6')
          }>
          <Text style={styles.buttonText}>
    ...
    if (plant7Selected == null || plant7Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() =>
            this.props.navigation.navigate('RepAngelleRow2Plant7')
          }>
          <Text style={styles.buttonText}>
    ...
    if (plant8Selected == null || plant8Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() =>
            this.props.navigation.navigate('RepAngelleRow2Plant8')
          }>
          <Text style={styles.buttonText}>
    ...
    if (plant9Selected == null || plant9Selected == true) {
      return (
        <TouchableOpacity
          style={styles.buttonContainer}
          onPress={() =>
            this.props.navigation.navigate('RepAngelleRow2Plant9')
          }>
          <Text style={styles.buttonText}>
