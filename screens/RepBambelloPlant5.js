  ...
  renderEntryData = () => {
    ...
    try {
      AsyncStorage.getItem('@MySuperStore:plantKey').then((plantValues) => {
        ...
        //Change week number
        const weekRowPlant = d => d.plantName === 'REP - Bambello' && d.plantNumber === 5 && d.plantRow === '232' && d.plantWeek === filteredPlantWeek;
    ...
    try {
      AsyncStorage.getItem('@MySuperStore:trussKey').then((trussValues) => {
        ...
        //Change week number
        const weekRowTruss = d => d.plantName === 'REP - Bambello' && d.plantNumber === 5 && d.plantRow === '232' && d.plantWeek === filteredTrussWeek;
