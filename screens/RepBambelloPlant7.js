  ...
  renderEntryData = () => {
    ...
    try {
      AsyncStorage.getItem('@MySuperStore:plantKey').then((plantValues) => {
        ...
        //Change week number
        const weekRowPlant = d => d.plantName === 'REP - Bambello' && d.plantNumber === 7 && d.plantRow === 232 && d.plantWeek === this.state.weekNumber;
    ...
    try {
      AsyncStorage.getItem('@MySuperStore:trussKey').then((trussValues) => {
        ...
        //Change week number
        const weekRowTruss = d => d.plantName === 'REP - Bambello' && d.plantNumber === '7' && d.plantRow === 232 && d.plantWeek === this.state.weekNumber;
  ...
  getTrussData = () => {
    ...
    if (this.state.allTrussData.length != 0) {
      ...
      if (this.state.trussNumberRepBambelloPlant7 != null) {
        ...
        //Change week number
        const weekRowTruss1 = d => d.trussNumber === parseInt(this.state.trussNumberRepBambelloPlant7);
        ...
        if (filteredweekRowTruss1.length != 0) {
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFlowers) === 'null') {
            ...
            this.setState({
              ...
              setFlowersRepBambelloPlant7: JSON.stringify(filteredweekRowTruss1[0].setFlowers),
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].setFruits) === 'null') {
            ...
            this.setState({
              ...
              setFruitsRepBambelloPlant7: JSON.stringify(filteredweekRowTruss1[0].setFruits),
          ...
          if (JSON.stringify(filteredweekRowTruss1[0].pruningNumber) === 'null') {
            ...
            this.setState({
              ...
              pruningNumberRepBambelloPlant7: JSON.stringify(filteredweekRowTruss1[0].pruningNumber)
      ...
      if ((parseInt(this.state.trussNumberRepBambelloPlant7) + 1) != null) {
        ...
        //Change week number
        const weekRowTruss2 = d => d.trussNumber === (parseInt(this.state.trussNumberRepBambelloPlant7) + 1);
        ...
        if (filteredweekRowTruss2.length != 0) {
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFlowers) === 'null') {
            ...
            this.setState({
              ...
              setFlowers1RepBambelloPlant7: JSON.stringify(filteredweekRowTruss2[0].setFlowers),
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].setFruits) === 'null') {
            ...
            this.setState({
              ...
              setFruits1RepBambelloPlant7: JSON.stringify(filteredweekRowTruss2[0].setFruits),
          ...
          if (JSON.stringify(filteredweekRowTruss2[0].pruningNumber) === 'null') {
            ...
            this.setState({
              ...
              pruningNumber1RepBambelloPlant7: JSON.stringify(filteredweekRowTruss2[0].pruningNumber)
      ...
      if ((parseInt(this.state.trussNumberRepBambelloPlant7) + 2) != null) {
        ...
        //Change week number
        const weekRowTruss3 = d => d.trussNumber === (parseInt(this.state.trussNumberRepBambelloPlant7) + 2);
        ...
        if (filteredweekRowTruss3.length != 0) {
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFlowers) === 'null') {
            ...
            this.setState({
              ...
              setFlowers2RepBambelloPlant7: JSON.stringify(filteredweekRowTruss3[0].setFlowers),
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].setFruits) === 'null') {
            ...
            this.setState({
              ...
              setFruits2RepBambelloPlant7: JSON.stringify(filteredweekRowTruss3[0].setFruits),
          ...
          if (JSON.stringify(filteredweekRowTruss3[0].pruningNumber) === 'null') {
            ...
            this.setState({
              ...
              pruningNumber2RepBambelloPlant7: JSON.stringify(filteredweekRowTruss3[0].pruningNumber)
      ...
      if ((parseInt(this.state.trussNumberRepBambelloPlant7) + 3) != null) {
        ...
        //Change week number
        const weekRowTruss4 = d => d.trussNumber === (parseInt(this.state.trussNumberRepBambelloPlant7) + 3);
        ...
        if (filteredweekRowTruss4.length != 0) {
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFlowers) === 'null') {
            ...
            this.setState({
              ...
              setFlowers3RepBambelloPlant7: JSON.stringify(filteredweekRowTruss4[0].setFlowers),
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].setFruits) === 'null') {
            ...
            this.setState({
              ...
              setFruits3RepBambelloPlant7: JSON.stringify(filteredweekRowTruss4[0].setFruits),
          ...
          if (JSON.stringify(filteredweekRowTruss4[0].pruningNumber) === 'null') {
            ...
            this.setState({
              ...
              pruningNumber3RepBambelloPlant7: JSON.stringify(filteredweekRowTruss4[0].pruningNumber)
      ...
      if ((parseInt(this.state.trussNumberRepBambelloPlant7) + 4) != null) {
        ...
        //Change week number
        const weekRowTruss5 = d => d.trussNumber === (parseInt(this.state.trussNumberRepBambelloPlant7) + 4);
        ...
        if (filteredweekRowTruss5.length != 0) {
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFlowers) === 'null') {
            ...
            this.setState({
              ...
              setFlowers4RepBambelloPlant7: JSON.stringify(filteredweekRowTruss5[0].setFlowers),
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].setFruits) === 'null') {
            ...
            this.setState({
              ...
              setFruits4RepBambelloPlant7: JSON.stringify(filteredweekRowTruss5[0].setFruits),
          ...
          if (JSON.stringify(filteredweekRowTruss5[0].pruningNumber) === 'null') {
            ...
            this.setState({
              ...
              pruningNumber4RepBambelloPlant7: JSON.stringify(filteredweekRowTruss5[0].pruningNumber)
      ...
      if ((parseInt(this.state.trussNumberRepBambelloPlant7) + 5) != null) {
        ...
        //Change week number
        const weekRowTruss6 = d => d.trussNumber === (parseInt(this.state.trussNumberRepBambelloPlant7) + 5);
        ...
        if (filteredweekRowTruss6.length != 0) {
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFlowers) === 'null') {
            ...
            this.setState({
              ...
              setFlowers5RepBambelloPlant7: JSON.stringify(filteredweekRowTruss6[0].setFlowers),
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].setFruits) === 'null') {
            ...
            this.setState({
              ...
              setFruits5RepBambelloPlant7: JSON.stringify(filteredweekRowTruss6[0].setFruits),
          ...
          if (JSON.stringify(filteredweekRowTruss6[0].pruningNumber) === 'null') {
            ...
            this.setState({
              ...
              pruningNumber5RepBambelloPlant7: JSON.stringify(filteredweekRowTruss6[0].pruningNumber)
      ...
      if ((parseInt(this.state.trussNumberRepBambelloPlant7) + 6) != null) {
        ...
        //Change week number
        const weekRowTruss7 = d => d.trussNumber === (parseInt(this.state.trussNumberRepBambelloPlant7) + 6);
        ...
        if (filteredweekRowTruss7.length != 0) {
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFlowers) === 'null') {
            ...
            this.setState({
              ...
              setFlowers6RepBambelloPlant7: JSON.stringify(filteredweekRowTruss7[0].setFlowers),
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].setFruits) === 'null') {
            ...
            this.setState({
              ...
              setFruits6RepBambelloPlant7: JSON.stringify(filteredweekRowTruss7[0].setFruits),
          ...
          if (JSON.stringify(filteredweekRowTruss7[0].pruningNumber) === 'null') {
            ...
            this.setState({
              ...
              pruningNumber6RepBambelloPlant7: JSON.stringify(filteredweekRowTruss7[0].pruningNumber)
      ...
      if ((parseInt(this.state.trussNumberRepBambelloPlant7) + 7) != null) {
        ...
        //Change week number
        const weekRowTruss8 = d => d.trussNumber === (parseInt(this.state.trussNumberRepBambelloPlant7) + 7);
        ...
        if (filteredweekRowTruss8.length != 0) {
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFlowers) === 'null') {
            ...
            this.setState({
              ...
              setFlowers7RepBambelloPlant7: JSON.stringify(filteredweekRowTruss8[0].setFlowers),
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].setFruits) === 'null') {
            ...
            this.setState({
              ...
              setFruits7RepBambelloPlant7: JSON.stringify(filteredweekRowTruss8[0].setFruits),
          ...
          if (JSON.stringify(filteredweekRowTruss8[0].pruningNumber) === 'null') {
            ...
            this.setState({
              ...
              pruningNumber7RepBambelloPlant7: JSON.stringify(filteredweekRowTruss8[0].pruningNumber)
      ...
      if ((parseInt(this.state.trussNumberRepBambelloPlant7) + 8) != null) {
        ...
        //Change week number
        const weekRowTruss9 = d => d.trussNumber === (parseInt(this.state.trussNumberRepBambelloPlant7) + 8);
        ...
        if (filteredweekRowTruss9.length != 0) {
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFlowers) === 'null') {
            ...
            this.setState({
              ...
              setFlowers8RepBambelloPlant7: JSON.stringify(filteredweekRowTruss9[0].setFlowers),
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].setFruits) === 'null') {
            ...
            this.setState({
              ...
              setFruits8RepBambelloPlant7: JSON.stringify(filteredweekRowTruss9[0].setFruits),
          ...
          if (JSON.stringify(filteredweekRowTruss9[0].pruningNumber) === 'null') {
            ...
            this.setState({
              ...
              pruningNumber8RepBambelloPlant7: JSON.stringify(filteredweekRowTruss9[0].pruningNumber)
      ...
      if ((parseInt(this.state.trussNumberRepBambelloPlant7) + 9) != null) {
        ...
        //Change week number
        const weekRowTruss10 = d => d.trussNumber === (parseInt(this.state.trussNumberRepBambelloPlant7) + 9);
        ...
        if (filteredweekRowTruss10.length != 0) {
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFlowers) === 'null') {
            ...
            this.setState({
              ...
              setFlowers9RepBambelloPlant7: JSON.stringify(filteredweekRowTruss10[0].setFlowers),
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].setFruits) === 'null') {
            ...
            this.setState({
              ...
              setFruits9RepBambelloPlant7: JSON.stringify(filteredweekRowTruss10[0].setFruits),
          ...
          if (JSON.stringify(filteredweekRowTruss10[0].pruningNumber) === 'null') {
            ...
            this.setState({
              ...
              pruningNumber9RepBambelloPlant7: JSON.stringify(filteredweekRowTruss10[0].pruningNumber)
...
{Platform.OS === 'ios'? 
        ...
        <Text style={styles.text2}><Text style={styles.textPlants}>Plant 7</Text>/ Row No. 232/ Week No. {this.state.weekNumber}</Text>
