  ...
  renderEntryData = () => {
    ...
    try {
      AsyncStorage.getItem('@MySuperStore:plantKey').then((plantValues) => {
        ...
        //Change week number
        const weekRowPlant = d => d.plantName === 'REP - KM5512' && d.plantNumber === 3 && d.plantRow === 807 && d.plantWeek === this.state.weekNumber;
    ...
    try {
      AsyncStorage.getItem('@MySuperStore:trussKey').then((trussValues) => {
        ...
        //Change week number
        const weekRowTruss = d => d.plantName === 'REP - KM5512' && d.plantNumber === '3' && d.plantRow === 807 && d.plantWeek === this.state.weekNumber;
