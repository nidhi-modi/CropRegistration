...
export default class RepKmPlantsRow1 extends Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    //PLANT 1
    this.kmEventPlant1 = EventRegister.addEventListener('kmEventPlant1', (data1) => {
    ...
    //PLANT 2
    this.kmEventPlant2 = EventRegister.addEventListener('kmEventPlant2', (data2) => {
    ...
    //PLANT 3
    this.kmEventPlant3 = EventRegister.addEventListener('kmEventPlant3', (data3) => {
    ...
    //PLANT 4
    this.kmEventPlant4 = EventRegister.addEventListener('kmEventPlant4', (data4) => {
    ...
    //PLANT 5
    this.kmEventPlant5 = EventRegister.addEventListener('kmEventPlant5', (data5) => {
    ...
    //PLANT 6
    this.kmEventPlant6 = EventRegister.addEventListener('kmEventPlant6', (data6) => {
    ...
    //PLANT 7
    this.kmEventPlant7 = EventRegister.addEventListener('kmEventPlant7', (data7) => {
     ...
     //PLANT 8
     this.kmEventPlant8 = EventRegister.addEventListener('kmEventPlant8', (data8) => {
    ...
    //PLANT 9
    this.kmEventPlant9 = EventRegister.addEventListener('kmEventPlant9', (data9) => {
    ...
    //PLANT 10
    this.kmEventPlant10 = EventRegister.addEventListener('kmEventPlant10', (data10) => {
