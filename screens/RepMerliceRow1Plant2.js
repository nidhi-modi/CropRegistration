  ...
  renderEntryData = () => {
    ...
    try {
      AsyncStorage.getItem('@MySuperStore:plantKey').then((plantValues) => {
        ...
        //Change week number
        const weekRowPlant = d => d.plantName === 'REP - Merlice' && d.plantNumber === 2 && d.plantRow === '123' && d.plantWeek === filteredPlantWeek;
    ...
    try {
      AsyncStorage.getItem('@MySuperStore:trussKey').then((trussValues) => {
        ...
        //Change week number
        const weekRowTruss = d => d.plantName === 'REP - Merlice' && d.plantNumber === 2 && d.plantRow === '123' && d.plantWeek === filteredTrussWeek;
