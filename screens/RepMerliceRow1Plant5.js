  ...
  renderEntryData = () => {
    ...
    try {
      AsyncStorage.getItem('@MySuperStore:plantKey').then((plantValues) => {
        ...
        //Change week number
        const weekRowPlant = d => d.plantName === 'REP - Merlice' && d.plantNumber === 5 && d.plantRow === 123 && d.plantWeek === this.state.weekNumber;
    ...
    try {
      AsyncStorage.getItem('@MySuperStore:trussKey').then((trussValues) => {
        ...
        //Change week number
        const weekRowTruss = d => d.plantName === 'REP - Merlice' && d.plantNumber === '5' && d.plantRow === 123 && d.plantWeek === this.state.weekNumber;
